...
# Frühzugriff - Adobe Experience Cloud Versionshinweise - August 2020
...
Neueste Aktualisierung: **7. August 2020**
...
| [Unterstützte Geräte und Plattformen](https://docs.adobe.com/content/help/de-DE/media-analytics/using/supported-devices.html) | 18. Juni 2020 | Die Media Launch-Erweiterung mit dem AEP-SDK unterstützt jetzt die folgenden OTT-Geräte:<ul><li>Apple TV (tvOS)</li><li>Fire TV (Fire OS)</li><li>Android TV</li></ul> |
...
* Es wurde ein Problem behoben, bei dem intelligente Warnhinweise nicht bearbeitet werden konnten. (AN-227162)
...
* **AEM as a Cloud Service**
   ...
   What is new on AEM as a Cloud Service? Zu den hervorgehobenen Highlights zählen:
   ...
   * Cloud Readiness Analyzer Version 1.0.2 wurde veröffentlicht. Siehe [Installieren von CRA auf AEM 6.1.](https://docs.adobe.com/content/help/de-DE/experience-manager-cloud-service/moving/cloud-migration/cloud-readiness-analyzer/using-cloud-readiness-analyzer.html#installing-on-aem61)
...
| 7. August 2020 | [Configuring AEM Assets for Administrators](https://experienceleague.adobe.com/?recommended=ExperienceManager-A-1-2020.1.assets) | Tutorial | Beschreibung |
...
| 21. Juli 2020 | [Übersetzungsprojekte](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html) | Tutorial | Learn how to create, edit, and manage a translation project for your [!UICONTROL Language Copy]. |
...
| 21. Juli 2020 | [Überblick über die Verwaltung mehrerer Sites](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/language-copy-overview.html) | Tutorial | Get an overview of how to create a multilingual site using [!UICONTROL Language Copy] in [!UICONTROL AEM Sites]. |
...
| 21. Juli 2020 | [Translation Job Status](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/translation-job-status.html) | Tutorial | Understand the different statuses associated with a Translation Job or an item in the job. |
| 21. Juli 2020 | [Introduction to Multi Site Management](https://video.tv.adobe.com/v/36686?captions=ger) | Tutorial | Introduction to the Getting Started with Multi-Site Management for business users course. |
| 21. Juli 2020 | [Erstellen von adaptiven Formularfragmenten](https://video.tv.adobe.com/v/37325?captions=ger) | Tutorial | Adaptive forms provides a convenient mechanism to create form segment like a panel or a group of fields only once and reuse them across adaptive forms. Diese wiederverwendbaren und eigenständigen Segmente werden als adaptive Formularfragmente bezeichnet. |
| 21. Juli 2020 | [AEM Inbox](https://docs.adobe.com/content/help/en/experience-manager-learn/forms/inbox-customization/introduction.html) | Tutorial | [!UICONTROL AEM Inbox] consolidates notifications and tasks from various AEM components, including Forms workflows. |
...
| 21. Juli 2020 | [Erstellen des ersten adaptiven Formulars](https://video.tv.adobe.com/v/37701?captions=ger) | Tutorial | In this video, learn how to create your first adaptive form. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| ----------- | ----------- | ---------- | ---------- |  
| 10. Juli 2020 | [Systemsteuerung - Verwaltung der GPG-Schlüssel - Entschlüsselung von Daten](https://docs.adobe.com/content/help/en/campaign-classic-learn/tutorials/administrating/control-panel-acc/gpg-key-management/decrypting-data.html) | Campaign Classic | Erfahren Sie, wie Sie einen öffentlichen Schlüssel erstellen, importieren und auf einer Kampagne-Instanz für die Entschlüsselung eingehender Daten installieren. |
| 10. Juli 2020 | [Systemsteuerung - GPG-Schlüsselverwaltung - Verschlüsseln von Daten mit einem GPG-Schlüssel](https://docs.adobe.com/content/help/en/campaign-classic-learn/tutorials/administrating/control-panel-acc/gpg-key-management/using-a-gpg-key-to-encrypt-data.html) | Campaign Classic | Erfahren Sie, wie Sie Daten mit einer GPG-Taste exportieren, die auf der Systemsteuerung installiert ist. |
...
| 9. Juli 2020 | [Systemsteuerung - GPG-Schlüsselverwaltung - Verschlüsseln von Daten mit einem GPG-Schlüssel](https://docs.adobe.com/content/help/en/campaign-standard-learn/tutorials/administrating/control-panel/gpg-key-management/using-a-gpg-key-to-encrypt-data.html) | Campaign Standard | Erfahren Sie, wie Sie Daten mit einer GPG-Taste exportieren, die auf der Systemsteuerung installiert ist. |
