...
| März 2022 | [Direkter Link zu einem Projekt in Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/direct-link-to-a-project.html?lang=de) | Video | Erfahren Sie, wie Sie einfacheren Zugriff auf die Analysefunktion bieten können, indem Sie gekürzte Links erstellen, über die Ihre Kollegen direkt zu Ihren Analysis Workspace-Projekten gelangen können. |
...
* **Experience Manager 6.5, Service Pack 12 (6.5.12.0)**
   ...
   Adobe Experience Manager 6.5.12.0 enthält neue Funktionen, wichtige von Kunden angeforderte Verbesserungen sowie Leistungs-, Stabilitäts- und Sicherheitsverbesserungen, die seit der Verfügbarkeit der Version 6.5 im April 2019 veröffentlicht wurden. Das Service Pack wird in Adobe Experience Manager 6.5 installiert.
...
* **Experience Manager-GEMS-Webinar: _Schnellere Erstellung von Sites mit Experience Manager Headless und App Builder_**
   ...
   * Haben Sie die Eröffnungs-Keynote zum Adobe Summit 2022 verpasst? Sehen Sie sich [Make the Digital Economy Personal](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2022-opening-keynote-make-the-digital-economy/td-p/444612) an.
...
| März 2022 | [Freigeben von öffentlichen Links](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/link-sharing.html?lang=de) | Video | Erfahren Sie, wie Sie Medienelemente in Assets Essentials mit „Link freigeben“ für interne und externe Beteiligte freigeben können, während Sie gleichzeitig das Risiko minimieren, falsche Medienelemente oder Informationen freizugeben. | AEM Assets |
...
Neue Videos, Tutorials oder Kurse, die für [!DNL XML Documentation for Adobe Experience Manager] veröffentlicht wurden.

| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| März 2022 | [Ausgabenerstellung mit XML-Dokumentation](https://experienceleague.adobe.com/?recommended=ExperienceManager-U-1-2022.2.xmldocs&amp;lang=de) | Kurs | Erfahren Sie, wie Sie mithilfe von [!DNL XML Documentation for Adobe Experience Manager] eine Ausgabe generieren. Erfahren Sie mehr über verschiedene Funktionen, die für die Generierung von Ausgaben verfügbar sind, einschließlich Berichten, Grundlinien, Bedingungen, der Fehlerbehebung, der Massenveröffentlichung und der Aktivierung. |
