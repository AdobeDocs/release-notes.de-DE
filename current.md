...
Neueste Aktualisierung: **11. Januar 2020**
...
Die neuesten Aktualisierungen für:[](https://docs.adobe.com/content/help/de-DE/experience-platform/release-notes/latest.html#!end-user/markdown/release-notes/release-notes.md)
...
Verwenden Sie Adobe Experience Platform, um die Customer Journey in großem Maßstab über Erlebnis-Kanal hinweg zu organisieren, indem Sie die Bedürfnisse jedes Einzelnen in Echtzeit vorhersehen.
...
| Analysis Workspace - Bild-URLs | 14. Januar 2021 | Sie können Bilder zu [!UICONTROL Workspace]-Projekten hinzufügen, indem Sie auf eine öffentliche Bild-URL verweisen. |
