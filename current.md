...
* [Customer Data Management - Stimmen](#voices)
...
* **[!DNL Analytics]** | EXL Live: _Umsetzbare Zielgruppen an einem Ort, aus jeder Quelle, mit Standardsteuerelementen_ | **20. Juli um 9:00 Uhr PT** ([Ereignislink](https://www.youtube.com/watch?v=QaJy9Tp-vTE)) | [registrieren](https://engage.adobe.com/ExpLeagueLive-230720.html)
...
Achtung an alle Kandidatinnen und Kandidaten für die Adobe-Zertifizierung! Experience Cloud besuchen [Zertifizierung](https://experienceleague.adobe.com/docs/certification/program/overview.html?lang=de) Site auf Experience League.

+++Details

Die Zertifizierungs-Website ist Ihre zentrale Anlaufstelle für alle [!DNL Experience Cloud] zertifizierungsbezogene Inhalte und werden regelmäßig mit folgenden Informationen aktualisiert:

* Verfügbare Zertifizierungen
* Zertifizierungsverlängerungen für Adobe Apps
...
[!DNL Adobe System Status] bietet detaillierte Informationen, Statusaktualisierungen und E-Mail-Benachrichtigungen zu Adobe-Produkten und -Diensten. Erhalten Sie eine Benachrichtigung über Ausfälle, Störungen und Wartungsereignisse. Weitere Informationen dazu erhalten Sie unter [status.adobe.com/de](https://status.adobe.com/de).
...
Erfahren Sie mehr über die [!DNL Experience Cloud] -Schnittstelle. Verwalten Sie Produkte und Benutzer, konfigurieren Sie Profileinstellungen und Voreinstellungen, suchen Sie nach Experience Cloud-Objekten und verwalten Sie Cookies.

+++Details

Hilfe zu den Komponenten der zentralen Experience Cloud-Benutzeroberfläche finden Sie im Abschnitt [Experience Cloud-Benutzeroberfläche und Administrationshandbuch](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=de) (umfasst [!UICONTROL Kundenattribute], [!DNL Experience Cloud Assets]und [!UICONTROL Zielgruppen]).
...
* [[!DNL Experience Platform] Versionshinweise zum Mobile SDK](https://developer.adobe.com/client-sdks/documentation/release-notes/)
...
| Juli 2023 | [Erste Schritte mit [!DNL Experience Platform] für Datenarchitekten und Dateningenieure](https://experienceleague.adobe.com/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview.html) | Aktualisiertes Tutorial | Dieses Tutorial ist der perfekte Ausgangspunkt für Ihre praktische Arbeit. [!DNL Experience Platform]. |
| Juli 2023 | [Aktualisieren spezifischer Profilattribute mithilfe von [!UICONTROL upsert]](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/update-a-specific-attribute-with-upsert.html) | Video | Erfahren Sie, wie Sie ein bestimmtes Attribut eines Profils mit dem `upsert` Funktion [!DNL Experience Platform]. |
...
Neue Video-Tutorials, Artikel und Kurse für Adobe [!DNL Analytics].

| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juli 2023 | [Erstellen von Bot-Berichten in Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/bot-reporting.html) | Video | Erfahren Sie, wie Sie Berichte zu Bot-Daten erstellen in [!UICONTROL Analysis Workspace]. Bot-Daten sind als Zusammenfassungsdaten verfügbar und können in Bot-fähigen Report Suites analysiert werden. |
| Juli 2023 | [Erstellen dynamischer Dropdown-Filter in Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/tips-and-tricks/dynamic-drop-downs.html) | Video | Erfahren Sie, wie Sie Dropdown-Filter basierend auf einer gesamten Dimension erstellen. Dimension Elemente werden dynamisch aktualisiert, basierend auf dem Datumsbereich, der im Berichtsbereich verwendet wird, und den Werten, die in anderen Dropdown-Filtern im selben Bereich ausgewählt sind. |
| Juli 2023 | [Berechnete Metriken: Segmentierte Metriken](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/calculated-metrics/calculated-metrics-segmented-metrics.html) | Video | Erfahren Sie, wie Sie berechnete Metriken basierend auf Segmenten erstellen, damit Sie die zugehörigen Besucher, Besuche und Seitenansichten effektiver analysieren können. |

{style="table-layout:auto"}

### Adobe [!DNL Analytics] Wissensdatenbank{#kb-analytics}

Neue Artikel und Aktualisierungen vorhandener Artikel für [!DNL Analytics].

| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juni 2023 | [Benutzerspezifischer Link heißt nicht Link-Klick](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22339.html?lang=de) | Neuer Artikel | Seit Version 2.15 des AEP Web SDK hat die Adobe die Einstellung `web.webInteraction.name` zum statischen Link-Klick. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juli 2023 | [Mit anderen Benutzern in Analysis Workspace teilen](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/curate-and-share/share-with-anyone-in-analysis-workspace.html) | Video | Informationen zu **[!UICONTROL Für alle freigeben]** in [!UICONTROL Analysis Workspace]. Sie können diese Funktion verwenden, um schreibgeschützten Zugriff auf [!UICONTROL Arbeitsbereich] Projekte für Personen, die keinen Zugang zur Adobe haben [!DNL Analytics] oder [!DNL Customer Journey Analytics], einschließlich Empfängern außerhalb Ihres Unternehmens. |
| Juli 2023 | [Verstehen von grundlegenden Besuchermetriken](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/metrics/understanding-basic-visitor-metrics.html?lang=de) | Video | Erfahren Sie mehr über Seitenansichten, Besuche und Besucher und wie Sie mit diesen grundlegenden Metriken den Website-Traffic verstehen können. |
| Juli 2023 | [Unterstützung von Führungskräften beim Zugriff auf mobile Scorecards](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/dashboards/assist-executives-to-access-mobile-scorecards.html) | Video | Unterstützen Sie Führungskräfte beim Zugriff auf mobile Scorecards, die in [!DNL Customer Journey Analytics] mithilfe der Mobile App des [!DNL Analytics]-Dashboards erstellt wurden. Mobile Scorecards bieten jederzeit Zugriff auf wichtige Leistungsmetriken und detaillierte Ansichten oder Aufschlüsselungen. |
| Juli 2023 | [Neue Funktionen in CJA-Tutorials](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/overview.html?lang=en) | Video | Neue Funktionen in [!DNL Customer Journey Analytics] Tutorials für Juli. |
...
| -----------| ---------- | ---------- | ---------- | ------|
| Juli 2023 | [Schnellzugriff](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/quick-access.html) | Video | Erfahren Sie mehr [!UICONTROL Schnellzugriff] kann Ihre Produktivität steigern und Ihren Workflow optimieren, indem Sie als Ihr persönliches Objektiv in [!DNL AEM Assets]. Diese Funktion hält alle Assets, die Sie für Ihre zugewiesenen Aufgaben benötigen, zur Hand. | [!DNL AEM Assets] |
| Juli 2023 | [Anzeige _Vielen Dank_ Meldung bei Übermittlung des Headless-Formulars](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/embed-form-spa/display-thank-you-message.html) | Artikel | Anzeigen einer _Vielen Dank_ Meldung bei erfolgreicher Headless-Formularübermittlung. | [!DNL AEM Forms] |
| Juli 2023 | [Lesezeichen-Vorschau - Codebeispiel](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/verify.html?lang=en#preview-bookmarklet) | Artikel | Erfahren Sie, wie Sie eine JavaScript-Lesezeichenvorschau erstellen.[!UICONTROL  App Builder-Inhaltsfragment] Erweiterung im Kontext der AEM [!UICONTROL Inhaltsfragment] Seiten. | [!UICONTROL Content Fragments] |
| Juli 2023 | [Inhaltsfragment in XML exportieren](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-export-to-xml.html) | Artikel | Benutzerdefinierte Schaltflächen können der [!UICONTROL Inhaltsfragment-Editor] Kopfzeilenmenü mit `headerMenu` Erweiterungspunkt. In diesem Beispiel wird gezeigt, wie eine Schaltfläche zum Kopfzeilenmenü hinzugefügt wird und wie das Klickereignis verarbeitet wird, um das aktive Element zu exportieren [!UICONTROL Inhaltsfragment] als XML oder CSV. | [!UICONTROL Content Fragments] |
| Juli 2023 | [Formular bei Klick auf die Karte anzeigen](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/embed-form-spa/open-form-card-view.html) | Artikel | Führen Sie aus der Kartenansicht einen Drilldown im Formular durch. | [!DNL AEM Forms] |
| Juli 2023 | [Widgets zum Rich-Text-Editor (RTE) hinzufügen](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-rte-widget.html) | Video | Erfahren Sie im AEM, wie Sie Widgets zum Rich-Text-Editor (RTE) hinzufügen [!UICONTROL Inhaltsfragment-Editor]. | [!UICONTROL Content Fragments] |
| Juli 2023 | [Hinzufügen von Abzeichen zum Rich-Text-Editor](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-rte-badges.html) | Video | Erfahren Sie im AEM, wie Sie dem Rich-Text-Editor (RTE) Badges hinzufügen [!UICONTROL Inhaltsfragment-Editor]. | [!UICONTROL Content Fragments] |
| Juli 2023 | [Benutzerdefinierte Rasterspalten](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/custom-grid-columns.html) | Video | Erfahren Sie, wie Sie der [!UICONTROL Inhaltsfragmentkonsole]. | [!UICONTROL Content Fragments] |
| Juli 2023 | [-3D-Assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/3d-assets.html?lang=en) | Video | Informationen zur Unterstützung von 3D-Assets in [!DNL AEM Assets as a Cloud Service]. | [!DNL AEM Assets] |
| Juli 2023 | [Verweise](https://experienceleague.adobe.com/docs/experience-manager-learn/content-fragments-console/search/references.html) | Video | Erfahren Sie, wie AEM Inhaltsfragment-Konsole und -Editor das Verstehen und Verwalten referenzierter Inhalte erleichtern. | [!DNL AEM Sites] |
| Juli 2023 | [Antwort basierend auf gesendeten Daten anpassen](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/custom-submit-headless-forms/introduction.html) | Video | Erstellen Sie einen benutzerdefinierten Sendedienst, um die Übermittlung des adaptiven Formulars ohne Kopf zu handhaben. | [!DNL AEM Forms] |
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|--------|---------|---------|
| Juni 2023 | [Überprüfen des Status AEM Dienste](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22310.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie den Status AEM Dienste überprüfen können, wenn ein Verfügbarkeitsproblem auftritt. |
| Juni 2023 | [Die Eigenschaft dam:relativePath wird nicht automatisch aktualisiert](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22302.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie das Problem lösen können, bei dem das `dam:relativePath` -Eigenschaft nicht automatisch aktualisiert wird. |
| Juni 2023 | [Benutzerprofile für Brand Portal funktionieren nicht erwartungsgemäß](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22298.html?lang=de) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass Benutzerprofile für Brand Portal nicht erwartungsgemäß funktionieren. |
...
| Juni 2023 | [Deaktivieren schwacher Chiffren](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22348.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie schwache Chiffren deaktivieren. |
| Juni 2023 | [SAML-Fehler - *SAML-Antwortparameter wurde nicht angegeben oder ungültig*](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22367.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie die *SAML-Antwortparameter wurde nicht angegeben oder ungültig* Fehler. |
| Juni 2023 | [So vermeiden Sie Probleme mit Package-Momentaufnahmen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22341.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie Probleme mit Package-Momentaufnahmen vermeiden können. |
| Juni 2023 | [Java™ 11-Code schlägt im Cloud Manager-Build fehl](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22285.html?lang=de) | Neuer Artikel | Erfahren Sie mehr über die Lösung für das Problem, dass Java 11-Code in [!UICONTROL Cloud Manager] erstellen. |
| Juni 2023 | [VLT RCP-Inhaltssynchronisierung schlägt fehl](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22323.html?lang=de) | Neuer Artikel | Erfahren Sie mehr über die Lösung für das Problem, dass die VLT RCP-Inhaltssynchronisierung fehlschlägt. |

{style="table-layout:auto"}

### Weitere Hilferessourcen für [!DNL Experience Manager]
...
| Juli 2023 | [B2B für Adobe Commerce - Anführungszeichen](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/sales-rep-initiates-quote.html?lang=en) | Mehrere Videos | Neue Anleitungsvideos zur Verwendung von [!UICONTROL Anführungszeichen] Seite für B2B für [!DNL Adobe Commerce]. |
...
| Juni 2023 | [UPS-APIs veraltet](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/ups-apis-deprecated.html) | Neuer Artikel | UPS-APIs werden vorübergehend als [!DNL Adobe Commerce] -Integration mit UPS unterstützt das OAuth 2.0-Sicherheitsmodell derzeit nicht. |
| Juni 2023 | [Bereitstellungsfehler: *Fehler 7 beim Herunterladen ... Port 443: Verbindung verweigert*](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/deployment/deployment-error-downloading-connection-refused-adobe-commerce.html) | Neuer Artikel | Erfahren Sie mehr über die Lösung für das Problem, bei dem die Bereitstellung mit *Fehler 7 beim Herunterladen* Fehler. |
| Juni 2023 | [Adobe Commerce 2.4.6-Fehlerplatzierung von Bestellungen aus dem Admin-Bedienfeld](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/adobe-commerce-2.4.6-error-placing-order-from-admin-panel.html) | Neuer Artikel | Erfahren Sie, wie Sie einen Patch auf das bekannte [!DNL Adobe Commerce] zum Problem der Cloud-Infrastruktur 2.4.6 , wenn Sie bei der Store-Auswahl hängen bleiben, nachdem Sie eine Bestellung von der [!UICONTROL Commerce Admin] Bereich. |
| Juni 2023 | [Adobe Commerce 2.4.3-p2 - 2.4.5 Sicherheits-Hotfix für CVE-2022-35698](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/adobe-commerce-2.4.3-p2-2.4.5-security-hotfix-for-cve-2022-35698.html) | Neuer Artikel | Suchen Sie nach Hotfix-Patches zum Auflösen [!UICONTROL Site-übergreifende Skripterstellung] Schwachstelle. |
...
* Neu! Control Panel - Version vom Juni: [Versionshinweise](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=de)
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|----|----|-----------|
| Juni 2023 | [Campaign Analytics-Verbindungsfehler: *AnalyticsAPIException: erhalten 403, Verboten*](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22296.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie die [!DNL Campaign] [!DNL Analytics] Verbindungsfehler: *AnalyticsAPIException: erhalten 403, Verboten*. |
| Juni 2023 | [Fehlerbehebung bei der Verwendung von .woff- und .woff2-Erweiterungen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22363.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie den Fehler beheben, der nach der Whitelist auftritt `.woff` und `.woff2` auf einer Mid-Instanz verwenden und diese Dateierweiterungen in einer Web-App verwenden. |
| Juni 2023 | [E-Mail-Testsendungen können nicht über eine Mid-Sourcing-Instanz gesendet werden](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22350.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie das Problem beheben, dass eine E-Mail nicht an die gewünschte E-Mail-Adresse gesendet wird, wenn der E-Mail-Testversand über eine Mid-Sourcing-Instanz durchgeführt wird. |
...
| Juni 2023 | [SCM-120008 Schlüsselwerte für das Element &quot;Ereignis&quot;können nicht gefunden werden](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22036.html?lang=de) | Neuer Artikel | Erfahren Sie die Lösung, wenn SCM-12008 keine Schlüsselwerte für das Element &quot;Ereignis&quot;finden kann. |
| Juni 2023 | [War die &quot;Weiterleitung an einen Freund&quot;für die Arbeit mit MID konzipiert?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22174.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie mit der Verwendung von &quot;Weiterleiten an Freunde&quot;einen Fehler auslösen können. |
...
Erfahren Sie mehr über die neuesten Funktionen, Verbesserungen und Fehlerbehebungen in der [Versionshinweise zu Journey Optimizer](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=de).
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juli 2023 | [Konfigurieren, Verfassen und Versenden von SMS-Nachrichten](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/sms-channel/author-sms-messages.html) | Video | Erfahren Sie, wie Sie SMS-Nachrichten konfigurieren, erstellen und versenden in [!DNL Journey Optimizer] Kampagnen und Journey. |
| Juli 2023 | [Anwendungsbeispiel: Transactional Journey](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-journeys/use-case-transactional-journey.html) | Aktualisiertes Video | Machen Sie sich mit den entsprechenden Anwendungsfällen für Journeys mit Transaktionen vertraut. Erfahren Sie, wie Sie Journeys mit Transaktionen erstellen und welche Best Practices anzuwenden sind. |
| Juli 2023 | [[!UICONTROL Erstellen von Inhalten mit dem E-Mail-Designer]](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/email-channel/create-content-with-the-email-designer.html?lang=de) | Video | Hier erfahren Sie, wie Sie E-Mails von Grund auf neu erstellen. Grundlegendes zur Verwendung von Assets aus der [!DNL AEM Assets] [!UICONTROL Grundlagen] , bearbeiten Sie den responsiven E-Mail-Entwurf und erstellen Sie E-Mails aus Vorlagen. |
| Juli 2023 | [Schemas erstellen](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/configuration/data-configuration/create-schema.html) | Aktualisiertes Video | Erfahren Sie, wie Sie ein Schema erstellen, Feldergruppen hinzufügen, benutzerdefinierte Feldergruppen erstellen und konfigurieren. |
...
* Siehe [Juli 2023 - aktuelle Versionshinweise](https://experienceleague.adobe.com/docs/marketo/using/release-notes/current.html?lang=de) für aktuelle Informationen
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juli 2023 | [Nutzung der Flexibilität von Standardprogrammen](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/default-programs/leverage-the-flexibility-of-default-programs.html) | Video | Von den vier Programmtypen sind Standardprogramme die flexibelsten und Sie können kreativ mit dem, was zu erstellen ist, arbeiten. Erfahren Sie mehr über zwei gängige Anwendungsfälle: Webformulare und Paid-Media-Lead-Generierung. |
| Juli 2023 | [Smart-Kampagnen 101](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/smart-campaigns-101.html) | Video | Erfahren Sie, wie Sie Smart-Kampagnen für Datennormalisierung und automatisierte Warnhinweise verwenden können. |
...
Neu [!DNL Workfront] Tutorials zur Experience League.

| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juli 2023 | [Typen und Aufgabenbegrenzungen von Dauer verstehen und verwalten](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/intermediate-projects/understand-and-manage-duration-types-and-task-constraints.html) | Video | Machen Sie sich mit den Typen der Dauer und den Aufgabenbegrenzungen vertraut und erfahren Sie, wie Sie sicherstellen können, dass diese in Ihren Projekten ordnungsgemäß eingerichtet sind. |
| Juli 2023 | [Digitale Arbeit überprüfen und genehmigen mit [!DNL Workfront] Startseite](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/issues-requests/review-and-approve-digital-work.html) | Video | Erfahren Sie, wie Sie Genehmigungen für Projekte, Aufgaben, Probleme, Dokumente und Testsendungen in [!DNL Workfront] Home. |
| Juli 2023 | [Basisansicht erstellen](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-basic-view.html) | Video | Erfahren Sie, was eine Ansicht ist, wie Sie eine Ansicht erstellen und wie Sie eine Ansicht für andere Benutzer freigeben können in [!DNL Workfront]. |
| Juli 2023 | [Meilensteine anwenden](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/approval-processes-and-milestone-paths/apply-milestones.html) | Video | Erfahren Sie, wie Sie Meilensteinpfade auf eine [!DNL Workfront] Projekt erstellen und wichtige Aufgaben als Meilensteinschritte innerhalb des Projekts verknüpfen. |
| Juli 2023 | [Zentralisieren von Problemen durch Erstellung eines Berichts](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/issues-requests/report-on-issues.html) | Video | Erfahren Sie, wie Sie Probleme zentralisieren können, indem Sie einen Bericht erstellen in [!DNL Workfront]. |
...
Siehe [Neue Funktionen in [!DNL Advertising DSP]](https://experienceleague.adobe.com/docs/advertising/dsp/home.html)

### Neue Funktionen in [!DNL Advertising Search, Social, & Commerce] {#advertising-search}

Siehe [Neue Funktionen in [!DNL Advertising Search, Social, & Commerce]](https://experienceleague.adobe.com/docs/advertising/search-social-commerce/home.html)
...
Neue Videos, Tutorials oder Kurse, die für veröffentlicht wurden [!DNL Creative Cloud] für Unternehmen.

+++Details

| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juli 2023 | [Adobe [!DNL Express] Übersicht](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/overview-express.html) | Mehrere Videos | Adobe [!DNL Express] ist ein benutzerfreundliches Kreativ-Tool ohne Erlebnis. Die neuesten Videos auf der Experience League zu [!DNL Adobe Express]. |
| Juli 2023 | [Adobe [!DNL Firefly] Übersicht](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/overview-firefly.html) | Mehrere Videos | [!DNL Firefly] ist die neue Produktfamilie kreativer generativer KI-Modelle, die zu Adobe-Produkten kommen und sich zunächst auf die Generierung von Bild- und Texteffekten konzentrieren. Firefly bietet neue Möglichkeiten, kreative Workflows zu konzipieren, zu erstellen und zu kommunizieren und verbessert gleichzeitig erheblich die kreativen Workflows. Die neuesten Videos auf der Experience League zu [!DNL Adobe Firefly]. |
...
[Customer Data Management - Voices](https://experienceleague.adobe.com/docs/events/customer-data-management-voices-recordings/overview.html) bietet eine Sammlung von Informationsmaterialien für technische Experten und Marketing-Spezialisten im Kundendaten-Management. Hier finden Sie Tutorials sowie die Möglichkeit, von Berufskollegen zu hören, sich inspirieren zu lassen und sich über Entwicklungen im Bereich MarTech zu informieren. Keine Registrierung erforderlich, einfach anklicken und ansehen.
