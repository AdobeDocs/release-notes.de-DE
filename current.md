...
|-------|------------|----------------|
| Experience Cloud admin & central interface   | [June 1, 2025](https://experienceleague.adobe.com/de/docs/release-notes/experience-cloud/current) | Generative AI support in Admin Console, improved user/product license management |
| Adobe Experience Platform | [June 18, 2025](https://experienceleague.adobe.com/de/docs/experience-platform/release-notes/latest)  | New dashboard email exports, updated tutorials & support articles |
| Adobe Real-Time CDP  | [June 12, 2025](https://experienceleague.adobe.com/de/docs/real-time-cdp-collaboration/using/latest) | Self-serve destination support, audience refresh frequency |
| Adobe Analytics  | [June 18-24, 2025](https://experienceleague.adobe.com/de/docs/analytics/release-notes/latest)  | Secure cloud exports, new preview bar chart, enhanced attribution |
| Adobe Customer Journey Analytics | [June 2-18, 2025](https://experienceleague.adobe.com/de/docs/analytics-platform/using/releases/latest)  | Fixed panel hover, new B2B Edition GA with account-level modeling |
| Adobe Streaming Media Analytics  | _(Not updated)_  | No new release notes - last updated December 2024 | 
| Adobe Experience Manager | [June 10, 2025](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/release-notes/maintenance/2025/2025-6-0)  | Maintenance release 21193, feature release 2025.6.0 scheduled June 26 |
| Adobe Commerce (Magento)  | [June 10, 2025](https://experienceleague.adobe.com/de/docs/commerce-operations/release/versions)  | Commerce 2.4.9‑alpha & patch 2.4.8‑p1, security fixes via APSB25‑50 |
| Adobe Commerce B2B Edition | [June 10, 2025](https://experienceleague.adobe.com/de/docs/commerce-admin/b2b/release-notes)  | B2B module v1.5.2‑p1 and v1.4.2‑p6 released with security compatibility |
...
| Adobe Journey Optimizer  | [June 18, 2025](https://experienceleague.adobe.com/de/docs/journey-optimizer/using/whats-new/release-notes) | Beta: AEP dataset decisioning |
...
| Adobe Mix Modeler   | [June 18, 2025](https://experienceleague.adobe.com/de/docs/mix-modeler/using/releases/latest)  | Introduced goal-based plans and spend pattern configurations |
...
* **Adobe Workfront** | _Webinar zur Version des dritten Quartals_ | Hebt die neuesten Workfront-Funktionen hervor, die für die Version Juli 2025 geplant sind. | [10. Juli 2025 - 9:00 Uhr MT] | [Registrieren](https://events.teams.microsoft.com/event/0481924a-fc34-4781-b7fc-ed4a54e6fa1f@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **Adobe Marketo Engage** | _Benutzergruppe_ | Erfahren Sie in dieser Grundlagensitzung, wie Sie Kampagnen mit Marketo Personalization unterstützen können. | 10. Juli 2025 | [Registrieren](https://mugs.marketo.com/events/details/marketo-foundational-marketo-user-group-presents-foundations-of-marketo-engage-powering-campaigns-with-marketo-personalization/)

* **Adobe Workfront** | _Verbinden: Admin-Chat für Marketing und Creative_ | Besprechen Sie mit Kollegen die Best Practices und Tipps für Workfront-Administratoren. | 11. Juli 2025 - 10:00 Uhr MT | [Registrieren](https://events.teams.microsoft.com/event/14f0c251-136d-4a61-befc-54673bf58cd6@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
Geplante Veröffentlichung: **18. Juni 2025**
...
|---------|----|----|-----------|
| Mai 2025 | [[!DNL Snowflake] Verbindungs-Timeout beim Bearbeiten des [!UICONTROL Quell]-Datenflusses in AEP](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26451) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem mit dem [!DNL Snowflake]-Verbindungs-Timeout in Adobe Experience Platform beim Bearbeiten eines [!DNL Snowflake]-[!UICONTROL Quell]-Datenflusses im Schritt **[!UICONTROL Daten auswählen]**. |
| Mai 2025 | [Adobe Experience Platform – Bei der Profilsuche nach **[!UICONTROL Partner-ID]** werden keine Ergebnisse angezeigt](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26462) | Neuer Artikel | Erfahren Sie mehr über die Lösungen des Problems, dass bei der Profilsuche nach der **[!UICONTROL Partner-ID]** aufgrund der Funktionsweise von Identitätsdiagrammen keine Ergebnisse in Adobe Experience Platform angezeigt werden. |
| Mai 2025 | [AEP unterstützt keine Einschränkung des API-Zugriffs auf der Grundlage bestimmter IP-Adressen](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26471) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass Sie den API-Zugriff nicht auf bestimmte IP-Adressen in Adobe Experience Platform (AEP) beschränken können. |
| Mai 2025 | Fehler [*UIS-0002-400: Fehler bei der Batch-Identitätsauflösung* in Adobe Experience Platform](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26520) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass der Fehler *UIS-0002-400: Fehler bei der Batch-Identitätsauflösung* in Adobe Experience Platform (AEP) auftritt. |
| Mai 2025 | [Behebung des 400-Fehlers [!UICONTROL Privacy Service-API] in AEP: Erklärung des täglichen Upload-Limits](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26552) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass ein Fehler vom Typ 400 beim Versuch ausgelöst wird, umfangreiche Benutzerprofile zu löschen, um die Einhaltung gesetzlicher Vorschriften zu gewährleisten, z. B. der DSGVO, da das [!UICONTROL Privacy Service-API] von Adobe Experience Platform (AEP) ein strenges tägliches Upload-Limit durchsetzt, um den Missbrauch von Services zu verhindern. |
| Mai 2025 | [Beheben von Timeout-Fehlern bei der Segmenterstellung in Adobe Experience Platform](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26606) | Neuer Artikel | Erfahren Sie, wie Sie Timeout-Fehler während der Erstellung von Zielgruppensegmenten in Adobe Experience Platform beheben. |
| Mai 2025 | Der Connector [[!DNL Facebook] [!UICONTROL Benutzerdefinierte Zielgruppe] steckt im Verarbeitungsstatus fest](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26615) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass das Ziel [!UICONTROL Benutzerdefinierte Zielgruppe] in [!DNL Facebook] im Verarbeitungsstatus feststeckt und die Zielgruppenaktivierung blockiert wird. |
...
| Mai 2025 | [Inkonsistenzen bei der Begrenzungslogik zwischen Platzierungen in AEP Offer Decisioning](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26682) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass sich die Begrenzungslogik zwischen den Platzierungen von 1:1-Nachrichten und E-Mails in der Funktion **[!UICONTROL Offer Decisioning]** in Adobe Experience Platform inkonsistent verhält. |
| Mai 2025 | [AEP: Fehler bei der Datenaufnahme aufgrund einer Anfrage-Payload, die die maximal zulässige Größe überschreitet](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26712) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass Adobe Experience Platform (AEP) einen Fehler bei der Payload-Größe zurückgibt, wenn die Anfrage während der Streaming-Aufnahme das 1-MB-Limit überschreitet. |
...
| Juni 2025 | [Konfigurationsfluss von Segment Match](https://experienceleague.adobe.com/de/docs/platform-learn/tutorials/audiences/segment-match-configuration-flow) | Neues Video | Sobald eine Segmentfreigabe mit einem Datenpartner verbunden wurde, können Sie Daten erkunden und für Partner freigeben. Dieses Video führt Sie durch die Konfiguration einer Segment Match-Instanz für eine Datenfreigabe. |
...
* Aktuelle [Wartungsversionshinweise](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest)
...
| Mai 2025 | [Die Anzahl der Empfangenden sinkt nach einer Versandaktivität in Adobe Campaign Classic](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26446) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass die Anzahl der Einträge nach einer Versandaktivität sinkt. |
...
| Juni 2025 | [!DNL Journey Optimizer] | [Integration von Adobe Experience Manager Dynamic Media](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/content-management/assets/aem-dynamic-media-integration) | Neues Video | Erfahren Sie, wie Sie Adobe Experience Manager Dynamic Media mit Adobe Journey Optimizer integrieren, um eine Aktualisierung und Personalisierung von Inhalten in Echtzeit zu ermöglichen. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Mai 2025 | [401-Fehlermeldung in Marketo Measure in der Konsole](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26569) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass ein *Fehler 401: Nicht autorisiert* in Marketo Measure auftritt, wenn ein Skript versucht, über eine URL zu aktivieren, die keine validierte Domain ist. |
| Mai 2025 | [Beheben von Problemen bei der Zuordnung des Kanals **[!UICONTROL Strategisches Ereignis]** in Marketo Measure](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26535) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass Offline-Touchpoints in Marketo Measure fälschlicherweise Kanälen in [!DNL Salesforce] (SFDC) zugeordnet werden. |
...
| Mai 2025 | [Fehlende Touchpoints für Aktivitätstypen in Marketo Measure](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26434) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass Aktivitäts-Touchpoints wie **[!UICONTROL Anruf verbunden]** und **[!UICONTROL Meeting abgeschlossen]** aufgrund von Inkonsistenzen in logischen Konfigurationen nicht in Marketo Measure angezeigt werden. |
| Mai 2025 | [Beheben des Problems fehlender Offline-Kanäle in Marketo Measure](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26397) | Neuer Artikel | Erfahren Sie mehr über die Lösungen für das Problem, dass bestimmte Offline-Kanäle während der Konfiguration fehlen. |
...
| Mai 2025 | [Korrigieren der Erstellung mehrerer Touchpoints für eine einzelne Kampagne in Marketo Measure](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26359) | Neuer Artikel | Erfahren Sie, wie Sie in Marketo Measure doppelte Touchpoints für eine einzelne E-Mail-Adresse korrigieren können. |
...
| Juni 2025 | [Erstellen grundlegender Filteraktivitäten](https://experienceleague.adobe.com/de/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-basic-filter-activity) | Neuer Artikel | In dieser Aktivität erstellen Sie einen Projektfilter mit dem Namen „Alle Projekte im Marketing-Portfolio“ im Filtererlebnis der Vorgängerversion. Dadurch werden alle Projekte im Portfolio mit dem Namen „Marketing-Portfolio“ unabhängig von ihrem Status angezeigt. |
| Juni 2025 | [Erstellen eines Matrix-Berichts](https://experienceleague.adobe.com/de/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-matrix-report) | Neues Video | Erfahren Sie, wann ein Matrix-Bericht nützlich sein kann und wie Sie einen Matrix-Bericht in Workfront erstellen. |
| Juni 2025 | [Senden und Freigeben von Berichten](https://experienceleague.adobe.com/de/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/how-to-send-and-share-reports) | Neues Video | Erfahren Sie, wie Sie Berichte an Benutzende, Teams oder E-Mail-Adressen senden und wie Sie Berichte für andere Benutzende in Workfront freigeben können. |
