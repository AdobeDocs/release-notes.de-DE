...
[Software Distribution](https://downloads.experiencecloud.adobe.com/) ist die neue Benutzeroberfläche, die die Suche und den Download von AEM Packages vereinfacht. Sie befindet sich derzeit im Beta-Status und ist nur für Adobe Managed Services-Kunden verfügbar.
...
Außerdem können Administratoren jetzt die Liste der Instanzen und die Berechtigung für Build-Upgrades anzeigen. For more information, refer to the [dedicated documentation](https://helpx.adobe.com/campaign/kb/control-panel-instance-settings.html).
