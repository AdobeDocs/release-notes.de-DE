...
Aktualisiert am **Dienstag, 29. Januar 2024**
...
| Januar 2024 | [Workflow und Planung: Arbeitsoptimierung und -beschleunigung](https://experienceleague.adobe.com/docs/genstudio-learn/tutorials/workflow-and-planning.html?lang=de) | Videos | Dies ist für Unternehmen, die Schwierigkeiten haben, sich zu verbinden und ihre Inhaltsvorgaben von der Planung über die Produktion bis zur Fertigstellung zu verfolgen. Aufgrund fehlender effizienter Prozesse, Planungen, Validierungen und projektübergreifender Datenkonsistenz ist die Content-Lieferkette dieser Unternehmen unproduktiv und ineffizient. |
| Januar 2024 | [Kreative Produktivität: Turbo-Kreativ-Teams](https://experienceleague.adobe.com/docs/genstudio-learn/tutorials/creative-productivity.html?lang=de) | Videos | Für Unternehmen, die zwar über kreative Genies verfügen, aber ihre Inhaltserstellung verbessern müssen. [!DNL GenStudio] stellt durch [!DNL GenAI] verstärkte Tools bereit, die diesem Team helfen, die Produktion, Bereitstellung und Auffindbarkeit von Inhalten zu steigern. |
| Januar 2024 | [Marketing-Agilität: Unterstützung der Skalierbarkeit von Nicht-Kreativen](https://experienceleague.adobe.com/docs/genstudio-learn/tutorials/marketing-agility.html?lang=de) | Videos | In Adobe [!DNL GenStudio] kann eine Inhaltsanfrage manchmal ohne das gesamte Kreativ-Team/ohne Studiobearbeitung adressiert werden. Adobe gibt Marketing-Fachleuten und anderen potenziellen Inhaltserstellerinnen und -erstellern Tools an die Hand. Mit diesen Tools lassen sich schnell Inhaltsvariationen erstellen. Aktualisierungen können von einer erweiterten, breiteren Gruppe von Einzelanwendern ausgeführt werden, die mit der Content-Lieferkette verbunden sind, wodurch der Inhaltsdurchsatz erheblich gesteigert und die Umsetzungszeit verkürzt wird. |
| Januar 2024 | [Bereitstellung und Aktivierung: Power-Erlebnisse und Leistung](https://experienceleague.adobe.com/docs/genstudio-learn/tutorials/delivery-and-activation.html?lang=de) | Videos | Für Unternehmen, die Unterstützung benötigen, um den richtigen Inhalt über den richtigen Kanal an die richtige Person zu bringen. [!DNL GenStudio] sorgt für eine bessere Verbindung als jede andere Lösung und bietet gleichzeitig die Analyse, um die Gesamtleistung des Inhalts sicherzustellen. |
...
| Dezember 2023 | Administration | [Hinzufügen von Produktadmins](https://experienceleague.adobe.com/de/docs/platform-learn/tutorials/admin/add-product-administrators.html?lang=de) | Video | Erfahren Sie, wie Sie in [!DNL Admin Console] neue Admins zu Adobe [!DNL Experience Platform] hinzufügen. Admins können zusätzliche Admins, Benutzende, Entwickelnde und API-Anmeldeinformationen hinzufügen und verwalten. |
...
* Die angekündigten Aktualisierungs-Rollouts für die [Build-Umgebung](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details.html?lang=de), die [mit Cloud Manager-Version 2023 begonnen wurden](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/cloud-manager/2023/2023-10-0.html?lang=de), sind abgeschlossen.
   ...
   * Maven wurde auf Version 3.8.8 aktualisiert.
      ...
      * [Adobe empfiehlt](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details.html?lang=de) Benutzenden, ihre Maven-Repositorys zu aktualisieren, damit sie HTTPS anstelle von HTTP verwenden.
