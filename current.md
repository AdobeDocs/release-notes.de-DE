...
* **[!DNL Commerce]** | _Commerce &amp; Coffee: Stärkung des B2B-Erfolgs_ | **22. Juni um 13:00 Uhr ET** | [registrieren](https://register.gotowebinar.com/register/2180200047542819420)

* **[!DNL Experience Manager]** | _Übergeordnet die Art der Experience Manager Zertifizierung - Bereit, Einrichten, Zertifizierung!_ | **28. Juni um 8:00 Uhr PT** | [registrieren](https://adobe.ly/3Ni6XeL)
...
Bestehende Kunden können weiterhin ihre [!DNL DIL] Implementierung. Die Adobe wird sich jedoch nicht entwickeln [!DNL DIL] über diesen Punkt hinaus. Kunden wird empfohlen, [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=de) für ihre langfristige Datenerfassungsstrategie. Kunden, die nach Juli 2023 neue Datenerfassungs-Integrationen implementieren möchten, sollten [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=de) anstatt.
...
>[!IMPORTANT]
>
>Adobe empfiehlt Ihnen ein [Upgrade auf die neueste Version 1.9.10](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets-view/integrations/workfront-connector-install.html?lang=en) des für Experience Manager erweiterten Workfront-Connectors. <!-- NEW. LEAVE IN FOR JUNE 7 -->
