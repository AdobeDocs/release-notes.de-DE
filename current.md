...
| 22. Juli 2020 | [Grundlagen zum Erstellen von Segmenten](https://docs.adobe.com/content/help/en/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/the-basics-of-creating-segments.html) | Tutorial | Walk through the fields in the UI to create a segment in Audience Manager. |
...
| 17. Juli 2020 | [Suppress ads to converters](https://video.tv.adobe.com/v/36658?captions=ger) | Tutorial | Save money and optimize customer experience by suppressing ads to converters. |
...
| 21. Juli 2020 | [Aktualisieren der Sprachkopie mit Starts](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/updating-language-copy.html) | Tutorial | Learn how to update, review, and approve changes in a [!UICONTROL Language Copy] with the help of Launches. |
| 21. Juli 2020 | [Overview of Multi-Site Management](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/language-copy-overview.html) | Tutorial | Verschaffen Sie sich einen Überblick darüber, wie eine mehrsprachige Site mit [!UICONTROL Sprachkopie] in [!UICONTROL AEM Sites]erstellt wird. |
...
| 21. Juli 2020 | [Manage Live Copy inheritance on a page](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/manage-page-inheritance-live-copy.html) | Tutorial | Learn how to manage inheritance between a [!UICONTROL Live Copy] and its [!UICONTROL Blueprint] at a page level. |
