...
* [Experience Platform Launch](https://docs.adobelaunch.com/) (Links zur Produkthilfe)
...
Die Produktdokumentation finden Sie unter [Experience Cloud und Core Services](https://marketing.adobe.com/resources/help/de_DE/mcloud/)
...
| Funktion | Beschreibung |
| -----------| ---------- |  
| [Eigenschaftsempfehlungen](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/segments/trait-recommendations.html) | Eigenschaftsempfehlungen, bereitgestellt von [Adobe Sensei](https://www.adobe.com/sensei.html), bringen die Datenwissenschaft in Ihre Day-to-Day-Workflows für Audience Manager. <br> Bei Eigenschaften-Recommendations erhalten Sie beim Erstellen oder Bearbeiten eines Segments in [Segment Builder](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/segments/segment-builder.html)Empfehlungen zu weiteren Eigenschaften, die Sie einbeziehen können, die den Eigenschaften in der Segmentregel ähneln. Fügen Sie die empfohlenen Merkmale zu Ihrem Segment hinzu, um Ihre Zielgruppe zu erweitern. |
...
| Funktion | Beschreibung |
| -----------| ---------- | 
| Suchkampagnen | In der Datumsbereichsauswahl wird der Kalender nun von Sonntag bis Samstag angeordnet. Zuvor wurde er von Sonntag bis Samstag angeordnet. |
...
Aktuelle Versionsinformationen zu den folgenden Produkten finden Sie in den [Adobe Target-Versionshinweisen](https://docs.adobe.com/content/help/en/target/using/release-notes/target-release-notes.html).
...
* [AEM Forms CFP Releases](https://helpx.adobe.com/de/aem-forms/kb/aem-forms-releases.html)
...
* [Livefyre-Versionshinweise](https://marketing.adobe.com/resources/help/de_DE/livefyre/c_rn.html)
