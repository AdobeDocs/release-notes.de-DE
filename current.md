...
* **ANALYTICS** | Experience Maker: Der Qualifikationsaustausch | _Kompetenzaustausch auf Adobe Summit für Adobe Analytics_ | Am 28. März 2024 veranstalten wir den Adobe Analytics Skill Exchange auf dem Gipfeltreffen in Las Vegas! Registrieren Sie sich jetzt, um Tipps, Tricks und Best Practices von Analytics-Kunden und -Champions zu erfahren. | **28. März, 09:00 Uhr PT** | [Registrieren](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=952%20953)

* **EXPERIENCE MANAGER** | Experience Maker: Der Qualifikationsaustausch | _Kompetenzaustausch bei Adobe Summit für AEM_ | Am 28. März 2024 veranstalten wir den AEM Skill Exchange auf dem Gipfel in Las Vegas! Registrieren Sie sich jetzt, um Tipps, Tricks und Best Practices von AEM Kunden und Champions zu erfahren. | **28. März, 09:00 Uhr PT** | [Registrieren](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=950%20951)

* **EXPERIENCE MANAGER** | Experience Maker: Der Qualifikationsaustausch | _Kompetenzaustausch bei Adobe Summit für Marketo Engage_ | Am 28. März 2024 veranstalten wir den Marketo Engage Skill Exchange auf dem Summit in Las Vegas! Registrieren Sie sich jetzt, um Tipps, Tricks und Best Practices von Marketo Engage-Kunden und Champions zu erfahren. | **28. März, 09:00 Uhr PT** | [Registrieren](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=954%20955)

* **WORKFRONT** | Experience Maker: Der Qualifikationsaustausch | _Kompetenzaustausch auf Adobe Summit für Workfront_ | Am 28. März 2024 veranstalten wir den Adobe Workfront Skill Exchange auf dem Gipfeltreffen in Las Vegas! Registrieren Sie sich jetzt, um Tipps, Tricks und Best Practices von Workfront-Kunden zu erfahren. | **28. März, 09:00 Uhr PT** | [Registrieren](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=956%20957)

* **WORKFRONT** | Community-Veranstaltung | _Connect: Admin-Chat für Marketing und Kreativität_ | Sind Sie Systemadmin eines Marketing- oder Kreativ-Teams? Diese kundengesteuerte Sitzung verbindet Sie mit anderen Admins, um Best Practices sowie Tipps und Tricks zu besprechen. | **5. April um 9:00 Uhr PT** | [registrieren](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,S3qiBpspOUyiG7Vl_PtPXg,rFPUK2gma0OCogFhuCyzjw,nTcEntnvgkePuH01JzrsQw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
Informationen zu [Inhaltsversorgungskette](https://business.adobe.com/de/solutions/adobe-genstudio.html), Adobe eine End-to-End-Lösung zur Beschleunigung und Vereinfachung Ihrer Inhalte mit generativer KI und intelligenter Automatisierung.

+++Details

| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Februar 2024 | [Tutorials der Inhaltsversorgungskette](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | Videos | Sehen Sie sich Tutorials zur Inhaltskette auf Experience League an. Die Content-Lieferkette ist eine Komplettlösung, mit der Sie Ihre Content-Lieferkette durch generative KI und intelligente Automatisierung beschleunigen und vereinfachen können. |
...
* [Mittwoch, 30. Januar 2024](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2024/02142024.html#status)
...
**Experience Platform-Berechtigungen**

Fehlerbehebungen:

* Sie können jetzt beim Anzeigen oder Ändern Ihrer Anmeldedaten nach einer API-Berechtigung anhand des Namens suchen.
* Informationen zur Benutzergruppenmitgliedschaft sind jetzt für jede Rolle verfügbar, wenn die Benutzerliste auf der Registerkarte &quot;Rollen&quot;angezeigt wird. Die **[!UICONTROL Rolle entfernen]** ist nur für Benutzer deaktiviert, denen über eine Benutzergruppe eine Rolle zugewiesen wurde.
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|----|----|-----------|
| Februar 2024 | [[!UICONTROL Erfassung von Standardwerten] in [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23641.html) | Neuer Artikel | Erfahren Sie, wie Sie während der Aufnahme einen Standardwert festlegen müssen in [!DNL Adobe Experience Platform (AEP)], insbesondere für [!DNL upsert] -Vorgänge verwenden, müssen Sie explizite Zuordnungen im Datenerfassungsprozess verwenden. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Februar 2024 | [Erstellen von Datenelementen in Experience Platform-Tags für die Analytics-Implementierung](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html) | Video | Erstellen Sie Datenelemente für Ihre [!DNL Analytics] Implementierung in Tags basierend auf den Variablen und Ereignissen, die in einem Dokument zur Lösungsdesign-Referenz (Solution Design Reference, SDR) dokumentiert sind. |
| Februar 2024 | [Erstellen einer globalen Seitenregel in Experience Platform-Tags](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-a-global-page-rule-in-tags.html) | Video | Erfahren Sie, wie Sie eine globale Seitenregel für Datenpunkte einrichten, die Sie auf jeder Seite mit Experience Platform-Tags an Adobe Analytics senden möchten. |
| Februar 2024 | [Validieren der globalen Seitenladeregel in Experience Platform-Tags](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/validating-your-global-page-load-rule-in-tags.html) | Video | Erfahren Sie, wie Sie Ihre globale Seitenladeregel mit dem Experience Platform-Debugger überprüfen. |
| Februar 2024 | [Erstellen von Experience Platform-Tags-Regeln für Erfolgsereignisse](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-success-events.html?lang=en) | Video | Erfahren Sie, wie Sie mithilfe von Regeln in Tags Konversionsereignisse (Erfolgsereignisse) auf Ihrer Site verfolgen können. |
...
| Februar 2024 | [Festlegen interner URL-Filter](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/set-internal-url-filters.html?lang=en) | Video | Erfahren Sie mehr über die Einstellungen für verweisende Stellen, indem Sie sie entweder als interne verweisende Stellen (zur Leistungsaufnahme der Pfadberichte) oder als externe verweisende Stellen festlegen (um die Berichte zur verweisenden Stelle/Referrer-Domäne zu aktivieren). |
| Februar 2024 | [Tags - Ihr persönlicher Assistent](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/analytics/analysis-workspace/tips-and-tricks/tags-your-personal-assistant.html) | Artikel | Erfahren Sie, wie Experience Platform-Tags Ihre digitale Analyse optimieren können, indem sie als Ihr persönlicher Assistent fungieren und effizient finden, was Sie benötigen. Jeff Bloomer, Adobe Analytics Champion, teilt Experteneinblicke zur Maximierung des Potenzials des Tools für Sie. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|----|----|-----------|
| Februar 2024 | [Vom Projektlink (URL) generierte Änderungen bei der Freigabe eines Adobe Analytics Workspace](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html) | Neuer Artikel | Dieser Artikel bietet eine Lösung für das Adobe Analytics-Problem, bei dem sich ein Projektlink ändert, sobald ein Workspace-Projekt-Link in einem freigegebenen Adobe Analytics-Arbeitsbereich abgerufen wird. Sie können entweder den neu generierten Link oder den zuvor generierten Link für den Zugriff auf das Zielprojekt verwenden. |
...
| Veröffentlicht | Anwendungen | Name | Typ | Beschreibung |
| ----------| ---------- | ---------- | ---------- |---------- |
| Februar 2024 | Experience Manager Assets | [Automatisch startende Workflows](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/auto-start-workflows.html?lang=de) | Video | Erfahren Sie, wie Workflows die Asset-Verarbeitung in automatisch starten [!DNL AEM as a Cloud Service] durch automatisches Aufrufen eines benutzerdefinierten Workflows beim Hochladen oder erneuten Verarbeiten nach Abschluss der Asset-Verarbeitung. |
| Februar 2024 | Experience Manager Sites | [Einrichten der Dokumenterstellung](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html) | Video | Eine Anleitung zum Einrichten der Dokumenterstellung für Autoren und Autorinnen. |
| Februar 2024 | Experience Manager Sites | [Dokument-Workflows](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | Video | Erfahren Sie, wie Sie Dokument-Workflows mit der AEM-Dokumenterstellung verwenden. |
| Februar 2024 | Experience Manager Sites | [Dokumentversionen](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Video | Erfahren Sie, wie Sie Dokumente versionieren, die mit der AEM-Dokumenterstellung erstellt wurden. |
| Februar 2024 | AEM CS | [Cloud 5 - Suche von Drittanbietern](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html) | Video | Erfahren Sie, wie die Suche von Drittanbietern am besten in Edge Delivery Services integriert werden kann. |
| Februar 2024 | Experience Manager Assets | [AEM Assets-Ereignisse für die PIM-Integration](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/assets-pim-integration.html) | Video | Erfahren Sie, wie Sie AEM Assets in ein Drittanbietersystem integrieren können, z. B. in ein Produktinformationsmanagement- (PIM-) oder Produktinformationsmanagement-(PLM-)System, um Asset-Metadaten mithilfe von nativen AEM I/O-Ereignissen zu aktualisieren. |
| Februar 2024 | AEM Headless | [Benutzerdefinierte Felder](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Video | Erfahren Sie, wie Sie benutzerdefinierte Felder im Inhaltsfragment-Editor AEM erstellen. |
| Februar 2024 | Experience Manager, AEM Cloud Manager, Marketo Engage | [Tipps und Tricks zu AEM - Verwendung von Anmeldungen in Cloud Manager](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/cloud-manager-using-logs.html) | Video | Sehen Sie sich diese Tipps von Ihrem AEM-Champion Rami EL Gamal an. In diesem Video führt Rami Sie durch das Herunterladen von Protokollen in Cloud Manager und gibt dabei Best Practice-Tipps. |
| Februar 2024 | AEM CS | [Cloud 5 - Real User Monitoring (RUM)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=en) | Video | Erfahren Sie mehr über die Analyse der Echtzeit-Benutzerüberwachung (RUM), die Adobe seinen AEM Sites anbietet, die mit Edge Delivery Services bereitgestellt werden, und wie RUM zur Verbesserung einer Website verwendet werden kann. |
| Februar 2024 | Experience Manager Forms | [Generieren von PDF mit Daten aus der auf Kernkomponenten basierenden Formularübermittlung](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html) | Video | Zusammenführen von Daten aus der Kernkomponentenbasierten Formularübermittlung mit der XDP-Vorlage im Workflow. |
| Februar 2024 | AEM Cloud Manager | [AEM Champion Best Practices und Tipps - Vorbereitung und Planung einer Migration zu AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Video | Erfahren Sie mehr über die fachkundige Beratung und Best Practices von Ihrem AEM-Champion Wilson Faure. In diesem Video navigiert er durch die Komplexität der Planung und Vorbereitung der Migration auf AEM as a Cloud Service. |
| Februar 2024 | Experience Manager Sites | [Cloud 5 - Edge-Sekundäre](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | Video | Erfahren Sie, wie wichtig Edge-Mitarbeiter in AEM Sites und Edge Delivery Services sind und wie Sie sie in Ihre Back-End-Systeme integrieren können. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|--------|---------|---------|
| Februar 2024 | [[!DNL CDN] Vorlage in [!UICONTROL Anwendungseinstellungen] speichert nicht](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | Neuer Artikel | Erfahren Sie mehr über die Problemumgehung bei der [!DNL CDN] Vorlage in [!UICONTROL Anwendungseinstellungen] kann nicht gespeichert werden. |
| Februar 2024 | [JDK 11-Ursachen `NoClassDefFoundError` [!DNL AEM] 6,5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | Neuer Artikel | Erfahren Sie, wie Sie die [!DNL CXF] -Pakete extern zur Lösung des Problems der `NoClassDefFoundError` nach einem Upgrade auf [!DNL Java™] 11 mit [!DNL AEM] 6,5x. |
| Februar 2024 | [Qualifizieren eines [!DNL AEM as Cloud Service] Support-Ticket](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | Neuer Artikel | Erfahren Sie, wie Sie ein Ticket vollständig qualifizieren können, damit der Support das Problem schnell verarbeiten und verstehen kann und welche Informationen benötigt werden. |
| Februar 2024 | [Erfahren Sie mehr über das Ändern des Servers und [!DNL JVM] Zeitzone zu Europa/Paris in [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Neuer Artikel | Erfahren Sie mehr über das Ändern des Servers und [!DNL JVM] Zeitzone zu Europa/Paris in [!DNL AEM as a Cloud Service]. |
| Februar 2024 | [Workflows werden nach der Codebereitstellung auf &quot;nicht bearbeitbar&quot;gesetzt](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Neuer Artikel | Erfahren Sie, wie Sie die [!DNL AEM] Problem, bei dem nach dem Erstellen eines Workflows in [!DNL AEM] gefolgt von einer Code-Bereitstellung, die [!UICONTROL Workflow] als &quot;Nicht bearbeitbar&quot;angezeigt. Als Best Practice sollten Sie Ihre [!UICONTROL Workflow] -Modelle in der Codebase konsistent über mehrere Umgebungen hinweg, sodass Sie nicht neu erstellen müssen [!UICONTROL Workflows] pro Umgebung. |
| Februar 2024 | [[!DNL DDoS] Überlastung von Angriffen oder Bots [!DNL AEM] mit Traffic](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | Neuer Artikel | Erfahren Sie, wie Sie dieses Problem beheben können, indem Sie die Protokollierung auf Dispatcher-Ebene aktivieren und Maßnahmen zur Verbesserung der Dispatcher-Zwischenspeicherung ergreifen, um durch Traffic-Spitzen verursachte Ausfälle zu vermeiden. |
| Februar 2024 | [Allgemeine Probleme und Lösungen bei der Asset-Erfassung](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | Neuer Artikel | Erfahren Sie mehr über die häufigsten [!DNL AEM] Problemszenarien bei der Asset-Erfassung und deren Analyse, einschließlich hoher Verarbeitung, hoher Menge und großer Datenmengen [!DNL DAM] Repositorys und viele gleichzeitige Autoren. |
| Februar 2024 | [Maximale Variationsbeschränkung, Leistungs- und Aufbewahrungsrichtlinien für [!UICONTROL Inhaltsfragmente]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | Neuer Artikel | Erfahren Sie mehr über die maximale Anzahl der Varianten, die innerhalb einer einzelnen [!UICONTROL Inhaltsfragment], ob mehrere Varianten zur Langsamkeit der Website beitragen und ob eine Aufbewahrungsrichtlinie für gelöschte [!UICONTROL Inhaltsfragmente]. |
| Februar 2024 | [[!UICONTROL Löschanfrage] Workflow beim Löschen von Inhalten ausgelöst](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | Neuer Artikel | Erfahren Sie, wann sich ein Benutzer anmeldet und eine Seite oder ein Asset in [!DNL AEM], wird[!UICONTROL Löschanfrage]&quot; Workflow ausgelöst. |
| Februar 2024 | [[!DNL HTML] Datei gespeichert in [!DNL CRX] nicht im Browser geöffnet, stattdessen heruntergeladen wird](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | Neuer Artikel | A [!DNL HTML] direkt in der [!DNL Oak] Repository wird nicht im Browser geöffnet. Stattdessen wird sie in [!DNL AEM 6.1 SP2] und späteren Versionen. |
| Februar 2024 | [[!DNL Adobe Experience Manager]: `WARN` Meldung von `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | Neuer Artikel | Erfahren Sie mehr über das Problem während [!DNL AEM 6.5] Start, `WARN` Nachrichten werden mehrmals im `error.log`. |
| Februar 2024 | [[!DNL Adobe Experience Manager]: Der Knoten mit `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | Neuer Artikel | Erfahren Sie mehr über das Problem, wenn in einigen Fällen Knoten mit `sling:resourceType` Wert von `wcm/msm/components/ghost` existieren. In diesem Artikel wird erläutert, wie der Knoten erstellt wird. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Februar 2024 | [Abfragen mit der Adobe Commerce-Datenbank verbinden und ausführen](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/remote-db-connection-execute-queries.html?lang=en) | Video | Erfahren Sie, wie Sie eine Verbindung zu einem Adobe Commerce-On-Cloud-Projekt herstellen, eine Datenbank für die Verwendung außerhalb der Website ablegen, PII maskieren und entfernen können. |
| Februar 2024 | [Commerce Cloud - Technisches Onboarding und Übergabe von Hardware - Launch-Prozess-Timeline](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-commerce-cloud/technical-onboarding-hardware-handoff/launch-process-timeline.html) | Video | Erfahren Sie mehr über das technische Onboarding von Adobe Commerce Cloud für die Zeitleiste des Launch-Prozesses. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|--------|---------|---------|
| Februar 2024 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html?lang=de) | Neue Artikel | Neue Artikel zum Anwenden von Patches, die in [!DNL QPT] 1.1.44 [!DNL QPT] 1.1.45 und [!DNL QPT] 1.1.46 wurden veröffentlicht und sind in den jeweiligen Abschnitten zu finden. |
| Februar 2024 | [Mehrere Zeilen in der Datenbank für dieselbe Entität](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/database/multiple-rows-in-database-for-same-entity.html) | Neue Artikel | Dieser Artikel bietet eine Lösung für das Problem, dass es mehrere Zeilen für dieselbe Entitäts-ID in der Datenbank gibt. |
| Februar 2024 | [Recommendations [!DNL JS] Fehler nach der Aktualisierung auf Adobe Commerce Version 2.4.5](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | Neue Artikel | Dieser Artikel enthält eine Fehlerbehebung, wenn nach der Aktualisierung auf Adobe Commerce (alle Bereitstellungsmethoden) [!DNL JS] Fehler in der Konsole in Bezug auf die Recommendations-Produktmodule/-einheiten. |
...
Für Adobe Campaign veröffentlichte neue oder aktualisierte Video-Tutorials.
...
| Februar 2024 | Campaign-Web-Benutzeroberfläche | [Webbenutzeroberfläche von Campaign](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/getting-started/explore-the-web-ui.html) | Video | Erfahren Sie, wie Sie auf die Campaign Web-Benutzeroberfläche zugreifen und darin navigieren können und wie Sie die Inventarlisten anpassen können. Erfahren Sie mehr über den KI-gestützten Wissensassistenten. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|----|----|-----------|
| Februar 2024 | [Das Fenster der Versandvorlagen wird bei der Verbindung mit nicht korrekt angezeigt. [!DNL Campaign Console] via [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Neuer Artikel | Erfahren Sie mehr über die Lösung des Problems bei der Verbindung zu [!DNL Adobe Campaign Console] via [!DNL VPN]werden die Versandvorlagendaten nicht im Fenster angezeigt. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
|---------|----|----|-----------|
| Februar 2024 | [Kapselung von Funktionen beim Erstellen von Ausdrücken mit dem Operator &quot;+&quot;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23749.html) | Neuer Artikel | Erfahren Sie, wie jeder Funktionsaufruf bei Verwendung des Operators &quot;+&quot;mit Klammern versehen werden muss. |
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Februar 2024 | [!DNL Adobe Firefly] | [Discover Adobe Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html?lang=en) | Video | Entdecken Sie die Adobe Firefly der Kreativität mit generativer KI, entwickelt für die kommerzielle Sicherheit und Innovation. |
| Februar 2024 | [!DNL Adobe Firefly] | [Landingpage](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | Video | Erfahren Sie, wie Sie mit der Verwendung von Adobe Firefly beginnen. |
| Februar 2024 | [!DNL Adobe Firefly] | [Generische Füllung](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html?lang=en) | Video | Erfahren Sie, wie Sie mit der generativen Füllung mit einfachen Textanforderungen problemlos Inhalte aus Ihren Bildern hinzufügen, erweitern oder entfernen können. Generative Füllung ermöglicht es Ihnen, Ihre Kreativität zu verbessern und außergewöhnliche Projekte zu erstellen. |
| Februar 2024 | [!DNL Adobe Firefly] | [Generativer Recolor](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html?lang=en) | Video | Erfahren Sie, wie Sie sofort eine Vorschau verschiedener Farbvarianten für Ihre Produktverpackungen, Poster oder Grafiken in Vektordateien anzeigen können. Mit der generativen Farbe können Sie so schnell wie möglich eine neue Farbe erstellen. Experimentieren Sie mit einfallsreichen Ideen, machen Sie sich Gedanken über verschiedene Themen oder Paletten und produzieren Sie mehrere Varianten. |
| Februar 2024 | [!DNL Adobe Firefly] | [Beispiele für die Verwendung von Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html?lang=en) | Video | Erfahren Sie, wie Sie mit Firefly inspirierende PowerPoint-Präsentationen, Stimmungsboards, Ideen, Bildschirmschoner und mehr erstellen können. |
| Februar 2024 | [!DNL Adobe Firefly] | [Texteffekte](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/text-effects.html?lang=en) | Videos | Erfahren Sie, wie Sie mit einfachen Textanforderungen eindeutigen und inspirierenden Text für Ihre Projekte erstellen. Mit Texteffekten können Sie Ihre Kreativität verbessern und außergewöhnlichen Text für Ihre Projekte erstellen. |
