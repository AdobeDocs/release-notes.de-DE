...
* Neue [Kurse](https://experienceleague.adobe.com/de/courses) auf Experience League:

  Neue Kurse bieten strukturiertes, von Fachleuten erstelltes Lernen, das Marketing-Experten, Fachleuten, Administratoren, Entwicklern und anderen dabei hilft, Fähigkeiten schneller zu entwickeln, Fachwissen zu validieren und sicherer über Adobe-Lösungen hinweg voranzukommen. Jeder Kurs endet mit einem teilbaren Abschlusszertifikat, das Ihnen eine greifbare Möglichkeit gibt, Ihre Leistungen intern oder auf LinkedIn hervorzuheben.

* [Agentic AI in AEM](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/overview?#agentic-ai-in-aem)
* Updates für die Events im November, neue Video-Tutorials und aktualisierte Support-Artikel auf dieser Seite.
