...
| ----------- | ---------- | ---------- |
| Anmelde-Update auf [!UICONTROL Report Builder] | Dienstag, 9. April 2021 | Ab 14. Januar 2021: Die Verbesserungen am Anmeldeprozess [!UICONTROL Report Builder] entfernen Abhängigkeiten von älteren Technologien und richten den Anmeldeprozess an Adobe Experience Cloud aus. Experience Cloud verwendet Ihre Enterprise ID (E-Mail und Passwort). <br>Um den unterbrechungsfreien Zugriff auf  [!UICONTROL Report Builder] sicherzustellen, aktualisieren Sie das  [!UICONTROL Report ] Builder-Add-In bis zum 22. Juli 2021 auf Version 5.6.47 oder höher. Report Builder Version 5.6.47 und höher unterstützt nur die Anmeldung beim Experience Cloud und unterstützt kein Single Sign-On. |
