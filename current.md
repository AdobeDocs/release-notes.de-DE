...
* [Versionshinweise zur Datenerfassung in Experience Platform](https://experienceleague.adobe.com/docs/launch/using/release-notes/current.html?lang=de) (früher Experience Platform Launch) - Aktualisiert am **22. April 2021**
...
| Mai 2021 | [Formatieren von Metriken in Datenansichten](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/formatting-metrics-in-data-views.html?lang=en) | Video | Erfahren Sie mehr über die Optionen zum Formatieren von Metriken im Komponentenbildschirm der Konfiguration [!UICONTROL Datenansicht]. In diesem Video finden Sie außerdem einige Tipps, die Ihnen helfen, Ihre Komponenten besser zu nutzen. |
...
| Mai 2021 | [Schnelles Setup für SPA-Editor und Remote SPA](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/spa-editor/remote-spa/quick-setup.html?lang=de) | Artikel | Das schnelle Setup ist eine kurze Anleitung, die veranschaulicht, wie die WKND-Mobile-App installiert und ausgeführt und als Remote-SPA eingesetzt wird und wie die Bearbeitung mit dem AEM-SAP-Editor erfolgt. |
...
In den [!DNL Marketo Engage] [Versionshinweisen](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/documentautomation.html#integrations) finden Sie die neuesten Informationen zum Versionsplan.
