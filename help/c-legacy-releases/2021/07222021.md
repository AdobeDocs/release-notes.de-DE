---
title: Zentrale Versionshinweise – Juli 2021
...
| ------- | ------- | -------|
| ![Globale Suche](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html#globally-search-for-objects-and-entities) in Experience Cloud | &#x200B;5. Juli 2021 | Ab dieser Version wird bei der globalen Suche in Experience Cloud auch Journey Orchestration zur Suche nach Geschäftsobjekten wie Segmenten, Datensätzen, Schemata und mehr hinzugefügt. |
...
* **Juli 2021:** Journey Optimizer ist jetzt verfügbar. [Weitere Informationen](https://experienceleague.adobe.com/docs/journey-optimizer/using/ajo-home.html?lang=de).
...
**Wann:** 29. Juli 2021 um :00 Uhr MESZ
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
      ...
      * **KI-gestützte Dokumentation** - Smart-Tagging-Funktion zur automatischen Identifizierung und Extrahierung relevanter Metadaten-Schlüsselwörter aus dem Text für Metadaten-Labels.
   ...
   * **Cloud Manager in AEM as a Cloud Service**
      ...
      * Auf der Seite „Umgebungsdetails“ werden jetzt ggf. mehrere Domain-Namen für Veröffentlichungs- und Vorschau-Services angezeigt. Siehe [Umgebungsdetails](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html).
   ...
   * **Experience Manager Assets as a Cloud Service**
     ...
     Neue Funktionen im Vorabversionskanal von Assets:
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Juli 2021 | [Experience Manager Guides](https://experienceleague.adobe.com/docs/experience-manager-guides-learn/tutorials/overview.html) | Artikel | Erfahren Sie, wie [!UICONTROL XML Documentation] alle zentralen CCMS-Funktionen wie Zusammenarbeit, Überprüfung, Übersetzung, Suche und Berichte für DITA-Inhalte bietet. Diese Funktionen ermöglichen es Autoren, durch effiziente Wiederverwendung von Inhalten und leistungsstarke Workflows zeitsparender zu arbeiten. |
...
* [Versionshinweise zu Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=de)
...
| -----------| ---------- | ---------- | ---------- |
| Juli 2021 | [Verfeinern von Zielgruppen durch Kombinieren von Abfrageergebnissen](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/targeting-workflows/refine-targets-by-combining-query-results.html) | Campaign v8 | Erfahren Sie, wie Sie Ihre Zielgruppe verfeinern können, indem Sie Abfrageergebnisse in einem Workflow kombinieren und dabei die Schnittmengen- oder Vereinigungsaktivität nutzen. |
