...
Aktualisiert: **Donnerstag, 6. Januar 2021**

| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Donnerstag, 23. Dezember 2020 | [Übersicht über Vereinigungsschemata](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/union-schemas-overview.html?lang=de) | Video | Erfahren Sie mehr über die Vereinigungsschemata, die das Echtzeit-Kundenprofil von Adobe Experience Platform verwendet. |
| Mittwoch, 22. Dezember 2020 | [Erstellen von Segmenten mit mehreren Entitäten](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/create-multi-entity-segments.html?lang=de) | Video | Erfahren Sie, wie Sie mit Segment Builder von Adobe Experience Platform Segmente mit mehreren Entitäten aufbauen können. |
| Dienstag, 21. Dezember 2020 | [Kollektionen erstellen](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-collections.html?lang=de) | Video | Erfahren Sie, wie Sie in [!UICONTROL Offer Decisioning] Sammlungen erstellen. Sammlungen werden verwendet, um Angebote in logischen Gruppen zu verwalten, und sind zum Erstellen von Offer Decisioning-Aktivitäten erforderlich. |
| Dienstag, 21. Dezember 2020 | [Unterbreiten von Angeboten mithilfe der Decisions-API](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/deliver-offers-with-the-decisions-api.html?lang=de) | Video | Erfahren Sie, wie Sie mit der Decisions-API [!UICONTROL Offer Decisioning]-Angebote unterbreiten. |
| Mittwoch, 15. Dezember 2020 | [Personalisierte Angebote erstellen](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-personalized-offers.html?lang=de) | Video | Erfahren Sie, wie Sie in [!UICONTROL Offer Decisioning] personalisierte Angebote erstellen. |
| Mittwoch, 15. Dezember 2020 | [Fallback-Angebote erstellen](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-fallback-offers.html?lang=de) | Video | Erfahren Sie, wie Sie in [!UICONTROL Offer Decisioning] Fallback-Angebote erstellen. |
...
* [Produktdokumentation und Tutorials zu Adobe Analytics](https://experienceleague.adobe.com/docs/analytics.html?lang=de)
...
Experience Manager 6.5, Service Pack 7 (6.5.7.0, veröffentlicht am 26. November 2020) ist ein wichtiges Update mit neuen Funktionen, wichtigen Kundenverbesserungen, verbesserter Leistung, Stabilität und Sicherheit, das seit der allgemeinen Verfügbarkeit von Experience Manager 6.5, April 2019, veröffentlicht wurde.
   ...
   * [Ergebnisse der AEM Forms-Version](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=de#forms-updates)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager Assets as a Cloud Service**
      ...
      * Die Integration in Adobe InDesign Server steht jetzt für Experience Manager as a [!UICONTROL Cloud Service] zur Verfügung. Sie bietet Automatisierungsfunktionen zur Verarbeitung von Adobe InDesign-Dateien mithilfe von Adobe InDesign Server-Scripting und ermöglicht Benutzern die Verwendung der Benutzeroberfläche für Asset-Vorlagen zum Erstellen von Prospekten oder Anzeigen. Für Experience Manager as a [!UICONTROL Cloud Service] wird nur InDesign Server (von Adobe Managed Services gehostet) unterstützt.
...
Siehe [Hinzufügen von Assets mit der Desktop-Applikation](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/using.html#upload-and-add-new-assets-to-aem).
   ...
   * **Adobe Experience Manager Commerce as a Cloud Service**
      ...
      * Freigabe der CIF Venia-Referenz-Website 2020.12.01, die die neueste CIF-Kernkomponenten Version 1.6.0 enthält.
Siehe [CIF Venia-Referenz-Site](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2020.12.01).
      * Version 1.6.0 von CIF-Kernkomponenten veröffentlicht.
Siehe [CIF-](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.6.0).
...
* [AEM 6.5 - Lernen und Support, Startseite](https://experienceleague.adobe.com/docs/experience-manager-65.html?lang=de)
* [AEM 6.4 - Lernen und Support, Startseite](https://experienceleague.adobe.com/docs/experience-manager-64.html?lang=de)
* [AEM 6.3 - Lernen und Support, Startseite](https://helpx.adobe.com/de/support/experience-manager/6-3.html)
* [AEM 6.2 - Lernen und Support, Startseite](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html?lang=de)
...
| Veröffentlicht | Name | Lösung | Beschreibung |
| ----------- | ----------- | ---------- | ---------- |
| 21. November 2025 | [Erstellen von Advertising Dashboards mit Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html) | Video | Verfahren zum Erstellen eines Advertising Dashboards zum Live-Monitoring von Kampagnen. |
