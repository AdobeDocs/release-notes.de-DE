...
| -Version | Produktfunktion | Typ | Beschreibung |
| -----------| ---------- |---------- |---------- |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Mai 2023 | [Gewähren von Zugriffsberechtigungen für Data Warehouse](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21666.html?lang=de) | Fehlerbehebung | Erfahren Sie, welche Berechtigung hinzugefügt werden sollte, um Zugriffsberechtigungen für Data Warehouse zu gewähren. |
...
[!DNL Customer Journey Analytics] Freigabedatum: **7. Juni 2023**
...
* [Adobe Experience Manager as a Cloud Service-Versions-Updates](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/overview.html?lang=de)
...
* [Versionshinweise zum Experience Manager 6.5 Service Pack](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/release-notes.html?lang=de)
...
| Veröffentlicht | Name | Typ | Beschreibung | Anwendungen |
| -----------| ---------- | ---------- | ---------- | ------|
...
| Mai 2023 | [Pipeline schlägt fehl mit dem Fehler: _Die Eigenschaft end_ aem_createsegmentstore fehlt_](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22091.html?lang=de) | Neuer Artikel | Erfahren Sie, wie Sie das Problem lösen können, wenn die CI/CD-Pipeline mit dem Fehler fehlschlägt: _Die Eigenschaft end_ aem_createsegmentstore fehlt_. |
...
* [Experience Manager as a Cloud Service-Handbücher](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/home.html?lang=de)
...
* [Experience Manager 6.5 - Lernen und Support, Startseite](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/home.html?lang=de)
...
* Mai-Version von [!DNL Campaign Control Panel], bei der SSL-Zertifikate der Subdomains an Adobe delegiert wurden. [Weitere Informationen…](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=de)
...
| Veröffentlicht | Name | Typ | Beschreibung | Anwendung |
| -----------| ---------- | ---------- | ---------- |---------- |
...
* Mai-Version von [!DNL Adobe Journey Optimizer] mit [!UICONTROL Inhaltsexperimentierung] und [!UICONTROL E-Mail]Fragmenten[Weitere Informationen…](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=de)

* [!UICONTROL Entscheidungs-Management] Mai-Version mit [!UICONTROL &#x200B; Ranking-Modell mit &#x200B;]KI für personalisierte Optimierung“. [Weitere Informationen…](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=de)
