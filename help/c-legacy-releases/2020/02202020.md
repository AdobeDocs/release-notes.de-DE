...
* **Labs (Technology Previews):** Diese neue Analytics-Funktion ermöglicht es Ihnen, neue Funktionsprototypen in der Produktion zu testen und wertvolles Feedback an Adobe zu senden. [Weitere Informationen…](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html?lang=de)
...
* [Campaign Classic-Aktualisierung 19.2.3](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-2.html?lang=de)
