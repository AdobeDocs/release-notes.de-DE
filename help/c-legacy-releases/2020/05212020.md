...
Benötigen Sie Hilfe? Unter [[!DNL Experience League]](https://experienceleague.adobe.com/de?lang=de#home) finden Sie von Adobe kuratierte Kurse, technische Dokumentationen, schnelle Antworten, Community-Erkenntnisse und von Schulungsleitenden geführte Schulungen.
...
Aktualisiert: **Samstag, 15. Mai 2020**

[!DNL Adobe Experience Platform] veröffentlicht Aktualisierungen für die Domain und den Header, um Ihr Erlebnis zu verbessern und mit anderen Experience Cloud-Anwendungen zu vereinheitlichen. Zu den Aktualisierungen gehören:
...
| -----------| ------------ | ---------- |
| Bereich [!UICONTROL Analytics for Target] in [!UICONTROL Arbeitsbereich] | 25. Juni 2020 | Im Bedienfeld [!UICONTROL Analytics for Target] (A4T) können Sie Ihre Adobe Target-Aktivitäten und -Erlebnisse in der [&#x200B; [!UICONTROL Analysis Workspace.] analysierenWeitere Informationen…](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/a4t-panel.html?lang=de) |
| Bereich [!UICONTROL „Quick Insights“] in [!UICONTROL Arbeitsbereich] | 25. Juni 2020 | [!UICONTROL Quick Insights] bietet Nicht-Analysten und neuen Benutzern von [!UICONTROL Analysis Workspace] die Möglichkeit, geschäftliche Fragen schnell und einfach zu beantworten. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/quickinsight.html?lang=de) |
| [!UICONTROL Bulk-Dateneinfüge-API] | &#x200B;31. Mai 2020 | Ermöglicht die einfache und unabhängige Erfassung von Analytics-Datenstapeln. Nützlich für Server-seitige und Offline-Daten. [Weitere Informationen…](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) |
...
| [!UICONTROL Adobe Analytics-Dashboards] | &#x200B;21. Mai 2020 | [!UICONTROL Adobe Analytics-Dashboards] ist eine App, mit der Benutzer jederzeit und überall auf Einblicke aus Adobe Analytics zugreifen können. Diese App ist für Führungskräfte gedacht, die unterwegs nach Schlüsselmetriken suchen. Es ermöglicht den Zugriff auf kuratierte, interaktive Scorecards und ist sowohl für iOS als auch für Android verfügbar. [Weitere Informationen…](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/home.html?lang=de) |
...
| Verbesserungen bei der Barrierefreiheit | &#x200B;21. Mai 2020 | Das Adobe Analytics-Team hat mehrere Verbesserungen bei der Barrierefreiheit von Analysis Workspace vorgenommen, darunter eine verbesserte Tastaturnavigation, einen verbesserten Farbkontrast und die Unterstützung für Bildschirmlesehilfen. [Weitere Informationen…](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/workspace-faq/aw-accessibility.html?lang=de) |
...
* Es wurden Latenzprobleme bei der [!UICONTROL Bulk-Aufnahme-API] behoben. (AN-210165)
...
| -----------| ---------- | ---------- |
| Migration zu einer einheitlichen Produkt-Domain | Datum des Inkrafttretens: 28. Mai 2020 | Die Migration zu einer einheitlichen Produkt-Domain für Adobe Analytics, die im Januar 2020 begann, wurde am 28. Mai 2020 abgeschlossen. Adobe Analytics entfernt alle Verweise auf `omniture.com` Domain aus seiner Architektur. Es ist jedoch wichtig, `omniture.com` als Drittanbieter-Cookie zuzulassen. Auf die Zulassungsliste setzen Wenn die Migration der vollständigen Architektur (bald) abgeschlossen ist, werden wir Sie über die Versionshinweise benachrichtigen. Dann ist dieser Schritt nicht mehr erforderlich. [Hier &#x200B;](https://helpx.adobe.com/de/analytics/kb/adobe-ip-addresses.html) Sie eine vollständige Liste der empfohlenen IP-Adressen und Domains, die Sie zulassen sollten.<br>Wenn Ihr Unternehmen Cookies von Drittanbietern blockiert, wenden Sie sich bitte an die Kundenunterstützung, um Ihren Zugriff auf Adobe Analytics wiederzuerlangen. |
...
| Ende der Unterstützung für TLS 1.1 | 3. Oktober 2019 | Bis zum 31. März 2020 wird Adobe Analytics die Unterstützung für TLS 1.1 einstellen. Diese Änderung ist Teil unserer ständigen Bemühungen, die höchsten Sicherheitsstandards zu wahren und die Sicherheit von Kundendaten zu fördern. |
...
* **AEM as a Cloud Service**
   ...
   * Performance-Verbesserungen bei der Dynamic Media-Asset-Aufnahme.
...
| [Erste Schritte mit AEM Assets](https://video.tv.adobe.com/v/37342?captions=ger) | Ein Einführungsvideo zu den ersten Schritten mit AEM Assets für Unternehmenskunden. |
