...
| &#x200B;6. Juli 2020 | [Erstellen von Advertising Cloud Dashboards mit Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/integrations/ad-cloud/create-advertising-cloud-dashboards-with-adobe-analytics.html?lang=de#tutorials) | Tutorial | Verfahren zum Erstellen eines Advertising Cloud Dashboards zum Live-Monitoring von Kampagnen. |
