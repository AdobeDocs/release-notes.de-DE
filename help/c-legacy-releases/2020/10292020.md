...
| Dienstag, 9. November 2020 | [Bereitstellen der Assets auf Ihrem lokalen AEM-Server](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/store-and-retrieve-af-with-2fa/deploy-this-sample.html?lang=de#store-and-retrieve-af-with-2fa) | Video | Erstellen Sie die Datenbank, stellen Sie das benutzerdefinierte OSGi-Paket bereit und importieren Sie die verschiedenen Client-seitigen Artefakte, um den Anwendungsfall auf Ihrer lokalen AEM-Instanz auszuführen. |
| Dienstag, 2. November 2020 | [Erstellen des MyApplication-Formulars](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/store-and-retrieve-af-with-2fa/create-the-myaccount-form.html?lang=de#store-and-retrieve-af-with-2fa) | Artikel | Erstellen des MyApplication-Formulars. Dieses Formular wird zur Bestätigung der eindeutigen Anwendungs-ID und Telefonnummer der Person verwendet, die versucht, das teilweise ausgefüllte adaptive Formular abzurufen. |
...
| Veröffentlicht | Name | Lösung | Beschreibung |
| ----------- | ----------- | ---------- | ---------- |
| 21. November 2025 | [Erstellen von Advertising Cloud Dashboards mit Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html?lang=de) | Video | Verfahren zum Erstellen eines Advertising Cloud Dashboards zum Live-Monitoring von Kampagnen. |
