...
Ein entsprechendes Beispiel finden Sie in der [Dokumentation zur Benutzeroberfläche](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=de) von Experience Cloud.
...
* [Wichtige Hinweise für Analytics-](#aa-notices) (aktualisiert am 13. Juli 2020)
...
| Data Repair API – öffentliche Beta-Version | &#x200B;14. Juli 2020 | Mit der [!UICONTROL Date Repair API] können Sie bestimmte vorhandene Adobe Analytics-Daten löschen oder bearbeiten. [!UICONTROL Data Repair]-Anfragen werden ausgeführt, indem eine Auftragsdefinition an die [!UICONTROL Data Repair-API] übermittelt wird. Diese enthält die Report Suite, den Datumsbereich, die Variablen und die Aktionen, die auf die Daten anzuwenden sind. Bei Beginn der öffentlichen Beta-Version unterstützt die [!UICONTROL Data Repair API] das Löschen von [!UICONTROL Activity Map]-Daten. Weitere Funktionen werden zu einem späteren Zeitpunkt eingeführt. Wenden Sie sich an die Kundenunterstützung, um an der öffentlichen Beta-Version der Data Repair-API teilzunehmen. [Weitere Infos...](https://github.com/AdobeDocs/analytics-2.0-apis/blob/master/data-repair.md) |
...
| -----------| ---------- | ---------- |
| Ende von Adobe Data Connectors | &#x200B;13. Juli 2020 | Adobe Data Connectors basieren auf einer älteren Technologie, die nicht mehr funktionsfähig ist oder unterstützt wird. Im [Adobe Exchange Partner-Programm](https://partners.adobe.com/exchangeprogram/experiencecloud) gibt es einen neuen Standard, der für alle Integrationen übernommen werden sollte, die weiterhin angeboten und unterstützt werden sollen. Das offizielle Ende des Lebenszyklus wurde noch nicht festgelegt, aber wir gehen davon aus, dass es in den nächsten 12 bis 18 Monaten (Mitte 2021 bis Ende 2021) sein wird. [Weitere Infos...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=de) |
...
* Im [Onboarding-Statusbericht](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/onboarding-status-report.html?lang=de) weicht das Datum, das beim Klicken auf einen Balken im Diagramm angezeigt wird, jetzt nicht mehr von dem in der Tabelle angezeigten Datum ab. (AAM-55235)
...
* Mehrere Verbesserungen hinsichtlich der Barrierefreiheit in der gesamten Benutzeroberfläche. (AAM-48956, AAM-49012, AAM-49364, AAM-49363, AAM-49374, AAM-49579, AAM-55037).
...
* **Dynamic Media Classic**
  ...
  Siehe [Adobe Dynamic Media Classic Desktop-App – jetzt verfügbar](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/new-ui-2020.html?lang=de).
...
* **Dynamic Media jetzt mit Unterstützung für 3D-Assets**
   ...
   * Für AEM as a Cloud Service finden Sie nähere Informationen hierzu unter [Arbeiten mit 3D-Assets in Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/assets-3d.html?lang=de).
   * Für AEM 6.5 finden Sie nähere Informationen hierzu unter [Arbeiten mit 3D-Assets in Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/assets-3d.html?lang=de).
...
* **Aktualisierungen der Dokumentation zu AEM 6.5.5 Forms**
   ...
   * Neue Funktionen und Verbesserungen in Version 6.5.5:
      ...
      * [Anpassen der Spalten zum Posteingang in Adobe Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/essentials/inbox.html?lang=de#inbox-admin-control).
      * [Speichern interaktiver Kommunikation als Entwurf.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html?lang=de#save-as-draft)
      * Unterstützung für Oracle WebLogic-Anwendungsserver auf [Einzelserver](https://helpx.adobe.com/content/dam/help/de/experience-manager/6-5/forms/pdf/prepare-install-single-server.pdf)- und [Cluster](https://helpx.adobe.com/content/dam/help/de/experience-manager/6-5/forms/pdf/prepare-install-cluster.pdf)-Installationen.
      * [Verbesserungen der Barrierefreiheit.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=de#accessibility-improvements)
      * [X-509-zertifikatbasierte Authentifizierung für SOAP-basierte Webdienste im Formulardatenmodell.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html?lang=de#configure-soap-web-services)
      * [Oracle RAC-Unterstützung.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=de#other-improvements)
      * [Verbesserte Fehlerprotokollierung in Transaktionsberichten.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=de#view-transaction-reporting-logs)
   * Neue Funktionen und Verbesserungen in 6.4.8.1 Version:
      * [X-509-zertifikatbasierte Authentifizierung für SOAP-basierte Webdienste im Formulardatenmodell.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html?lang=de#configure-soap-web-services)
      * [Verbesserte Fehlerprotokollierung in Transaktionsberichten.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=de#view-transaction-reporting-logs)
...
| 23. Juni 2020 | [Verarbeitungsprofile](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/processing-profiles.html?lang=de) | Video | Verarbeitungsprofile definieren die in AEM as a Cloud Service für Assets erstellten Ausgabeformate. |
| 23. Juni 2020 | [Best Practices für Dynamic Media Classic](https://experienceleague.adobe.com/docs/experience-manager-learn/dynamic-media-classic-tutorial/overview.html?lang=de) | Artikel | Bestehende ebenso wie neue Benutzer finden hier nützliche Informationen rund um Dynamic Media Classic, seine Kernfunktionen sowie die Workflows für die _Erstellung_, das _Authoring_ und die _Bereitstellung_. |
| 23. Juni 2020 | [Debugging von Build und Bereitstellungen von AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/build-and-deployment.html?lang=de) | Artikel | Erfahren Sie, wie Sie ein Debugging von Build und Bereitstellungen von AEM as a Cloud Service vornehmen. |
| 16. Juni 2020 | [Debugging von AEM as a Cloud Service mithilfe von Protokollen](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/logs.html?lang=de) | Artikel | Erfahren Sie, wie Sie AEM as a Cloud Service mit der Hilfe von Protokollen debuggen können. Protokolle sind die erste Anlaufstelle wenn es darum geht, AEM-Anwendungen zu debuggen. Voraussetzung dafür ist allerdings, dass für die jeweils bereitgestellte AEM-Anwendung eine adäquate Protokollierung eingerichtet wurde. |
| 5. Juni 2020 | [Projekt für SPA-Editor](https://experienceleague.adobe.com/docs/experience-manager-learn/spa-react-tutorial/create-project.html?lang=de) | Artikel | Erfahren Sie, wie Sie mit dem AEM-Projektarchetyp (Adobe Experience Manager) ein Maven-Multimodul-Projekt als Ausgangspunkt für eine mit dem AEM SPA Editor integrierte React-Anwendung erstellen. |
...
* Neuer, stabiler Gold Standard-Build – [Weitere Informationen](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html?lang=de#release-19-1-4-build-9032)

#### Campaign Control Panel

* Zustellbarkeitsprüfung für Subdomains – [mehr dazu](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html?lang=de)
...
| ----------- | ----------- | ---------- | ---------- |
| 26. Juni 2020 | [Überblick über die Benutzeroberfläche von Adobe Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/exploring-the-adobe-campaign-classic-user-interface.html?lang=de) | Campaign Classic | In diesem Video lernen Sie die zentrale Benutzeroberfläche von Adobe Campaign Classic kennen und erfahren, wie die Navigation zu und innerhalb der wichtigsten Funktionen erfolgt. |
| &#x200B;8. Juli 2020 | [Installieren und Einrichten des Adobe Campaign-Clients](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/install-and-setup-the-adobe-campaign-client.html?lang=de) | Campaign Classic | Erfahren Sie, wie Sie die Adobe Campaign-Client-Konsole herunterladen und installieren, Verbindungen mit mehreren Umgebung erstellen und verwalten und den Zugriff auf die Adobe Campaign-Client-Konsole überprüfen. |
| 19. Juni 2020 | [Einführung in Adobe Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/introduction-to-adobe-campaign-classic.html?lang=de) | Campaign Classic | Erfahren Sie mehr darüber, wie sich Adobe Campaign Classic in das Adobe Digital Experience-Portfolio einfügt, und lernen Sie seine wichtigsten Funktionen und die damit verbundenen Möglichkeiten kennen. |
| 12. Juni 2020 | [Bereitstellen einer Ad-hoc-Vorlage für den E-Mail-Versand](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/deploying-ad-hoc-email-delivery-template.html?lang=de) | Campaign Classic | Erfahren Sie, wie Sie eine Ad-hoc-Vorlage für E-Mails bereitstellen. |
| 12. Juni 2020 | [Konfigurieren einer Versandvorlage](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/configuring-a-delivery-template.html?lang=de) | Campaign Classic | Erfahren Sie, wie Sie eine E-Mail-Vorlage konfigurieren. |
| 12. Juni 2020 | [Festlegen der Eigenschaften von Versandvorlagen](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/setting-delivery-template-properties.html?lang=de) | Campaign Classic | Erfahren Sie, wie Sie die Eigenschaften von E-Mail-Vorlagen festlegen. |
| 26. Juni 2020 | [Erste Schritte mit der Benutzeroberfläche von Adobe Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/getting-started/getting-started-with-the-ui.html?lang=de) | Campaign Standard | In diesem Video erhalten Sie einen Überblick über die Benutzeroberfläche von Adobe Campaign Standard und darüber, wie Sie zu den wichtigsten Funktionen und Funktionalitäten navigieren. |
| 26. Juni 2020 | [GPG-Schlüsselverwaltung](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/administrating/control-panel/gpg-key-management/gpg-key-management-overview.html?lang=de) | Campaign Standard/Control Panel | Erfahren Sie, wie Sie für die Verschlüsselung von Daten ein öffentlich-privates Schlüsselpaar erstellen und installieren und wie Sie für die Entschlüsselung von Daten einen öffentlichen Schlüssel importieren und installieren. |
...
| Funktion | Beschreibung |
| -----------| ---------- |
| Transparency and Consent Framework zur DSGVO | Advertising Cloud aktualisiert seine Unterstützung für das Transparency and Consent Framework des IAB bis zum 15. August 2020 auf Version 2.0. Derzeit sind keine Änderungen auf Kundenseite erforderlich.  Als Auftragsverarbeiter all unserer Kundinnen und Kunden verfügt Adobe Advertising Cloud über die Möglichkeiten, die den Kundinnen und Kunden zur Verfügung stehen, um ihre Verpflichtungen gemäß der DSGVO zu erfüllen, die für die Nutzung unserer Produkte und Services gelten. |
| Audience Manager-Integration | (Beta nur für Kundinnen und Kunden von Adobe Audience Manager mit Adobe Experience Platform) DSP kann über Adobe Experience Platform verwertbare Protokolldateien mit Daten über die Werbeeinbindung eines Werbetreibenden an Audience Manager senden. In Audience Manager können Werbetreibende die Daten für eine erweiterte Segmentierung und Nutzung in Einblicks-Tools wie Audience Optimization Reports verwenden. |
| Personenbasiertes geräteübergreifendes Diagramm-Targeting | Kundinnen und Kunden von Self-Service-DSP können ein Gerätediagramm (Adobe Device Co-op oder LiveRamp) für personenbasiertes Targeting und Häufigkeits-Management in neuen Kampagnen verwenden. Dies stellt sicher, dass Werbetreibende ihre Zielgruppen über ihre eigenen Geräte erreichen können, aber die Offenlegung begrenzt ist. Darüber hinaus ist die Massenbearbeitung von geräteübergreifenden Targeting-Einstellungen für Platzierungen jetzt in der Beta-Phase. Um die Beta für Ihr Konto zu aktivieren, wenden Sie sich an Ihren Adobe Account Manager. |
| Site-Targeting | „Blacklists“ und „Whitelists“ wurden in die gerechteren Begriffe „blockierte (Sites)“ und „Zielgruppen-Sites“ umbenannt. |
| Flashtalking-Anzeigen | DSP fügt nun automatisch Klickmakros für alle Flashtalking-Anzeigen-Tags über die Workflows für die Erstellung von Einzelanzeigen und die Erstellung von Massenwerbeanzeigen von Drittanbietern ein. |
...
| Funktion | Beschreibung |
| -----------| ---------- |
| [!UICONTROL Warnhinweise (Beta)] | Ihnen steht jetzt eine schreibgeschützte, gefilterte Ansicht mit Daten zu jedem beliebigen Warnhinweis zur Verfügung, von der aus Sie in der entsprechenden Ansicht zur Kampagnenverwaltung eine gefilterte Aufstellung der Entitäten öffnen können, über die sich die Einträge der einzelnen Entitäten bearbeiten lassen. |
