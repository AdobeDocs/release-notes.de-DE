...
* **Aktualisierungen der Dokumentation zu AEM 6.5.5 Forms**
   ...
   * Neue Funktionen und Verbesserungen in Version 6.5.5:
      ...
      * [Verbesserungen hinsichtlich der Barrierefreiheit.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=de#accessibility-improvements)
      * [Authentifizierung für SOAP-basierte Webservices im Formulardatenmodell mittels X.509-Zertifikat.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html?lang=de#configure-soap-web-services)
      * [Unterstützung für Oracle RAC.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=de#other-improvements)
   ...
   * Neue Funktionen und Verbesserungen in 6.4.8.1 Version:
      * [Authentifizierung für SOAP-basierte Webservices im Formulardatenmodell mittels X.509-Zertifikat.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html?lang=de#configure-soap-web-services)
