...
| Unterstützung der [!UICONTROL Anomalieerkennung] | 10. Sept. 2020 | [!UICONTROL Anomalieerkennung] ermöglicht es Ihnen zu identifizieren, welche statistischen Schwankungen von Bedeutung sind und welche nicht. Diese Funktion wird jetzt in [!UICONTROL Customer Journey Analytics unterstützt]. |
...
* **AEM6.5.6.0**
AEM 6.5, Service Pack 6 (6.5.6.0 vom 3. September 2020) ist ein wichtiges Update mit neuen Funktionen, wichtigen Kundenverbesserungen, verbesserter Leistung, Stabilität und Sicherheit, das seit der allgemeinen Verfügbarkeit von AEM 6.5, April 2019, veröffentlicht wurde.
...
* **AEM6.4.8.2**
AEM 6.4, Service Pack 8, Cumulative Fix Pack 2 (6.4.8.2, veröffentlicht am 3. September 2020) ist ein wichtiges Update, das seit der allgemeinen Verfügbarkeit von AEM 6.4, Service Pack 8 (6.4.8.0) im März 2020 mehrere interne und Kunden-Fehlerbehebungen enthält.
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Die Videotranskodierung wird jetzt mit Asset-Mikrodiensten unterstützt. Im Bildschirm [!UICONTROL Processing Profiles] (Verarbeitungsprofile) gibt es einen neuen Abschnitt [!UICONTROL Video] zur Konfiguration der Video-Bit-Rate und Abmessungen (das Ausgabeformat ist MP4 mit H.264-Codec). Weitere Informationen finden Sie unter [Verwalten von Video-Assets.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/manage-video-assets.html?lang=de#transcode-video) Für weitere Transkodierungsoptionen und die Videobereitstellung [!UICONTROL Dynamic Media]-Add-on verwendet werden.
...
* **Experience Manager [!UICONTROL Desktop-Programm]2.0.3.2**
...
* [AEM as a Cloud Service-Benutzerhandbücher](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=de)
