...
| Privacy Service API: CCPA | Der California Consumer Privacy Act (CCPA) erweitert die Datenschutzrechte und den Verbraucherschutz für Einwohner von Kalifornien, USA. Dieses Gesetz trat am 1. Januar 2020 in Kraft.<br><br/>Der CCPA bietet neue Datenschutzrechte, mit denen Verbraucher beispielsweise ihre personenbezogenen Daten einsehen und löschen oder herausfinden können, ob (und an wen) ihre personenbezogenen Daten verkauft oder weitergegeben wurden. Zusätzlich können sie dem Verkauf ihrer personenbezogenen Daten widersprechen.<br><br/>Der Datenschutzdienst unterstützt Anfragen zur Abmeldung vom Verkauf personenbezogener Daten.<br><br/>Der Privacy Service war früher der DSGVO-Service und verfügt weiterhin über alle vorherigen Funktionen, die jetzt erweitert wurden, um CCPA.<br/><br/>[CCPA in Analytics zu unterstützen](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/an-ccpa-overview.html)<br><br/>[Überblick über Privacy Service](https://experienceleague.adobe.com/docs/experience-platform/privacy/home.html?lang=de) |
...
| Bevorstehende Änderung bezüglich des Felds `createDate` für Analytics-Benutzer | &#x200B;30. August 2019 | Im Oktober oder November 2019 wurde das Feld `createDate` für Analytics-Benutzer von US Pacific Time auf einen korrekt formatierten Datums- und Zeitwert mit Zeitzoneninformationen aktualisiert. (AN-183468) |
...
| Funktion | Beschreibung |
| -----------| ---------- |
| [California Consumer Privacy Act (CCPA) – Überarbeitung der Support- und Datenschutzdokumentation](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html) | Der [California Consumer Privacy Act (CCPA)](https://www.caprivacy.org/about), der am 1. Januar 2020 in Kraft trat, gewährt Einwohnern Kaliforniens neue Rechte in Bezug auf ihre personenbezogenen Daten und erlegt bestimmten Unternehmen, die in Kalifornien Geschäfte tätigen, Datenschutzverpflichtungen auf. <br><br> Mit Audience Manager können Sie Ihren Verpflichtungen gemäß den Datenschutzbestimmungen nachkommen, indem Sie Datenschutztools wie den [Adobe Experience Platform Privacy Service ](https://experienceleague.adobe.com/docs/experience-platform/privacy/home.html?lang=de) für Datenzugriffs- und Löschanfragen verwenden. <br><br> Wir haben den aktuellen Prozess [Opt-out-Verwaltung](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html) aktualisiert und die Abmeldung von deklarierten IDs (z. B. CRM-ID) einbezogen. Bei der Abmeldung über eine deklarierte ID werden die deklarierte ID und das zuletzt verbundene Gerät von der Datenerfassung durch Audience Manager ausgeschlossen. Opt-out-Anfragen senden jetzt auch Anfragen zur Aufhebung der Segmentierung an [Zielpartner](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html) die diese Funktion sowohl im Batch als auch in Echtzeit unterstützen. <br><br> Darüber hinaus haben wir unsere Dokumentation [Datensicherheit](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-security.html), [Datenschutz](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html) und [Data Governance](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-governance.html) neu gestaltet, damit Sie die Informationen, die Sie zur Einhaltung der oben genannten Vorschriften benötigen, leichter finden können. |
...
* **NEU: AEM as a Cloud Service**
   ...
   * [Einführung](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/overview/introduction.html)
...
* **Service zur automatischen Formularumwandlung**
   ...
   * [Konfigurieren des Service](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   * [Konvertieren von PDF forms in adaptive Formulare](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)
...
Siehe [Anzeigen einer Vorschau von 3D-Assets](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html).

* **Kernkomponenten**

  Kernkomponenten 2.8.0 ist jetzt gemeinsam mit der [Erstellungsdokumentation](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=de), den [Entwicklerdetails und dem Projektdownload auf GitHub](https://github.com/adobe/aem-core-wcm-components) verfügbar.

* **AEM Projektarchetyp**

  Das [ui.frontend-Modul](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/uifrontend.html) des [AEM-Projektarchetyps](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=de) ist ein nützliches und flexibles Tool, um die Front-End-Entwicklung für Ihr AEM-Projekt zu vereinfachen.
