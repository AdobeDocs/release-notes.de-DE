---
title: Zentrale Versionshinweise – Februar 2022
...
* **Experience Manager-GEMS-Webinar: _Schnellere Erstellung von Sites mit Experience Manager Headless und App Builder_**
  ...
  **Time**: :00 Uhr (PST) oder 5 Uhr :00MEZ) oder 9 :00 (IST)
  **Vortragende Person**: Duy Nguyen, Adobe Software Development Engineer
  [Anmeldung zum Webinar unter https://adobe.ly/3oCkEsh](https://adobe.ly/3oCkEsh)
...
| Februar 2022 | [Einbetten von Schriftarten in generierte PDF-Dateien](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/intellij-set-up.html#add-the-fonts-module) | Artikel | Erfahren Sie, wie Sie [!DNL IntelliJ] Community Edition installieren. | AEM Forms CS |
...
| Februar 2022 | [Adobe Commerce 2.4 Aktualisierungs-Workshop](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/upgrade-workshop.html) | Video | Erfahren Sie mehr über die Schritte und Best Practices, die bei der Vorbereitung der nächsten Aktualisierung auf 2.4.4 oder höher ausgeführt werden sollten. |
| Februar 2022 | [Verwenden des Kompatibilitäts-Tools für Aktualisierungen auf PhpStorm](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/uct-phpstorm.html) | Video | Erfahren Sie, wie Sie das Plug-in `PhpStorm` verwenden |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Februar 2022 | [Arbeiten mit Formularfeldern](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/workforms.html) | Video | Erfahren Sie, wie Sie verschiedene Arten von Formularfeldern hinzufügen, Formularfeldeigenschaften festlegen und Sicherheitsfunktionen hinzufügen können, um hochwertige professionelle Formulare zu erstellen. |
