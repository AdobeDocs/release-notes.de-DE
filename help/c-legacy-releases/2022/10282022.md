...
>[!IMPORTANT]
>
>Schauen Sie regelmäßig wieder vorbei, um über die Entwicklung bei Experience League auf dem Laufenden zu bleiben. Das nächste Prioritätsprodukt-Update wird im **Januar 2023** nach den Feiertagen bereitgestellt. Bleiben Sie dran!
...
Neueste Version: **Donnerstag, 23. November 2022**
...
* Bietet fortschrittliche Personalisierung und Segmentierung, dank der [Einfügung von Campaign-Variablen](https://github.com/adobe/aem-core-email-components/wiki/RTE-Personalization) in die meisten Dialogfelder und der flexiblen [Segmentierungskomponente](https://github.com/adobe/aem-core-email-components/wiki/).
