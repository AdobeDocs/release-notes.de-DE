...
<table id="table_BEDD720754F84255A64598018911E336"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Mithilfe von CORS können Browser Ressourcen von einer anderen als der aktuellen Domäne anfordern. Der <span class="keyword">Experience Cloud</span> ID-Dienst bietet Unterstützung für CORS-Standards und ermöglicht somit clientseitige, ursprungsübergreifende Ressourcenanforderungen. Bei Browsern, die keine Unterstützung für CORS bieten, greift der ID-Dienst auf JSONP-Anforderungen zurück. (AAM-23988) </p> <p>Siehe: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-cors.html" format="https" scope="external"> Unterstützung für CORS beim Experience Cloud ID-Dienst </a> </li> 
...
* Der Standardwert für ` loadTimeout` wurde von 500 auf 30.000 Millisekunden (30 Sekunden) festgelegt. Siehe [Von der ID-Dienst-Funktion getInstance verwendete Variablen](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid_getinstance.html). (MCID-96)
...
* Neu: [Implementieren des Experience Cloud ID-Diensts für Analytics und Audience Manager](https://marketing.adobe.com/resources/help/de_DE/mcvid/?f=mcvid-setup-aam-analytics.html)
* Überarbeitet: [Testen und Überprüfen des Experience Cloud ID-Service](https://marketing.adobe.com/resources/help/de_DE/mcvid/?f=mcvid-test-analytics.html)

Weitere Informationen finden Sie in der Produktdokumentation für [Experience Cloud ID-Dienst](https://marketing.adobe.com/resources/help/de_DE/mcvid/).
...
* [Bericht zur Optimalen Häufigkeit](https://marketing.adobe.com/resources/help/de_DE/aam/optimal-frequency.html)
* [Cross-Channel-Konvertierung](https://marketing.adobe.com/resources/help/de_DE/aam/cross-channel-conversion-reporting.html)
* [Gerätetargeting mit Schlüsseln auf Plattformebene](https://marketing.adobe.com/resources/help/de_DE/aam/c_tb_device_targeting.html auf Plattform-Ebene)


Überarbeitet:

* [Erste Schritte mit Bulk Management ](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_bulk_start.html). Beinhaltet eine neue Bulk Management-Tabelle.
* [Geotargeting mit Schlüsseln auf Plattformebene](https://marketing.adobe.com/resources/help/de_DE/aam/c_tb_platform_vars.html). Beinhaltet eine aktualisierte Liste mit Schlüsseln mit den neuesten Werten.
...
Die aktuelle Primetime-Hilfe finden Sie unter [Primetime Help Home](https://helpx.adobe.com/de/support/primetime.html).
