...
>[!IMPORTANT]
>
>Mit der Experience Cloud ID-Dienst-Bibliothek 1.9.0+ beginnt die ID-Synchronisation für Adobe Media Optimizer standardmäßig. Siehe [ID-Synchronisierung und Trefferquoten verstehen ](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid-match-rates.html).
...
* **(Aktualisiert 28.10., 4.11.)** Der ID-Dienst synchronisiert [!DNL  Marketing Cloud] IDs (MIDs) automatisch mit [!DNL  Adobe Media Optimizer] und anderen internen [!DNL  Adobe] Domänen direkt auf der Seite. Die automatische Synchronisierung ist für alle vorhandenen und neuen Konten aktiviert. Dies hilft bei der Verbesserung der Übereinstimmungsraten [!DNL  Media Optimizer]. Für VisitorAPI.js Version 1.9 oder höher. Siehe auch [Die ID-Synchronisierung und Trefferraten verstehen ](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid-match-rates.html). (MCID-152, MCID-184)
...
* [Permissions.GetGroups](https://marketing.adobe.com/developer/de/documentation/analytics-administration-1-4/r-permission-group-1)`
...
Weitere Informationen finden Sie unter [Änderungen an Berechtigungs-APIs für Oktober](https://marketing.adobe.com/developer/de/forum/administration/permissions-api-changes-for-october) in der Developer Connection.
...
* Es wurde ein Fehler im [!UICONTROL Onboarding-Statusbericht] behoben, durch den gefundene Fehler nicht an Ihre Inbound-Datendatei weitergegeben werden konnten. Siehe auch [Onboarding-Statusbericht: Info ](https://marketing.adobe.com/resources/help/de_DE/aam/onboarding-status-report.html). (AAM-26460)
...
* DIL synchronisiert IDs mit Adobe Media Optimizer und anderen internen Adobe-Domänen direkt auf der Seite. Um diese Funktion zu ermöglichen, verwendet DIL einen neuen Cookie, ` AAM_ *`hier Name des Partners`*_ *`hier containerNSID`*`. Informationen zu [DIL erstellen unter ](https://marketing.adobe.com/resources/help/de_DE/aam/r_dil_create.html). Dort finden Sie Infos zum ` *` Namen des Partners`*` und zu den ` *` containerNSID`*`-Variablen So wird die Trefferquote des Media Optimizer verbessert. (MCID-138)
* DIL nutzt den von ` loadTimeout` bestimmten Wert als Eigenschaft des [!DNL  Marketing Cloud]-ID-Service, um zu bestimmen, wie lange es dauert, eine ` getMarketingCloudVisitorID`-Antwort vom Datenerfassungsserver zu erhalten. Siehe [loadTimeout](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid-loadtimeout.html). (MCID-143)

Vorgesehenes Veröffentlichungsdatum: **25. Oktober 2016**

**Verbesserungen**

* Facebook-Markeninhalte werden jetzt unterstützt. Bei der Veröffentlichung von Markeninhalten von Drittanbietern, die nicht die Marke der eigenen Facebook-Seite sind, können die entsprechenden Drittanbieter über [!DNL  Publish Anywhere] im Post getaggt werden. Weitere Informationen finden Sie unter [Facebook-Richtlinien für Markeninhalte](https://www.facebook.com/policies/brandedcontent/).
...
Wir freuen uns, die Community für [Adobe Media Optimizer ](https://forums.adobe.com/community/experience-cloud/advertising-cloud)bekanntzugeben! Einen Ort, um Fragen zu stellen, Ratschläge zu erhalten, Best Practices auszutauschen und mehr über das Produkt zu erfahren. Die Community bietet eine Plattform, auf der Benutzer mit Adobe-Teams und anderen Produktbenutzern aus der ganzen Welt in Verbindung und gegenseitigen Austausch treten und mit ihnen zusammenarbeiten können. Es ist eine großartige Möglichkeit, zu helfen und Hilfe zu erhalten.
