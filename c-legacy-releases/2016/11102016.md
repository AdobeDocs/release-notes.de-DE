...
>[!IMPORTANT]
>
>**EnterpriseTV** wurde zum **9. Dezember 2016** eingestellt. Produktvideos finden Sie unter [Adobe Video Learning](https://www.adobe.com/training/video.html). Bitte haben Sie etwas Geduld. Wir migrieren derzeit Videos zu einem neuen Speicherort. In der Zwischenzeit sind einige Videolinks möglicherweise fehlerhaft. Nach Abschluss der Migration sind die Videoinhalte auf den relevanten Seiten der Produktdokumentation eingebettet.
...
>* Mit der Experience Cloud ID-Dienst-Bibliothek 2.0.0+ beginnt die ID-Synchronisation für Adobe Media Optimizer standardmäßig. Siehe [ID-Synchronisierung und Trefferraten verstehen ](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid-match-rates.html).
...
* Geringfügige Workflow- und UI-Änderungen am Profillink, die die Adobe Experience Cloud-Kooperationsoptionen für Geräte unterstützen. (AAM -25988) Siehe [Profil-Link](https://marketing.adobe.com/resources/help/de_DE/aam/profile-link-intro.html).

**Verbesserungen**

* Neue ID-Definitionsoption für alle geräteübergreifenden Data Sources – die IDs in einer geräteübergreifenden Data Source können nun als „Person“ oder „Haushalt“ definiert werden. Diese Definition gibt die Beziehung zwischen der geräteübergreifenden ID und der Audience Manager-ID an. Die Standardoption für alle bestehenden geräteübergreifenden Data Sources lautet „Person“. Weitere Informationen finden Sie im Dokument [Erstellen von Data Sources](https://marketing.adobe.com/resources/help/de_DE/aam/create-datasource.html). (AAM-25988)

>[!NOTE]
Ab dem 1. Dezember 2016 stellen wir aufgrund von Änderungen bei unseren Datenanbietern keine Wordpress- und Disqus-Daten mehr zur Verfügung. Für weitere Informationen, klicken Sie [hier](https://marketing-resource-help.s3.amazonaws.com/resources/help/en_US/social/Data%20Changes_Wordpress_Disqus_FAQ_2016.pdf).
