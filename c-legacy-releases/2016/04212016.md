...
>[!IMPORTANT]
>
>Log-in-Hinweis für [!DNL  Recommendations Classic]- und [!DNL  Search&Promote]-Benutzer. Auf der aktualisierten Experience Cloud-Benutzerberfläche können Sie über das Menü **[!UICONTROL Analytics]** &gt; **[!UICONTROL Werkzeuge]** auf diese Links zugreifen.
...
Weitere Informationen finden Sie unter [Neue Funktionen in der Experience Cloud – Frühjahr 2016](https://marketing.adobe.com/resources/help/de_DE/mcloud/marketing-cloud-interface.html).
...
Die Dokumentation enthält neue Verfahrensinhalte für [!DNL  Target]. Siehe [Implementieren des Experience Cloud ID-Diensts mit Analytics ](https://marketing.adobe.com/resources/help/de_DE/mcvid/?f=mcvid-setup-target.html).

Siehe Produktdokumentation zu [Experience Cloud ID Services](https://marketing.adobe.com/resources/help/de_DE/mcvid/).
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b> <span class="keyword"> AppMeasurement</span> für JavaScript</b> </p> <p>JavaScript-Version 1.6: </p> 
...
>[!IMPORTANT]
>
>In der aktualisierten Experience Cloud-Schnittstelle können Sie über **[!UICONTROL Analysen]** &gt; **[!UICONTROL Tools]** auf Search&amp;Promote zugreifen. Oder melden Sie sich direkt an mit: [https://center.atomz.com/center/](https://center.atomz.com/center/).
