...
>[!IMPORTANT]
>
>Log-in-Hinweis für [!DNL  Recommendations Classic]- und [!DNL  Search&Promote]-Benutzer. In der aktualisierten Benutzeroberfläche des Marketing Cloud können Sie über das Menü **[!UICONTROL Analytics]** > **[!UICONTROL Tools]** auf diese Links zugreifen.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>Ziele für In-App- und Push-Nachrichten</b> </p> <p> <p class="important">Hinweis: Demnächst! </p> </p> <p>Zur Erleichterung der Bearbeitung können Marketingexperten eine „Ziel“-URL auswählen, um einen Web- oder App-Deep-Link aus den im Link-Manager gespeicherten Links aufzurufen, oder Links linear bereitstellen. </p> 
    <ul id="ul_379FB0A30634422AAFD3B708D562E6D7"> 
     <li id="li_62C4475E78E84657A2AA193C7CA34856">Geben Sie manuell einen benutzerspezifischen Web-Link oder Deep-Link ein. </li> 
...
Informationen finden Sie in der Produktdokumentation zu den [Marketing Cloud ID-Diensten](https://docs.adobe.com/content/help/en/id-service/using/home.html).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ermöglicht es dem Analysten, den Datenzugriff für Benutzer anhand bestimmter Segmente einzuschränken, indem er ein Segment auf eine Report Suite anwendet und basierend auf dieser Kombination eine neue Ansicht (Virtual Report Suite) erstellt. Auf Virtual Report Suites kann genau wie auf normale Report Suites zugegriffen werden. <a href="https://marketing.adobe.com/resources/help/de_DE/reference/virtual-report-suites.html" format="https" scope="external"> Mehr... </a></p> </td> 
  </tr> 
  <tr> 
...
Zusätzlich zu den unter [Neue Funktionen in Analytics](../../c-legacy-releases/2016/04212016.md#features_analytics) aufgeführten Funktionen bietet Analytics Premium die folgenden zusätzlichen neuen Funktionen:
...
<table id="table_37DB222470C84C3184D8E98E5D9B146D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Die Skalierbarkeit in den Visualisierungen <a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_chord_visualization.html" format="https" scope="external"> und <a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_pie_chart.html" format="https" scope="external"> Kreisdiagramm </a> wurde implementiert. </a> Sie können sie skalieren, indem Sie die &lt;Strg&gt;-Taste gedrückt halten und das Mausrad verwenden oder indem Sie mit der rechten Maustaste auf den Fensterrahmen klicken, Skalierung auswählen und einen Wert eingeben. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Zugriff auf den Detailstatus </td> 
   <td colname="col2"> <p> Der Zugriff auf <b>Detaillierter Status</b> ist jetzt standardmäßig auf Power-Benutzer und -Administratoren beschränkt. </p> </td> 
  </tr> 
  <tr> 
    ...
    <ul id="ul_7B6DDED9E1FE47328FDB5422A547AE52"> 
     ...
     <li id="li_5F0C233BD3CA4BA5A688A96059B640C0"> <p>Änderungen an der Konfigurationsstruktur (Insight.cfg): </p> 
      <ul id="ul_E7711DB0E1354CC48022459B8829F47D"> 
       <li id="li_6E3E8A99C66548608DCF62DC040B4B5D"> <p>Warnmeldung für das Feld Insight.cfg <b>Max. Trace Log Size</b>. </p> </li> 
       <li id="li_BDFE8EAB8FFE47C7892A97B45BB105BF"> <p>Printf-Format. Sie können jetzt das Printf-Format in der Struktur <b>Insight.cfg</b> festlegen. </p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </codeblock> <p>Betroffene Versionen sind <span class="term"> AppMeasurement for Flash </span> Version 4.0 und früher auf allen Plattformen. </p> <p>Hinweis:  Aus Sicherheitsgründen verteilen wir keine AS2-Version von <i>AppMeasurement for Flash</i> mehr. Wir unterstützen aber weiterhin die Datenerfassung durch bestehende AS2-Projekte. Wir empfehlen Kunden jedoch dringend, ihre Implementierungen auf AS3 zu aktualisieren und die neuesten Sicherheitsfunktionen von <i>AppMeasurement für Flash</i> zu integrieren. </p> <p> <span class="term"> AppMeasurement für Flash- </span> Kunden, die von diesem Problem betroffen sind, müssen ihre Projekte mit der aktualisierten Bibliothek neu erstellen, die über die Analytics-Konsole heruntergeladen werden kann.  <a href="https://help.adobe.com/de_DE/Flex/4.0/UsingFlashBuilder/WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7feb.html#WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7f88" format="http" scope="external"> Mehr...  </a> (AN-121780) </p> <p> <b> <span class="keyword"> AppMeasurement</span> für weitere Plattformen</b> </p> <p>In der <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/index.html" scope="external" format="https">Versionshistorie zu AppMeasurement</a> finden Sie Informationen zu den verschiedenen Versionen von <span class="keyword">AppMeasurement</span> auf den folgenden Plattformen: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     ...
     <ul id="ul_8405C43A9E2842EF8DF875C8BCDBA86B"> 
      <li id="li_B52F124D6E714FFF815785885FDDD0B2">Problem mit dem Propensity-Score-Modell. Beim Festlegen der Zielgruppe in der Propensity-Score-Visualisierung während der Anzeige von <b>Abgeschlossene Bewertung</b> wird der Fehler "Fehler beim Kompilieren von ScoreDim x No Score-Modell"zurückgegeben. Mit einem Propensity-Score können Sie mit einem Buildmodell "Los"auswählen. Wenn Sie eine Zielgruppe festlegen, den Filter anwenden (Zielgruppe &gt; Name) und auf "OK"klicken, wird ein Fehler ausgegeben. Die Lösung besteht darin, auf <b>Reset</b> &gt; <b>Reset Model</b> zu klicken und dann <b>Go</b> zu drücken, um ohne Problem zu erstellen. </li> 
...
>[!IMPORTANT]
>
>In der aktualisierten Benutzeroberfläche des Marketing Cloud können Sie über das Menü **[!UICONTROL Analytics]** > **[!UICONTROL Tools]** auf Search&amp;Promote zugreifen. Alternativ können Sie sich direkt anmelden über: [https://center.atomz.com/center/](https://center.atomz.com/center/).
...
Advertising Cloud-Hilfe ist im Produkt unter **[!UICONTROL verfügbar? > Hilfe-Inhalte]**.
