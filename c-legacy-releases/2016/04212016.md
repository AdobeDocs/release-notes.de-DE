...
Die Dokumentation enthält neue Verfahrensinhalte für [!DNL  Target]. See [Implement the Marketing Cloud ID Service With Analytics ](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-setup-target.html).
...
>[!IMPORTANT]
>
>In der aktualisierten Experience Cloud-Schnittstelle können Sie über **[!UICONTROL Analysen]** &gt; **[!UICONTROL Tools]** auf Search&amp;Promote zugreifen. Alternativ können Sie sich direkt anmelden über: [https://center.atomz.com/center/](https://center.atomz.com/center/).
