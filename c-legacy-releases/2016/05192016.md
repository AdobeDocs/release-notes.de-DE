...
seo-title: 19. Mai 2016 - Versionshinweise
solution: Experience Cloud, Versionshinweise
title: 19. Mai 2016 - Versionshinweise
...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Kundenadministratoren in Marketing Cloud können Produktkonfigurationen nutzen, die zuvor erstellt und für Analytics und das dynamische Tag-Management Standardberechtigungsgruppen zugeordnet wurden. </p> <p>Diese Optimierung ist für neu bereitgestellte Organisationen verfügbar und verringert die Zeit, die Organisationen zur Verwaltung von Benutzern im Enterprise Dashboard benötigen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Feed-Verbesserung </p> </td> 
   <td colname="col2"> <p> Beim Erstellen eines neuen Beitrags im Marketing Cloud-Feed wird in der Zeile „An“ jetzt standardmäßig das derzeit aktive Thema anstelle der Organisation verwendet.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Es wurde ein Problem behoben, bei dem Miniaturansichten für Assets, die aus Assets on Demand für den Marketing Cloud-Feed freigegeben worden waren, nicht angezeigt wurden. (MAC-29955)
...
<table id="table_899AD81646E24BE49EB86F7FF75718E1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Neue Dokumentation hinzugefügt, die die Integration der Marketing Cloud ID in Data Workbench beschreibt. Informationen dazu finden Sie unter <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-dwb.html" format="https" scope="external">Data Workbench und der Marketing Cloud ID-Dienst </a>. (AAM-23727) </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"><p> <b> <span class="keyword"> AppMeasurement</span> für JavaScript</b> </p> <p>JavaScript Version 1.5.6 </p> 
    <ul id="ul_F303CB7334E04F3B9489EB7C0F778A3E"> 
     <li id="li_99AC87DB34984CC9BAC77AC5C3671B72">Jetzt einschließlich Visitor API 1.5.6 (neuester <a href="../../c-legacy-releases/2016/05192016.md#mcvid" format="dita" scope="local">Marketing Cloud ID-Dienst </a>) </li> 
    ...
    </ul> <p> <b>JavaScript H-Code (Legacy)</b> </p> <p>Jetzt einschließlich Visitor API 1.5.5 (neuester <a href="../../c-legacy-releases/2016/05192016.md#mcvid" format="dita" scope="local">Marketing Cloud ID-Dienst </a>) </p> <p> <b>Flash 4.0.1 – Aktualisierung</b> </p> <p>Aufnahme der Besucher API 1.5.6 </p> </td> 
  </tr> 
  <tr> 
