...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Erweiterte Kommunikation von Data Feeds mit AWS-Regionen (AN-118446) </p> </td> 
   <td colname="col2"> <p>Data Feeds können nun mit den folgenden 11 standardmäßigen AWS-Regionen kommunizieren (gegebenenfalls mit dem entsprechenden Signaturalgorithmus): </p> 
    ...
    </ul> <p>Wir unterstützen derzeit nicht die Region Peking, China AWS (cn-north-1). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Data Warehouse: Unterstützung für Ranking-Zeileneinträge (AN-125562) </p> </td> 
   <td colname="col2"> <p>Data Warehouse Berichte unterstützt jetzt die Rangordnung von Zeileneinträgen nach der bereitgestellten Metrik oder den bereitgestellten Metriken. Wenn die Sortierung verwendet wird und Sie sich auch dafür entscheiden, die Anzahl der Zeilen in der Tabelle zu begrenzen (Seite mit erweiterten Einstellungen für DW), gibt der Bericht die "Top N"-Werte für die Metrik zurück, nach der Sie sortieren. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Data Warehouse: Änderung der Spaltenbenennungslogik </p> </td> 
   <td colname="col2"> <p> <b>In dem im Juli veröffentlichten Maintenance Release</b> wurde die Benennungslogik für die <span class="wintitle">Data Warehouse</span>-Datei geändert. Wenn der Name "evar1"zuvor "ABC"lautete, lautete der Spaltenname "ABC (evar1)". </p> <p>In Fällen, in denen die Variable bereits den Bezeichner enthielt, wurde dies überflüssig: </p> 
  ...
  <tr> 
   <td colname="col1"> Videoanalyse: Bericht "Gleichzeitige Viewer" </td> 
   <td colname="col2"> <p>Der Bericht "Video-Gleichzeitiger Viewer"zeigt gleichzeitige Viewer an einem Tag an. Die Daten können nach Inhalt, Gerätetyp und Land gefiltert werden. <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/c_vhl_video-concurrent-viewers-dashboard.html" format="https" scope="external"> Mehr... </a></p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Es wurde ein Problem behoben, bei dem die Aufschlüsselung der Dimension "Woche"nach "Tagen"dazu führte, dass Tage unterschiedlicher Wochen einbezogen wurden. (AN-123821) </li> 
      <li id="li_914EEE918E5C40FA988765334E1C758F">Es wurde ein Problem behoben, bei dem beim Wechsel zu einer anderen Report Suite der Währungscode des Projekts nicht aktualisiert wurde. (AN-123821) </li> 
      <li id="li_D0C0C458BF104A4D9A28C03F0879360D">Es wurde ein Problem behoben, das gelegentlich verhinderte, dass Projekte mit Textvisualisierungen heruntergeladen wurden. (AN-124982, AN-127546) </li> 
      <li id="li_27E3CB2B943949398895FA0E376033EA">Es wurde ein Problem behoben, bei dem die in der PDF-Datei angezeigte Zeitzone nicht mit der Zeitzone der Report Suite übereinstimmte. (AN-127547) </li> 
      <li id="li_280BBD99A16247339FFD0DBDEA01D7A8">Es wurde ein Problem behoben, das verhinderte, dass Benutzer ein zweites Mal in einer Freiformtabelle auf "Max. Elemente begrenzen"klicken konnten. (AN-126717) </li> 
      <li id="li_90165AC645A84CB08F3BCB7F3AAFA09A">Es wurde ein Fehler behoben, der dazu führte, dass die erste Instanz in einer Reihe geplanter Berichte übersprungen wurde. (AN-127200) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Mit Audience Lab können Sie Grundsegmente in Testsegmente aufteilen, die sich gegenseitig ausschließen. Testsegmente können verwendet werden, um verschiedene Variablen (z. B. Targeting-Plattformen oder Targeting-Kriterien) auszuwerten und gleichzeitig für eine Audience-Variable zu steuern. Kunden können bis zu 10 Multivarianz-Tests gleichzeitig erstellen. Weitere Informationen finden Sie in der <a href="https://marketing.adobe.com/resources/help/en_US/aam/" format="https" scope="external">Audience Manager-Dokumentation</a>. </p> <p>Bekannte Probleme in Mozilla Firefox und Internet Explorer: Beim Anzeigen von Berichten für einen Test: </p> <p> 
...
* Es wurde ein Fehler im Segment Builder behoben, durch den Sie bei Verwendung von Chrome keine Eigenschaften zu neuen Segmenten hinzufügen konnten. (AAM-24994)
* Es wurde ein Fehler behoben, durch den Administratoren Gruppen mit einer großen Anzahl von Datenquellen keine Berechtigungen zuweisen konnten. (AAM-24870)
* Es wurde ein Fehler behoben, durch den Segmentordner nicht erweitert und Unterordner oder Segmente angezeigt wurden. (AAM-25054)
...
DIL ist der API-Datenerfassungscode für [!DNL  Audience Manager]. Mit der Version vom Juli wird die DIL auf Version 6.5 erhöht. Aktualisieren Sie auf die neueste Version, um diese Funktionen und Fehlerbehebungen zu nutzen.

* Es wurde ein Fehler behoben, durch den DIL-Code nicht in Firefox bereitgestellt werden konnte. (AAM-24708)
* Dem DIL iFrame wurde ein Titelattribut hinzugefügt. Mithilfe eines iFrame-Titels können Bildschirmleser Benutzern Seiteninformationen bereitstellen, die Unterstützung bei der Interaktion mit Online-Inhalten benötigen. (AAM-25317)
* Zusätzliche DIL-Unterstützung für Cross-Herkunft Resource Sharing (CORS). Siehe [useCorsOnly](https://marketing.adobe.com/resources/help/en_US/aam/dil-use-cors-only.html). (AAM-25319, AAM-20139).
...
* DIL führt jetzt standardmäßig sichere HTTPS-Aufrufe durch. Kunden, die [!DNL  Audience Manager] DIL-Code und visitorAPI.js-Code auf derselben Seite verwenden, sollten die DIL-Variable ` secureDataCollection= false`festlegen. Siehe [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/dil-secure-data-collection.html).

**Fehlerbehebungen, Verbesserungen und veraltete Elemente**

* Die Häufigkeit und die Dauer der Datenerfassung für Facebook-Metriken wurden erhöht. Der neue Datenerfassungszeitrahmen lautet wie folgt:

   * Alle Facebook-Metriken werden in den ersten 72 Stunden nach der Veröffentlichung eines Beitrags stündlich erfasst.
   * Die Datenerfassung wird in den nächsten 72 Stunden alle 8 Stunden fortgesetzt.
   * Die Datenerfassung wird dann für die nächsten 60 Tage täglich fortgesetzt.

* Dem Export von Beitragsanalysen-Berichten wurde eine Geotargeting-Spalte für Twitter hinzugefügt.
* Fünf neue Facebook-Reaktionsmetriken stehen jetzt sowohl in Beitragsanalysen- als auch in Eigenschaftenanalysen zur Verfügung. Dazu gehören: Liebe, Wow, Traurig, Haha und Wut. In einer kommenden Version werden diese Facebook-Reaktionsmetriken auch für Adobe Analytics-Berichte verfügbar sein.
...
* Es wurde ein Problem behoben, bei dem Social Buzz-Berichte, die an verschiedenen Tagen erstellt wurden, bestimmte Beiträge ablegten.
* Es wurde ein Problem behoben, bei dem beim Ändern der Feed-Einstellungen in &quot;Einheitliche Moderation&quot;nach dem Abmelden und erneuten Einloggen nicht gespeichert wurde.
* Es wurde ein Problem behoben, bei dem URLs in zitierten Tweets länger als die erwarteten 24 Zeichen brauchten.
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Hotfixes für Sicherheit </p> </td> 
   <td colname="col2"> <p> Adobe hat Sicherheitshotfixes für Adobe Experience Manager veröffentlicht. Mit diesen Hotfixes werden zwei Validierungsprobleme behoben, die bei Cross-Site-Scripting-Angriffen verwendet werden können (CVE-2016-4168 und CVE-2016-4170): </p> 
...
Die folgende Tabelle enthält eine Auswahl von Links zu empfohlenen Themen, Ereignissen und Webinaren, mit deren Hilfe Sie die Implementierung und Nutzung von AEM optimal nutzen können.
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Treffen Sie Gleich gesinnte in Ihrer Gegend oder nehmen Sie an einem Gruppentreffen teil, wenn Sie unterwegs sind. Eine Liste der einzelnen Ereignis ist im Gemeinschaftskalender verfügbar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Treffen Sie Gleich gesinnte bei AEM Developer Ereignisses </p> </td> 
   <td colname="col2"> <p>Die folgenden zwei anstehenden Ereignis sind @AEM_Dev: </p> 
    <ul id="ul_74A5BB5856844F38884CEAE36A16168F"> 
     <li id="li_D85EC94BEFE44654A8FB050CBC955F41">EVOLVE gehostet von 3Share, 29.-31. August in San Diego. Eintrittskarten erhalten Sie hier: https://evolve.3sharecorp.com. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Am 23. August 2016 diskutieren wir gemeinsam mit Lokesh BS und Scott Macdonald über die Verwendung AEM eCommerce. </p> <p>Die Sitzung behandelt das eCommerce-Framework, einschließlich der Verwendung der eCommerce-APIs. Durch die Teilnahme an dieser Sitzung können Sie ein tieferes Verständnis der Verwendung des AEM eCommerce-Frameworks und der zugehörigen APIs gewinnen. </p> <p> <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_3.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external"> Melden Sie sich hier für die Veranstaltung an </a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Nehmen Sie am 17. August 2016 am Webinar "Wie Sie Dynamic Media einrichten und konfigurieren"teil. </p> <p>Folgende Themen werden im Webinar behandelt: </p> 
    <ul id="ul_6C2DD857C8804D19A8F0D7FE51C6745C"> 
     <li id="li_864C04A369E342ED9C4F0DED93D9E744"> Dynamic Media-Anwendungsfälle. </li> 
     <li id="li_22E96702DD0E41CBAA101331B0FAABF5"> Technische Architektur. </li> 
     <li id="li_68EB914F76D343148E14971E5930E9E1"> Konfigurieren von Dynamic Media in AEM 6.2. </li> 
     <li id="li_5F9B644D992840F395477A340E078544">Einrichtung und Best Practices für die Dynamic Media-Bildbearbeitung. </li> 
     <li id="li_CF200832AB4A4B53B98434EA8DEAFE5F">Einrichtung und Best Practices für Dynamic Media-Videos. </li> 
