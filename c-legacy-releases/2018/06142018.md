...
Versionshinweise zum Start werden regelmäßig unter [https://docs.adobelaunch.com/getting-started/release-notes](https://docs.adobelaunch.com/getting-started/release-notes) aktualisiert.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Analytics-Nutzungsprotokolle verfolgen jetzt, wenn jemand ein Projekt in <span class="uicontrol"> Analysis Workspace </span> öffnet (zusätzlich zur vorhandenen Verfolgung von Aktionen zum Erstellen, Aktualisieren, Aufheben der Freigabe und Löschen). Das bietet einen besseren Überblick darüber, wer Workspace wie häufig nutzt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Beim Definieren eines Segments oder einer Warnung wird die Meldung "<b>inkompatible Komponenten"</b> angezeigt, wenn nicht alle Komponenten (Metriken/Dimensionen/Segmente) im Segment oder Warnhinweis mit der aktuell ausgewählten Report Suite kompatibel sind. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      ...
      <li id="li_EBCCE705F98A4E8088F348B2CEAD5F32"> Es wurde ein Problem mit der lokale Anpassung behoben, bei dem Metrikbeschriftungen nicht in der lokalisierten, sondern auf Englisch angezeigt wurden. (AN-156651) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe wird ab Juni 2018 keine Unterstützung mehr für das TLS 1.0-Protokoll bieten. Die Funktionalität der Adobe <span class="wintitle"> Audience Manager </span> funktioniert nicht für Endbenutzer, die Browser verwenden, die nur TLS 1.0 unterstützen. Wir haben für Sie eine Liste von Browsern, Versionen und TLS-Support gesammelt. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Sie können jetzt Google AdWords-Remarketing-Listen (RLSAs) aus freigegebenen Analytics-Segmenten erstellen. Zuvor musste der Advertiser auch über Adobe <span class="wintitle"> Audience Manager </span> verfügen. Um zugelassen zu werden, muss ein Advertiser den Adobe Experience Cloud ID-Dienst implementieren, seine IMS-Organisations-ID angeben und ein Tag auf seinen Websites bereitstellen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Bulksheets durchsuchen </p> </td> 
   <td colname="col2"> <p>(Google AdWords-Konten) Bulksheets unterstützen jetzt RLSA-Zielgruppen (Remarketing Liste) für Kampagnen. </p> <p>Das Dialogfeld "Bulksheet herunterladen"für AdWords-Kampagnen enthält den optionalen Entitätsabschnitt "Kampagne-RLSA-Zielgruppe" mit den Feldern "Kampagne-Name", "Angebotsanpassung", "Anzeigengruppenname", "Audience", "Zielgruppe-Typ"(mit dem Wert <i>einschließlich</i>), "RLSA-Zielgruppe-Status"und "Adobe-Angebotsanpassung". </p> </td> 
  </tr> 
  <tr> 
