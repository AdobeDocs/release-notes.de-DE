...
seo-title: 09. März 2018 - Versionshinweise
solution: Experience Cloud, Versionshinweise
title: 09. März 2018 - Versionshinweise
...
* Es wurde ein Fehler behoben, durch den der Experience Cloud-ID-Dienst fälschlicherweise ein AMCV-Cookie für Domänen ohne vorangestellten Punkt erstellte, obwohl [!DNL  visitor.cookieDomain] über einen vorangestellten Punkt verfügte. So würde zum Beispiel ein [AMCV-Cookie](https://marketing.adobe.com/resources/help/en_US/whitepapers/cookies/cookies_mc.html) zusätzlich [!DNL  sampledomain.com][!DNL  .sampledomain.com]zu einem AMCV-Cookie gesetzt. (CORE-10634)
...
* Es wurde die Fähigkeit zum Erstellen [!DNL Target] von Workflows in Adobe [!UICONTROL Mobile] Services entfernt. (MOB-8683)
