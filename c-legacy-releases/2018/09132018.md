...
Sie können jetzt das Farbschema in Workspace ändern, indem Sie eine andere Farbpalette auswählen oder eine eigene Palette angeben. Diese Funktion wirkt sich auf viele Aspekte in Workspace aus, einschließlich der meisten Visualisierungen. **hat keine Auswirkungen auf die Sammeländerung, die bedingte Formatierung in Freiform-Tabellen und die Imagemap-Visualisierung.**
...
* Die Berechtigung _Als Vorlage speichern_ wurde hinzugefügt, mit der Benutzer Projekte als Vorlagen in Workspace speichern können. Diese war bislang in der Berechtigung zum Erstellen/Kuratieren enthalten, also erhält jede Person mit dieser Berechtigung die neue Berechtigung _Als Vorlage speichern_.

**Advertising Analytics-Optimierungen**

Der [Automatische Verfolgungsmodus](https://marketing.adobe.com/resources/help/en_US/analytics/advertising/aa_manual_vs_automatic_tracking.html) wurde für die automatische Verfolgung von Suchmaschinendaten durch Ihre Adobe Analytics-Implementierung eingeführt.
...
* True Audience Ratings - Benchmark zu historischen und aktuellen Daten zur Messung der Reichweite; Ebenfalls in den Metriken &quot;UV-Strahlung&quot;und &quot;Personen&quot;enthalten, Listening-Interaktionen durchgeführt und Listener über die Kohorte-Analyse zurückgegeben werden.
* Customer Journey Flow - Messen Sie Benutzer über alle Listening-Geräte hinweg, einschließlich Autos, und vergleichen Sie damit geräteübergreifende Listening-Erlebnisse, Listener nach Minute und Inhalt, auf den sie als Nächstes zugreifen.
...
* Ab dem 13. September 2018 wird die Adobe Analytics-Datenerfassung **TLS 1.0 nicht mehr unterstützt. Mit dieser Änderung erfassen wir keine Analytics-Daten mehr von Endbenutzern mit älteren Geräten oder Webbrowsern, die TLS 1.1 oder höher nicht unterstützen.**
...
Die Dokumentation zur Entwicklung von [Einzelseitenanwendungen (SPA)](https://helpx.adobe.com/experience-manager/6-4/sites/developing/user-guide.html?topic=/experience-manager/6-4/sites/developing/morehelp/spa.ug.js) für den AEM SPA Editor wird aktualisiert und erweitert.

**Rich-Text-Editor**

Das Thema [Rich-Text-Editor](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/rich-text-editor.html) wurde überarbeitet, um es besser zu strukturieren, einige fehlende Informationen hinzuzufügen, eine Workflow-Abbildung hinzuzufügen und den langen Artikel zu teilen.
...
Weitere Informationen finden Sie in den Themen [AEM Assets-Integration mit Marketing Cloud und Creative Cloud konfigurieren](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/configure-assets-cc-integration.html) und [AEM Assets-Integration mit Markenportal konfigurieren](https://helpx.adobe.com/de/experience-manager/6-4/assets/using/brand-portal-configuring-integration.html).
...
Zieh dich mit deinen Kollegen zusammen! Unsere lokalen Benutzergruppen-Treffen wachsen weiter. Überprüfen Sie, ob sich in Ihrem Bereich [hier](https://www.meetup.com/pro/aem/) eine befindet. Sehen Sie keine lokale Gruppe, sondern möchten Sie eine gründen? Schicken Sie uns eine E-Mail an [aemusers@adobe.com](mailto:aemusers@adobe.com)
...
Weitere Informationen finden Sie unter [hier](https://adapt.to/2018/en/conference.html).
