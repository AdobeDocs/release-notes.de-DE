...
Die Versionshinweise werden regelmäßig unter [https://docs.adobelaunch.com/getting-started/release-notes](https://docs.adobelaunch.com/getting-started/release-notes )aktualisiert.
...
[Bedienfeld-Dropdowns](https://marketing.adobe.com/resources/help/de_DE/analytics/analysis-workspace/panels.html)
...
Siehe [Audio Analytics](https://marketing.adobe.com/resources/help/de_DE/sc/appmeasurement/hbvideo/media-workspace-templates.html).
...
Der [Auto-Tracking-Modus](https://marketing.adobe.com/resources/help/de_DE/analytics/advertising/aa_manual_vs_automatic_tracking.html) für die automatisierte Verfolgung von Suchmaschinendaten durch Ihre Adobe Analytics-Implementierung wurde eingeführt.

Verbesserungen der Nutzung von Server-Aufrufen

Es wurde ein neuer Warnhinweistyp _[Server Call](https://marketing.adobe.com/resources/help/de_DE/analytics/servercall/scu_alerts.html)_ hinzugefügt, der aktive Benachrichtigungen bereitstellt, wenn die Menge der Serveraufrufe sich einem bestimmten Niveau nähert.
...
* [Übungen zu Adobe.com](https://helpx.adobe.com/de/analytics/tutorials.html)
...
Kumulative Versionsinformationen finden Sie unter [Data Workbench Versionshinweise](https://marketing.adobe.com/resources/help/de_DE/insight/whatsnew/index.html).
...
Eine Versionsgeschichte von AppMeasurement auf den folgenden Plattformen finden Sie unter [AppMeasurement-Versionsgeschichte](https://marketing.adobe.com/resources/help/de_DE/sc/appmeasurement/release/index.html).
...
Am 6. August 2018 kündigte Adobe die Absicht an, Ad Hoc Analysis einzustellen. Das Datum für das Ende des Produktlebenszyklus wird bekannt gegeben, sobald es verfügbar ist. Weitere Informationen finden Sie unter [Arbeitsbereich entdecken](https://spark.adobe.com/page/S9Bhp66VJ2fEn/).
...
* Ab dem 13. September 2018 bietet die **Adobe Analytics Reporting-API** keine Unterstützung mehr für die Verschlüsselung mit TLS 1.0. Kunden, die auf die API zugreifen, sollten sicherstellen, dass sie nicht von den Auswirkungen betroffen sind.
   * API-Clients mit Java 7 mit Standardeinstellungen benötigen [Änderungen zur Unterstützung von TLS 1.2](https://www.java.com/en/configure_crypto.html). (siehe „Changing default TLS protocol version for client end points: TLS 1.0 to TLS 1.2“).
...
Die Anomalieerkennung und die Beitragsanalyse wurden aus dem Funktionssatz [!UICONTROL von Reports &amp; Analytics] entfernt und sind jetzt nur über den [Analysis Workspace](https://marketing.adobe.com/resources/help/de_DE/analytics/analysis-workspace/virtual-analyst.html) verfügbar.

Kunden von Adobe Analytics und Foundation haben nur Zugriff auf die [Anomalieerkennung mit „täglicher Granularität“](https://marketing.adobe.com/resources/help/de_DE/analytics/analysis-workspace/anomaly_detection.html).
...
* Die Seitenumbenennung ist nicht mehr zulässig. In Zukunft müssen Sie die [Classifications](https://marketing.adobe.com/resources/help/de_DE/reference/classifications.html) verwenden, um Seiten umzubenennen. Bis zum 10. Mai 2018 wird das System die umbenannten Seiten so weiterverarbeiten, wie sie aktuell konfiguriert sind. Adobe bittet alle Kunden darum, bis zu diesem Datum zu Classifications zu migrieren. Nach der Version vom Mai werden vorhandene Umbenennungen nicht mehr berücksichtigt und können sich ohne Ankündigung rückwirkend ändern.
...
Analytics-Benutzer müssen ihre Konten nicht mehr manuell zwischen Experience Cloud und Analytics verknüpfen. Benutzer können sich an ihre [Admin Console](https://helpx.adobe.com/de/enterprise/help/aedash.html) wenden, um den Analytics-Zugriff anzufordern.
...
[Weitere Informationen zur Migration der Analytics-Benutzer-ID finden Sie unter](https://marketing.adobe.com/resources/help/de_DE/experience-cloud/admin-console/analytics-migration/).
...
Um sich auf dieses Ereignis vorzubereiten, sehen Sie sich die Liste der betroffenen APIs an und erfahren Sie, was Adobe empfiehlt, siehe [Analytics Administrations-API 1.4](https://marketing.adobe.com/developer/de/documentation/analytics-administration-1-4/admin-api).
...
* Wir haben ein [Suchfeld in Audience Lab](https://marketing.adobe.com/resources/help/de_DE/aam/audience-lab.html) hinzugefügt, wodurch Sie Ihre Testgruppen nach Name, Beschreibung oder Name der Testsegmente durchsuchen können, die zu Testgruppen gehören.
...
Um mehr über Adobe Campaign zu erfahren, aktivieren Sie sich selbst unter [Adobe Digital Library](https://digitalu.adobe.com/content/Enablement/en.html).
...
* [AEM Assets Brand Portal-Benutzer-Handbuch](https://helpx.adobe.com/de/experience-manager/brand-portal/user-guide.html)
...
Aktualisieren Sie die [Integration mit Livefyre](https://helpx.adobe.com/de/experience-manager/6-4/sites/administering/using/livefyre.html) mit einem neuen Workflow für [Livefyre Feature Pack 2.0.6 Version](https://helpx.adobe.com/de/experience-manager/6-4/release-notes/livefyre-feature-pack-206.html) und die Seite [Funktionen Packs](https://helpx.adobe.com/de/experience-manager/6-4/release-notes/feature-packs-release-notes.html).
...
Weitere Informationen finden Sie in den [Versionshinweisen und Dokumentation-Aktualisierungen](https://helpx.adobe.com/de/experience-manager/cloud-manager/using/release-notes-2018-6-0.html).

**Single-Page-Anwendungen**

Die Dokumentation zur Entwicklung von [Einzelseitenanwendungen (SPAs)](https://helpx.adobe.com/de/experience-manager/6-4/sites/developing/user-guide.html?topic=/experience-manager/6-4/sites/developing/morehelp/spa.ug.js) für AEM SPA Editor wird aktualisiert und erweitert.

**Rich-Text-Editor**

Artikel [Konfigurieren Sie den Rich-Text-Editor](https://helpx.adobe.com/de/experience-manager/6-4/sites/administering/using/rich-text-editor.html)überarbeitet, um ihn besser zu strukturieren, einige fehlende Informationen hinzugefügt, eine Workflow-Illustration hinzugefügt, und ein langer Artikel aufgespalten.
...
Weitere Informationen finden Sie in den Themen [Konfigurieren von AEM Assets Integration in Experience Cloud und Creative Cloud](https://helpx.adobe.com/de/experience-manager/6-4/sites/administering/using/configure-assets-cc-integration.html) und [Konfigurieren der AEM Assets Integration mit dem Marken-Portal](https://helpx.adobe.com/de/experience-manager/6-4/assets/using/brand-portal-configuring-integration.html).

**[!UICONTROL Bildgenerator für Mobile]-Signaturtool**

Jetzt steht ein neuer [Bildgenerator für Mobile-Signaturtool](https://helpx.adobe.com/de/digital-publishing-suite/help/mobile-signing-tool-image-generator.html) zur Verfügung. Dieses Tool hilft Ihnen dabei, die notwendigen Bilder in exakt den Dimensionen und mit den Namen zu erstellen, wie es für das AEM [!UICONTROL Mobile]-Signaturtool erforderlich ist.

**[!UICONTROL Push-Benachrichtigungen unter Android für Mobilgeräte]**

Die [Push-Benachrichtigungen in der Dokumentation zu AEM Mobile Apps](https://helpx.adobe.com/de/digital-publishing-solution/help/push-notifications.html#push-android) werden jetzt aktualisiert, um die Google Firebase-Konsole (Android) zu verwenden.
...
Sehen Sie sich unseren [Kalender der anstehenden Ereignisse](https://www.meetup.com/AEM-Technologist-Group/events/calendar/) an, einschließlich der folgenden Ressourcen:
...
Darüber hinaus können Sie Ihren On-Demand-Pass für unbegrenzten Zugriff auf mehr als 90 Sitzungen erwerben. Gehen Sie [hierhin](https://immerse18.adobe-devs.adobeevents.com/register/) und verwenden Sie den Discount-Code He7B52.
...
Sehen Sie bevorstehende Sitzungen oder sehen Sie sich vergangene Sitzungen[hier](https://helpx.adobe.com/de/experience-manager/kt/eseminars/gems/aem-index.html) an.

**Fragen an AEM-Community-Experten – Webinare**

 Diese monatliche Webinar-Reihe bietet Einblicke in Themen, die kürzlich in unserer [Erlebnis-League](https://landing.adobe.com/experience-league/) erläutert wurden. | [AEM HelpX Forum](https://forums.adobe.com/community/experience-cloud/marketing-cloud/experience-manager).
...
Sehen Sie bevorstehende Sitzungen oder sehen Sie sich vergangene Sitzungen [hier](https://helpx.adobe.com/de/experience-manager/kt/eseminars/ask-the-expert/atace-index.html) an.

Sie benötigen dennoch Hilfe? Besuchen Sie die AEM-Community, stellen Sie sich vor und posten Sie Ihre Frage [hier](https://forums.adobe.com/message/9643186?cid=AEMNewCommInvite13June_MU_1).

Treffen Sie sich mit Ihren Kollegen! Unsere lokalen Benutzergruppen-Treffen werden immer größer. Überprüfen Sie[hier](https://www.meetup.com/pro/aem/), ob in Ihrem Bereich eine vorhanden ist. Sie finden keine lokale Gruppe, haben aber Interesse daran, eine zu gründen? Schicken Sie uns eine E-Mail an [aemusers@adobe.com](mailto:aemusers@adobe.com)
