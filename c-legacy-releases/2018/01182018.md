...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>There is no longer a need to <b>share</b> curated components (segments, calculated metrics, date ranges). Für die Virtual Report Suite kuratierte Komponenten sind in Workspace stets sichtbar, auch wenn sie nicht freigegeben werden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_049F6A23A21F4EF583A62D7C64759295"> 
      ...
      <li id="li_A38AEC6152294BA282964357D95C6CA7">Es wurde ein Problem behoben, bei dem Aufschlüsselungen beim Ändern eines Datumsbereichs und bei Verwendung der <i>Aufschlüsselung nach Position</i>nicht ordnungsgemäß aktualisiert wurden. (AN-152275) </li> 
      ...
      <li id="li_274DB6E81EF141AAA25B8E90D373390C">Es wurde ein Problem behoben, bei dem in der Kohortentabelle <i>NaN</i> (Not a Number - Keine Zahl) in bestimmten Fällen angezeigt wurde. Die Kohortentabelle wird nun stattdessen <i>ungültig</i> angezeigt. (AN-146403) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D8C419C29A7B4184802AC44AFF26F271"> 
      <li id="li_421869B6AD854ABFBA09B554B2A042D6">Es wurde ein Fehler behoben, der dazu führte, dass Links, die von der Option <i>Link zu Bericht</i> generiert wurden, nicht funktionierten, wenn sich der Benutzer mit <i>Merken</i>angemeldet hatte. (AN-153261, AN-153038) </li> 
      ...
      <li id="li_DD523B3B36454E1A84E38792EF967F54"> <b>Admin Console</b>: Problem behoben, das beim Benennen einer Spalte bei Erfolgsereignissen auftrat, wenn auf <i>Mehrere</i> geklickt wurde. Der Spaltentyp <i>zeigte</i> stattdessen die Werte für <i>Name</i> an. (AN-148763) </li> 
...
* Für die Anzahl der abgeleiteten Signale, die Sie verwenden können, wurde eine Grenze von 50.000 hinzugefügt. Lesen Sie mehr über [Nutzungsbeschränkungen](https://marketing.adobe.com/resources/help/de_DE/aam/usage-limits.html).
...
* Es wurde ein Fehler in Internet Explorer-Browsern behoben. Wenn Sie versuchen, ein Ziel auf der Seite &quot;Ansicht&quot;zu bearbeiten, löst die Schaltfläche &quot;Bearbeiten&quot;kein Ereignis aus. (AAM-33625)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>AEM 6.3 Feature Pack für dynamische Medien </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM Desktop-App 1.7 konzentriert sich auf die Verbesserung der Stabilität und der Cache-Logik, eine bessere Unterstützung für Netzwerk-Proxy und die Möglichkeit, interne Dateien nach der Deinstallation zu bereinigen. </p> <p> 
     <ul id="ul_529FEC1E204640249E4AE5D370570CFB"> 
      <li id="li_5D6588F541654A288015F12034E34D3D"> <a href="https://helpx.adobe.com/de/experience-manager/kb/download-companion-app.html" format="https" scope="external"> Download </a> </li> 
