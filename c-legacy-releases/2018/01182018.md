...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die Funktionsweise von "Keine/Nicht angegeben" im <span class="uicontrol"> Analysis Workspace </span> wurde geändert, damit es mit [UICONTROL Reports &amp; Analysen], der Segmentaufbau und das Menü Dimensionswerte in [! UICONTROL Analysis Workspace]. </p> <p>Das bedeutet, dass der Wert in den meisten Projekten in [!UICONTROL Analysis Workspace] als „Nicht angegeben“ anstelle von „Keine“ angezeigt wird. (AN-146879) </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Es ist jetzt möglich, direkt aus der <span class="wintitle"> Adobe Campaign </span> Standard-API eine Signalaktivität für Ihre Arbeitsabläufe auszulösen. </p> <p>Weitere Informationen finden Sie in der <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">ausführlichen Dokumentation</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
