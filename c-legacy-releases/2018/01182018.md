...
| [!UICONTROL Interaktion mit mobilen Apps] | 1. Juni 2017 | Der Einsatzfall für mobile Apps zeigt Ihnen, wie Sie Ihre mobilen Apps mit dem Adobe Experience Cloud integrieren können, um die Benutzerinteraktion zu messen und personalisierte Erlebnisse für Ihre Audiencen bereitzustellen. |
...
<table id="table_7C1BFFBCEA2C48A5BA9D2C4AE7D48CA6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>JavaScript – 3.0.0</b> </p> <p>Adobe hat folgende Konfigurationen umbenannt, um das Deaktivieren von Synchronisierungsaufrufen von Drittanbietern zu ermöglichen. </p> 
    <ul id="ul_F26FC6F0B49C437AA5FE1C1753C88FF0"> 
     <li id="li_C84362D6F7BA4F27838548DF57A0CD65"> <span class="codeph"> idSyncDisableSyncs</span> zu <span class="codeph"><a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-disableidsync.html" format="html" scope="external">disableIdSyncs </a> </span> </li> 
     <li id="li_D0C446A5AAB24AE8B437ED943E5FC681"> <span class="codeph"> idSyncDisable3rdPartySyncing</span> zu <span class="codeph"><a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-disable-cookies.html" format="html" scope="external">disableThirdPartyCookies </a> </span> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Funktion <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_getinstance.html" format="html" scope="external">Visitor</a> wurde eine neue Funktion zur Nicht-Instanziierung dieser Funktion mit <span class="codeph">var visitor = new Visitor</span> hinzugefügt. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Weitere Filteroptionen für Freiformtabelle </p> </td> 
   <td colname="col2"> <p>Die folgenden Optionen zum Filtern von Dimensionen wurden hinzugefügt: </p> 
    <ul id="ul_869B3E943E304C0282D56AD96BB79E18"> 
     <li id="li_81A49BA0CA3041C7AB892FAD2D129E5A">Enthält alle Begriffe </li> 
     <li id="li_2AB564F917844F82839A91949D0B684A">Enthält einen Begriff </li> 
     <li id="li_16C7938EDC8F422EA006FB63F2881EF1">Enthält die Wortgruppe </li> 
     <li id="li_5130EBE9A7A54CCFA313F3C3C268B367">Enthält keinen Begriff </li> 
     <li id="li_861825154EDC49EBA57514FD0A2AE462">Enthält keine Wortgruppe </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sie können nun mit der rechten Maustaste auf eine Visualisierung oder ein Bedienfeld klicken und das kopierte Element dann an eine andere Stelle im Projekt oder in ein anderes Projekt einfügen (einfügen). </p> <p>Mit dieser Funktion können Sie Bausteine (vordefinierte Visualisierungen/Bereiche) erstellen, die in andere Projekte kopiert werden können, um schneller mit unternehmensspezifischen Daten zu beginnen. </p> <p> <a href="https://marketing.adobe.com/resources/help/de_DE/analytics/analysis-workspace/freeform-analysis-visualizations.html" format="html" scope="external"> Mehr... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Neue <span class="uicontrol"> Mobile </span>-Vorlagen für Messaging und Standort </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Beim Ändern der Größe der Spalte ganz links behält Workspace jetzt die Breitenprozentwerte der übrigen Spalten bei (nicht einfach die nächste Spaltenbreite rechts anpassen). Diese Änderung beschleunigt die Tabellenerstellung für Analyse und Freigabe. </p> <p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Anzeigen von  400 Zeilen  in einer Tabelle </p> </td> 
   <td colname="col2"> <p>Sie können nun 400 Zeilen (statt 200) in einer Tabelle und damit Trends über 365 Tage hinweg anzeigen. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/freeform-table.html" format="html" scope="external"> Mehr... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Unterstützung der  Zuordnungsvisualisierung  im PDF-Format </p> </td> 
   <td colname="col2"> <p>Die im Oktober 2017 eingeführte Zuordnungsvisualisierung kann nun im PDF-Format gerendert werden. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/map-visualization.html" format="html" scope="external"> Mehr... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Relative Intra-Links beim Kopieren/Speichern als Projekt </p> </td> 
   <td colname="col2"> <p>Wenn Sie zuvor ein Projekt kopiert oder <i>speichern unter</i> verwendet haben, verweisen alle im Projekt gespeicherten Intra-Links auf das Originalprojekt, nicht auf das kopierte Projekt. </p> <p>Die Intra-Links beziehen sich jetzt auf das Projekt, in dem sie leben, nachdem Sie sie kopiert oder gespeichert haben. </p> <p> <a href="https://marketing.adobe.com/resources/help/de_DE/analytics/analysis-workspace/t_freeform_project.html" format="html" scope="external"> Mehr... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Beitragsanalyse: Token-Benachrichtigung </p> </td> 
   <td colname="col2"> <p>Wenn Ihre Firma über eine begrenzte Anzahl von Token für die Beitrags-Analyse verfügt, zeigt die Benutzeroberfläche <span class="uicontrol"> Analysis Workspace </span> jetzt eine Benachrichtigung an, wenn Sie ein Token verwenden. Sie werden darüber informiert, wie viele Token noch vorhanden sind.&amp;nbsp; </p> <p>(Admin-Benutzer: Durch die Bearbeitung Ihrer Gruppenberechtigungen können Sie einschränken, wer diese Token verwenden darf.)&amp;nbsp; </p> <p> <a href="https://marketing.adobe.com/resources/help/de_DE/analytics/contribution/ca_main.html" format="html" scope="external"> Mehr... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ereignis#, eVar# und prop#, die den Dimensionsnamen in der linken Leiste (2017) hinzugefügt wurden, werden nur angezeigt, wenn Sie nach der Komponente suchen. </p> <p>(Gilt auch für Virtual Report Suite Builder.) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Änderungen an Keine/Nicht angegeben </p> </td> 
   <td colname="col2"> <p>Es wurde geändert, wie "Keine/Nicht angegeben"in <span class="uicontrol"> Analysis Workspace </span> funktioniert, sodass es mit <span class="uicontrol"> Reports &amp; Analysen</span>, dem Segmentaufbau und dem Dimensionswertmenü in <span class="uicontrol"> Analysis Workspace</span> konsistent ist. </p> <p>Das bedeutet, dass der Wert in den meisten Projekten unter <span class="uicontrol"> Analysis Workspace</span> als "Nicht angegeben"statt als "Keine"angezeigt wird. (AN-146879) </p> </td> 
  </tr> 
  <tr> 
   <td> <p>Andere Analytics </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   ...
   <td colname="col2"> <p>Es ist nicht mehr erforderlich, die kuratierten Komponenten (Segmente, berechnete Metriken, Datumsbereiche) <b>freizugeben. </b> Für die Virtual Report Suite kuratierte Komponenten sind in Workspace stets sichtbar, auch wenn sie nicht freigegeben werden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p> <b>Segmentaufbau</b>: Es wurde ein   <span class="uicontrol"> Analysis Workspace- </span> Produktkompatibilitätstyp hinzugefügt </p> </td> 
   <td colname="col2"> <p>Im <a href="https://marketing.adobe.com/resources/help/de_DE/analytics/segment/seg_build.html" format="html" scope="external"> Segmentaufbau </a> wurde ein <span class="uicontrol"> Analysis Workspace </span>-Produktkompatibilitätstyp hinzugefügt. </p> <p>Segmente mit eingebetteten Datumsbereichen funktionieren in <span class="uicontrol"> Analysis Workspace</span> und <span class="uicontrol"> Reports &amp; Analysen</span> weiterhin unterschiedlich: In Workspace setzt ein Segment mit einem eingebetteten Datumsbereich den Datumsbereich des Bereichs außer Kraft. Im Gegensatz dazu erhalten Sie in <span class="uicontrol">Reports &amp; Analytics</span> die Schnittmenge des Datumsbereichs des Berichts und des eingebetteten Datumsbereichs des Segments. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_049F6A23A21F4EF583A62D7C64759295"> 
      <li id="li_FA20387188F347B6A63C400BCABBC1FD"> Es wurde ein Problem behoben, bei dem die Metrik "Personen"und die Metrik "Geschätzte Zählerdifferenz"ungewöhnlich niedrige Zahlen berichteten. (AN-154510) </li> 
      <li id="li_4C15473CA8134605AB25D568C5F5541B">Es wurde ein Problem behoben, das irrtümlicherweise zu einer Warnung bezüglich einer inkompatiblen Report Suite führte. (AN-154791, AN-154706) </li> 
      <li id="li_3BFD3E2E8E2D4DCCA4CC2168D5A3F64B">Es wurde ein Fehler behoben, der dazu führte, dass geplante Projekt-Tags nach der Aktualisierung des geplanten Projekts ausgeblendet wurden. (AN-153794) </li> 
      <li id="li_306069B2F1414A809B181EB723FDE3AF">Es wurde ein Problem behoben, das das vollständige Laden oder Herunterladen einer Projekt-PDF verhindert hat. (AN-152760) </li> 
      <li id="li_89069FCB9FDB4BAC92168A53643AC615">Es wurde ein Problem behoben, bei dem die Y-Achsen-Zahlen immer mindestens eine Dezimalzahl anzeigten. In Zukunft werden Dezimalstellen nur angezeigt, wenn dies erforderlich ist. (AN-152685) </li> 
      <li id="li_A38AEC6152294BA282964357D95C6CA7">Es wurde ein Fehler behoben, der verhinderte, dass Aufschlüsselungen beim Ändern eines Datumsbereichs und bei Verwendung von <i>Aufschlüsselung nach Position</i> ordnungsgemäß aktualisiert wurden. (AN-152275) </li> 
      <li id="li_9028E65C2330440D98D42F95224F5BB2">Es wurde ein Problem behoben, bei dem Benutzer keine Projekte an E-Mail-Adressen senden konnten, die Apostrophe enthielten. (AN-151837) </li> 
      <li id="li_BF00F9A67C9746E3A548F138B023A196">Es wurde ein Fehler behoben, der dazu führte, dass Zeitraumspalten in einigen Situationen nicht zu einer Freiform-Tabelle hinzugefügt wurden. (AN-150614) </li> 
      <li id="li_3AC4C0CDC1894C83B14317CDD45E5069">Es wurde ein Problem behoben, das beim Ändern der Report Suite eines Projekts und beim Speichern des Projekts aufgetreten ist. Im Dialogfeld "Geplantes Projekt"wurde eine falsche Report Suite angezeigt, wenn auf Zeitzoneninformationen verwiesen wurde. (AN-150570) </li> 
      <li id="li_274DB6E81EF141AAA25B8E90D373390C">Es wurde ein Problem behoben, bei dem in der Kohortentabelle unter bestimmten Umständen <i>NaN</i> (Keine Zahl) angezeigt wurde. Die Kohortentabelle zeigt nun stattdessen <i>Invalid</i> an. (AN-146403) </li> 
      <li id="li_11696FA6ECA946D3A3BDEEBB680B0A43">Es wurde ein Problem behoben, das beim Erstellen von Segmentvergleichen mit ungültigen Segmenten auftrat. Jetzt wird eine aussagekräftigere Fehlermeldung angezeigt. (AN-145953) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Andere Analytics </p> </td> 
   <td colname="col2"> <p> 
     <ul id="ul_D8C419C29A7B4184802AC44AFF26F271"> 
      <li id="li_421869B6AD854ABFBA09B554B2A042D6">Es wurde ein Fehler behoben, der dazu führte, dass Links, die von der Option <i>Link zu Bericht</i> generiert wurden, nicht funktionierten, wenn der Benutzer mit <i>Bitte merken</i> angemeldet war. (AN-153261, AN-153038) </li> 
      <li id="li_B36206B9AFBD4A67A2F7A2E3CE826620"> <b>Lesezeichen</b>: Problem behoben, aufgrund dessen mit Lesezeichen versehene Berichte gelegentlich angezeigt wurden, obwohl der Benutzer keine Berechtigung mehr für die Report Suite besaß, in der sich der mit Lesezeichen versehene Bericht befand. In diesem Fall wird in Zukunft die Meldung "Zugriff verweigert"angezeigt. (AN-153970) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_1EC0B858C95740D8AE039A40F7DF728A"> 
     <li id="li_0559C0464EA94BE493BA2A93E8BB2C23">Berichte mit großer Data Warehouse sollten nicht mehr mit einem 500-Gateway-Fehler fehlschlagen. Stattdessen werden sie getrennt und paginiert. (AN-150062) </li> 
     <li id="li_3B01A07E75DA4E1BB75981E35CBB8AB9">Verbesserte E-Mail-Nachrichten für Dateiübertragungsprobleme. (AN-150162) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    <ul id="ul_00E41A39A19F4EDE920FF835A06C9631"> 
     <li id="li_6D5A30F39BA24AB39FCE2E8CE4CDAC1E">Support für IE 6 bis 9 fallen lassen </li> 
     <li id="li_AC8BD2DC70FE464982EC3517126A6F2F">Aufnahme der Besucher-API, Version 3.0.0 </li> 
...
* Für die Anzahl der abgeleiteten Signale, die Sie verwenden können, wurde eine Grenze von 50.000 hinzugefügt. Lesen Sie mehr über [Verwendungsbeschränkungen](https://marketing.adobe.com/resources/help/de_DE/aam/usage-limits.html).
* Es wurde ein Fehler auf der Seite &quot;Ziele erstellen/bearbeiten&quot;behoben, durch den in Safari-Browsern die Schaltflächen &quot;Segmentzuordnungen&quot;nicht reagierten. (AAM-33558)
* Es wurde ein Fehler auf der Seite Abgeleitete Signale behoben, durch den in Firefox die Aktionsschaltflächen (Bearbeiten, Löschen) nicht reagiert haben. (AAM-33573)
* Es wurde ein Fehler in Internet Explorer-Browsern behoben. Wenn Sie versuchen, ein Ziel auf der Seite &quot;Ansicht&quot;zu bearbeiten, wird über die Schaltfläche &quot;Bearbeiten&quot;kein Ereignis Trigger. (AAM-33625)
* Es wurde ein Fehler in den Profil Merge Rules in Internet Explorer 11 behoben, durch den die Optionen für authentifiziertes Profil falsch angezeigt wurden. (AAM-33628)
* Es wurde ein Fehler in Addressable Audiencen in Internet Explorer 11 behoben, durch den das Hilfemodal nicht korrekt angezeigt wurde. (AAM-33631)
* Es wurde ein Problem in Audience Lab behoben, bei dem einige Kunden beim Versuch, die CSV-Datei für Konversionseigenschaften herunterzuladen, einen Fehler vom Typ 500 erhalten haben. (AAM-33775)
* Es wurde ein Problem behoben, das beim Löschen von Segmenten mit der Schaltfläche &quot;Auswahl entfernen&quot;auftrat, wobei die Segmente nicht gelöscht wurden. (AAM-33815)
* Es wurde ein Problem behoben, das von Kunden gemeldet wurde, die beim Versuch, eine Segmentzuordnung aus dem Google DBM-Ziel zu entfernen, einen Fehler erhielten. (AAM-34056)
* Es wurde ein Problem behoben, bei dem Kunden den Operator in einer Eigenschaftsregel nicht ändern konnten, ohne die Bedingung zu löschen oder die Code-Ansicht zu verwenden. (AAM-34112)
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> In diesem konfigurierbaren Bericht ist innerhalb eines bestimmten Zeitraums vor dem Versanddatum zu sehen, wie sich die Ermüdungsregeln auf E-Mail-, Push-, SMS- und Briefpost-Sendungen auswirken. Durch diese Übersicht können Marketer alle miteinander in Konflikt stehenden Kampagnen auf einen einzigen Blick erkennen. Dies ermöglicht es ihnen, Marketingkampagnen entsprechend zu planen, die Ermüdungsregeln optimal zu definieren und Nachrichten zu hierarchisieren. </p> <p>Weitere Informationen finden Sie in der <a href="https://helpx.adobe.com/campaign/standard/administration/using/working-with-typology-rules.html#viewing-the-fatigue-rule-summary-report" format="html" scope="external">ausführlichen Dokumentation</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Berichtfreigabe </p> </td> 
   <td colname="col2"> <p> Mit der Freigabe von Berichten können Sie Ihre Berichte als E-Mail-Anhang und auf automatisierter Basis wiederkehrend an Adobe Campaign-Benutzer freigeben. Empfänger dieser Berichte können sich von diesen Nachrichten über einen speziellen Link in jeder E-Mail abmelden. </p> <p>Weitere Informationen finden Sie in der <a href="https://helpx.adobe.com/campaign/standard/reporting/using/reporting-interface.html#share-tab" format="html" scope="external">ausführlichen Dokumentation</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Push-Verbesserungen </p> </td> 
   <td colname="col2"> <p> <b>Push-Nachrichten-Vorschau</b> – Zeigen Sie vor dem Testen oder Ausführen der Bereitstellung eine Vorschau für Push-Benachrichtigungen auf iOS- und Android-Geräten im Inhalts-Editor für Push-Benachrichtigungen an, um genau das zu sehen, was Ihre Empfänger sehen werden. </p> <p>Weitere Informationen finden Sie in der <a href="https://helpx.adobe.com/campaign/standard/channels/using/creating-and-sending-a-push-notification.html#previewing-the-notification" format="html" scope="external">ausführlichen Dokumentation</a>. </p> <p> <b> Inhalt verfügbar</b> – Wenn Anwendungen über einen längeren Zeitraum hinweg nicht geöffnet werden, können deren Daten veraltet sein. Folglich müssen die Daten bei der nächsten Öffnung der App aktualisiert oder ersetzt werden, was zu einer Verzögerung bei der Verwendung der App führen kann. Dank der zusätzlichen Unterstützung von Content Available können Adobe Campaign-Benutzer ihre App aufrüsten, um ihre Daten im Hintergrund zu aktualisieren, wenn sie eine Push-Benachrichtigung senden, wodurch mehr Konsistenz und Kontrolle über das In-App-Erlebnis eines Benutzers gewährleistet werden. </p> <p> <b>Stummschaltbarer Inhalt</b> – Dank der neuen Unterstützung von „Stummschaltbarer Inhalt“ können Adobe Campaign-Benutzer nun ihre mobilen Anwendungserweiterungen nutzen, um den Inhalt oder die Darstellung von eingehenden Push-Benachrichtigungen von Adobe Campaign weiter anzupassen. Mit der Funktion "Veränderlicher Inhalt" haben Sie beispielsweise folgende Möglichkeiten: </p> 
    <ul id="ul_3EF9A2749F3B4D6ABD8DBF459D5533EE"> 
     <li id="li_157AE9CA180749118F100810A756046E"> In einem verschlüsselten Format gesendete Daten entschlüsseln </li> 
     <li id="li_33D93E48F4594A368F8EB510C9192531"> Bilder oder andere Mediendateien herunterladen und als Anhänge zu einer Benachrichtigung hinzufügen </li> 
     <li id="li_AE112D8C7D3D43968690AC1FB9533E13"> Den Text oder Titel einer Benachrichtigung ändern </li> 
     <li id="li_D464555FEC3E446A85E791FE657AE2CB"> Eine Thread-Id zur einer Benachrichtigung hinzufügen </li> 
  ...
  <tr> 
   <td colname="col1"> <p> Zeitzonenoptimierte Sendungen </p> </td> 
   <td colname="col2"> <p> Planen Sie regelmäßige E-Mail-, SMS- und Push-Benachrichtigungen an einem bestimmten Tag und zu einem bestimmten Zeitpunkt in der Zeitzone jedes Empfängers, um sicherzustellen, dass Ihre Nachrichten zum richtigen Zeitpunkt gesendet werden, ohne dass mehrere Versand eingerichtet werden. </p> <p>Weitere Informationen finden Sie in der <a href="https://helpx.adobe.com/campaign/standard/automating/using/scheduler.html" format="html" scope="external">ausführlichen Dokumentation</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Auslösen einer Signalaktivität über die API </p> </td> 
   <td colname="col2"> <p> Es ist jetzt möglich, eine Signal-Aktivität für Ihre Workflows direkt von <span class="wintitle"> Adobe Campaign </span> Standard-API Trigger. </p> <p>Weitere Informationen finden Sie in der <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">ausführlichen Dokumentation</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> Brand Portal 6.3.1 bietet verbesserte Benutzerfreundlichkeit, Leistung und neue Verbesserungen bei Metadaten, Suche, Berichte und Verwaltung digitaler Rechte. </p> <p> 
     <ul id="ul_445D216D5F674C079E2816AF1AA5C8BD"> 
      <li id="li_483696B31B634B20B6B5F138268F43DB"> <a href="https://helpx.adobe.com/de/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html" format="https" scope="external"> Versionshinweise </a> </li> 
      <li id="li_FA5CC8D13EDD48C7BD43C6325073AADC"> <a href="https://helpx.adobe.com/de/experience-manager/brand-portal/using/whats-new.html" format="https" scope="external"> Neue Funktionen in AEM Assets Brand Portal </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM 6.3 Dynamic Media Feature Pack </p> </td> 
   <td colname="col3"> <p>Das AEM 6.3 Dynamic Media Feature Pack ist jetzt mit AEM 6.3.1.0 kompatibel. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM Desktop-App 1.7 konzentriert sich auf die Verbesserung der Stabilität und der Cache-Logik, eine bessere Unterstützung für Netzwerk-Proxy und die Möglichkeit, interne Dateien nach der Deinstallation zu bereinigen. </p> <p> 
     <ul id="ul_529FEC1E204640249E4AE5D370570CFB"> 
      <li id="li_5D6588F541654A288015F12034E34D3D"> <a href="https://helpx.adobe.com/de/experience-manager/kb/download-companion-app.html" format="https" scope="external"> Herunterladen  </a> </li> 
      <li id="li_F5428913D5D0470DAC68A8C7EA2CCC11"> <a href="https://helpx.adobe.com/de/experience-manager/6-3/release-notes/desktop-app-release-notes.html" format="https" scope="external"> Versionshinweise </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.3-CFP2 (6.3.1.2) vom 8. Januar 2018 ist eine Aktualisierung, die wichtige Fehlerbehebungen und Optimierungen für Kunden enthält, die seit der allgemeinen Verfügbarkeit von AEM 6.3 SP1 im April 2017 veröffentlicht wurden. </p> <p> 
     <ul id="ul_5E37F844028C4EBA810DD60FA7988A93"> 
      <li id="li_F4A42388096A4DF0BB336E8561A9F07A"> <a href="https://helpx.adobe.com/de/experience-manager/release-notes—aem-6-3-cumulative-fix-pack.html" format="https" scope="external"> Versionshinweise </a> </li> 
      <li id="li_D4299C6C7703461D9A63DABCA75E00FC"> <a href="https://helpx.adobe.com/de/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM Forms-Versionen </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Felder für Standardtextanzeigen können in Bing Ads-, Google AdWords- und Yahoo Japan-Inventar-Feed-Vorlagen nicht mehr bearbeitet werden. </p> <p>In Textanzeigenvorlagen können Sie den Vorlagen jetzt Label-Classifications für einzelne Anzeigenvarianten hinzufügen. hinzufügen Sie die Klassifizierungen unter der Vorlage für Anzeigenvarianten auf der Registerkarte Anzeigen. </p> <p>In Shopping-Anzeigenvorlagen können Sie den generierten Produktgruppen Label-Classifications hinzufügen. hinzufügen Sie die Klassifizierungen auf der Registerkarte Klassifizierungen beschreiben. Label-Klassifizierungen für Produktgruppen werden auf die Einheitenebene (granulärste) angewendet. </p> </td> 
  </tr> 
  <tr> 
