...
Neue Funktionen und Fehlerbehebungen in den Adobe Experience Cloud- und Core Services. Dazu gehören [!UICONTROL Mobile Services], Launch by Adobe, Dynamic Tag Management, die DSGVO-API und der Experience Cloud ID-Dienst.
...
* Implementierung einer Backend-Lösung, um die Freigabe von Assets zwischen Marketing Cloud-to-AEM und Marketing Cloud-to-Creative Cloud zu steuern. (CORE-14386)
...
* Es wurde ein Problem behoben, durch das Benutzer weitergeleitet wurden, [!DNL  marketing.adobe.com] während sie [!DNL  experiencecloud.adobe.com][!DNL  http] statt [!DNL  https] (geschützt) auf den Zugriff zugegriffen haben. (CORE-15587)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.1 SP2-CFP16 (6.1.2.16) vom 10. Juli 2018 ist ein wichtiges Update, das entscheidende Fehlerbehebungen von Kunden enthält, die seit der allgemeinen Verfügbarkeit von AEM 6.1 SP2 seit August 2016 veröffentlicht wurden. </p> <p> 
