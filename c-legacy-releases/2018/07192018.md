...
Eine Zusammenfassung der Versionshinweise finden Sie unter [Experience Cloud-ID-Dienst - Versionshinweise](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-release-notes.html).

Informationen finden Sie in der Produktdokumentation zu den [Experience Cloud ID-Diensten](https://docs.adobe.com/content/help/en/id-service/using/home.html).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Mit Attribution IQ können Sie komplexere und intelligentere Analysen Ihrer Marketing-Performance durchführen. Neue Zuordnungsmodelle können für Metriken in <span class="uicontrol"> Analysis Workspace </span> (in einer beliebigen Tabelle oder bei einer Aufschlüsselung) und in berechneten Metriken verwendet werden. Der neue Zuordnungsbereich sorgt für bessere Darstellung und Vergleichsmöglichkeiten. </p> <p>Attribution IQ steht allen Kunden über die SKUs Ultimate, Prime, Select und Foundation zur Verfügung. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Datumsbereichsvorgabe in <span class="uicontrol"> Analysis Workspace </span> wurde "Letzte 13 volle Wochen"hinzugefügt. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Audience Optimization für Herausgeber kann Ihnen dabei helfen, potenzielle Leistungsmöglichkeiten für <span class="wintitle">-Audience Manager </span>-Segmente in Ihren eigenen und betriebenen Inhalten zu identifizieren. Diese Berichte kombinieren Leistungsdaten zur Kampagne auf Protokollebene mit Audience Manager-Metriken, um Optimierungen und Monetarisierungsmöglichkeiten in der Audience zu identifizieren. </p> <p>Diese Meldungen sind nicht standardmäßig erhältlich. Wenden Sie sich an Ihren Audience Manager-Berater oder an den Kundendienst, um sich zu den ersten Schritten zu wenden. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Bevor <span class="wintitle">-Audience Manager </span> die Audience Optimization für Herausgeber aktivieren kann, müssen Sie sicherstellen, dass alle in diesem Artikel aufgeführten Voraussetzungen erfüllt sind. Kontaktieren Sie die Kundenunterstützung, nachdem Sie sichergestellt haben, dass alle Voraussetzungen erfüllt sind. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>Integration mit Adobe Analytics </p> </td> 
