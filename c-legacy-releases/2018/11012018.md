...
| Adobe und [!DNL Analytics]Datenschutz-Grundverordnung (DSGVO) | [!DNL Analytics] unterstützt eine neue Methode zum Weiterleiten der alten [!DNL Analytics] Besucher-ID an eine GDPR-Anforderung (siehe [AAID](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_namespaces.html)). Also, [!DNL Analytics] now supports [deleting (anonymizing) the Purchase ID value](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_labels.html) as part of a delete request. |
