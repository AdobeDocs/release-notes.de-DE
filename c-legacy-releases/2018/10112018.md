...
Siehe [Upgraden von Adobe FTP Servern](https://marketing.adobe.com/resources/help/de_DE/whitepapers/ftp/ftp_upgrade.html).
...
Am 6. August 2018 kündigte Adobe die Absicht an, Ad Hoc Analysis einzustellen. Das Datum für das Ende des Produktlebenszyklus wird bekannt gegeben, sobald es verfügbar ist. Weitere Informationen finden Sie unter [Workspace entdecken](https://spark.adobe.com/page/S9Bhp66VJ2fEn/).
...
Siehe [Analytics-Benutzerkonten für Enterprise und Federated IDs migrieren](https://marketing.adobe.com/resources/help/de_DE/experience-cloud/admin-console/analytics-migration/migrate-enterprise.html).
...
Die Anomalieerkennung und die Beitragsanalyse wurden aus dem Funktionssatz [!UICONTROL von Reports &amp; Analytics] entfernt und sind jetzt nur über [Analysis Workspace](https://marketing.adobe.com/resources/help/de_DE/analytics/analysis-workspace/virtual-analyst.html) verfügbar.
...
[Weitere Informationen zur Analytics-Benutzer-ID Migration finden Sie unter](https://marketing.adobe.com/resources/help/de_DE/experience-cloud/admin-console/analytics-migration/).
...
Diese Option steht auch in der [Segmenttestgruppe API](https://bank.demdex.com/portal/swagger/index.html#/Segment_Test_Group_API/get_segment_test_groups_) über den groupStatus-Abfrageparameter zur Verfügung.
...
* **Cloud Manager 2018.7.0**
   ...
   Diese Cloud Manager-Version bietet bedeutende Verbesserungen bei Autoskalierung, Analyse der Codequalität sowie eine genauere Ansicht Ihrer Umgebung und Ihrer Leistungstests. [Versionshinweise](https://helpx.adobe.com/de/experience-manager/cloud-manager/using/release-notes-2018-7-0.html).
...
Weitere Informationen finden Sie unter [Funktions-Video)https://helpx.adobe.com/de/experience-manager/kt/sites/using/spa-editor-framework-feature-video-use.html]( und [Technisches Video](https://helpx.adobe.com/de/experience-manager/kt/sites/using/spa-editor-components-technical-video-understand.html).

Weitere Informationen finden Sie in der folgenden Dokumentation: [https://helpx.adobe.com/de/experience-manager/6-4/assets/using/aem-assets-adobe-stock.html](https://helpx.adobe.com/de/experience-manager/6-4/assets/using/aem-assets-adobe-stock.html)
...
* **AEM Screens**
   ...
   [Dynamische eingebettete Sequenzen verwenden](https://helpx.adobe.com/de/experience-manager/6-4/sites/authoring/using/dynamic-embedded-sequences.html) ermöglicht dem Benutzer, einer Hierarchie zu folgen, in der Änderungen und Aktualisierungen an einem Kanal zu einem anderen in Relation mit ihm propagiert werden. Eine Eltern-Kind-Hierarchie ist möglich. Bestimmte Assets wie Bilder oder Videos sind ebenfalls vorhanden.

* **AEM Cloud Manager**

   Das horizontale skalieren der Dispatcher-/Publish-Segmente in der Produktionsumgebung ermöglicht die Autoskalierung, um einen plötzlichen Anstieg der Datenmenge, der Lautstärke und weiterer festgelegter und überwachter Metriken verarbeiten zu können. Lesen Sie die  [Versionshinweise für 2018.7.0](https://helpx.adobe.com/de/experience-manager/cloud-manager/using/release-notes-2018-7-0.html) für weitere Informationen.
