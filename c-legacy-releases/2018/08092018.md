...
Kumulative Versionsinformationen finden Sie unter [Versionshinweise zu Data Workbench](https://marketing.adobe.com/resources/help/de_DE/insight/whatsnew/index.html).
...
Die Anomalieerkennung und die Beitragsanalyse wurden aus dem Funktionssatz [!UICONTROL von Reports &amp; Analytics] entfernt und sind jetzt nur über den [ 
Analysis Workspace verfügbar](https://marketing.adobe.com/resources/help/de_DE/analytics/analysis-workspace/virtual-analyst.html).
...
* Die Seitenumbenennung ist nicht mehr zulässig. In Zukunft müssen Sie die[Klassifikationen](https://marketing.adobe.com/resources/help/de_DE/reference/classifications.html) verwenden, um Seiten umzubenennen. Bis zum 10. Mai 2018 wird das System die umbenannten Seiten so weiterverarbeiten, wie sie aktuell konfiguriert sind. Adobe bittet alle Kunden darum, bis zu diesem Datum zu Classifications zu migrieren. Nach der Version vom Mai werden vorhandene Umbenennungen nicht mehr berücksichtigt und können sich ohne Ankündigung rückwirkend ändern.
...
Siehe [Versionshinweise](https://helpx.adobe.com/de/experience-manager/cloud-manager/using/release-notes-2018-50.html).

**Kernkomponentenversion 2.1.0**

Version 2.1.0 der [Kernkomponenten](https://helpx.adobe.com/de/experience-manager/core-components/user-guide.html) ist jetzt verfügbar, mit Einführung in [Bild](https://helpx.adobe.com/de/experience-manager/core-components/using/image.html), einem neuen [Teaser](https://helpx.adobe.com/de/experience-manager/core-components/using/teaser.html) und zahlreichen Fehlerbehebungen.
...
Darüber hinaus können Sie On-Demand-Tickets für unbegrenzten Zugriff auf mehr als 90 Sitzungen erwerben. Gehen Sie [hierhin](https://immerse18.adobe-devs.adobeevents.com/register/) und verwenden Sie den Discount-Code He7B52.
...
 Suchen Sie lokale Benutzergruppen [hier](https://www.meetup.com/pro/aem/). Wenn keine lokale Gruppe angezeigt, Sie jedoch an der Gründung einer solchen interessiert sind, senden Sie eine E-Mail an [aemusers@adobe.com](mailto:aemusers@adobe.com)
...
Hilfe für die Advertising Cloud ist im Produkt verfügbar, indem Sie auf das Hilfe-Symbol ( **[!UICONTROL ?]**) am oberen Rand einer beliebigen Seite klicken.
