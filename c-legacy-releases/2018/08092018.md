...
Aktualisiert am 21. August 2018 **(entfernt JavaScript 2.10 Update, das im September 2018 stattfindet).**
...
Version 2.1.0 der [Kernkomponenten](https://helpx.adobe.com/experience-manager/core-components/user-guide.html) ist jetzt verfügbar. Es werden [Verbesserungen der Komponente ](https://helpx.adobe.com/experience-manager/core-components/using/image.html), eine neue Komponente [Teaser](https://helpx.adobe.com/experience-manager/core-components/using/teaser.html) und zahlreiche Fehlerbehebungen eingeführt.
...
Siehe Bevorstehende Sitzungen oder Vergangene Sitzungen [hier](https://helpx.adobe.com/de/experience-manager/kt/eseminars/gems/aem-index.html).
...
Siehe Bevorstehende Sitzungen oder Vergangene Sitzungen [hier](https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html).
...
Weitere Informationen finden Sie unter [hier](https://evolve.3sharecorp.com/).
...
 Finden Sie lokale Benutzergruppentreffen [hier](https://www.meetup.com/pro/aem/). Wenn keine lokale Gruppe angezeigt, Sie jedoch an der Gründung einer solchen interessiert sind, senden Sie eine E-Mail an [aemusers@adobe.com](mailto:aemusers@adobe.com)
