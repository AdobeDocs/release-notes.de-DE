...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> So können Kunden Daten in ihrem [!DNL Target]-Besucherprofil löschen. </p> </td> 
  </tr> 
  <tr> 
...
Versionshinweise zur Benutzeroberfläche der Core Services, einschließlich [!UICONTROL Assets], [!UICONTROL Feed], [!UICONTROL Benachrichtigungen], Personen, [!UICONTROL Mobile] Services, Launch und dynamisches Tag-Management. Enthält auch Release-Informationen für den Experience Cloud ID-Dienst (früher bekannt als *` Visitor ID service`* und *` Visitor API`* in Analytics und *` Marketing Cloud ID service`*).
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>10. Mai 2018 </p> </td> 
   <td colname="col2"> <p>Da der Support für TLS 1.0 eingestellt wird, empfahlen wir Nutzern von Adobe [!UICONTROL Report Builder] (ARB), vor dem 13. September 2018 ARB v5.6.21 herunterzuladen. Danach werden ältere Versionen von ARB nicht mehr unterstützt. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Im Ad Hoc Analysis Project Converter werden Ihre Ad Hoc-Projekte mit nur einem Klick in [!UICONTROL Analysis Workspace] konvertiert. </p> <p>Kopierte Projekte können anschließend nach Bedarf in [!UICONTROL Analysis Workspace] verwendet, geändert und geplant werden. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Verbesserungen von [!UICONTROL Analysis Workspace] </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Geplante Version wirksam ab 15. Mai 2018</b> </p> <p> <span class="term"> mc_ audiences</span> – Spalte wurde hinzugefügt. <span class="term"> mc_audiences</span> – ist die Audience Analytics-Segment-ID-Liste aus Adobe Audience Manager. </p> <p>Hinweis: Anzeigenamen sind nicht eingeschlossen, da es sich hierbei um eine Klassifizierung der ID handelt. </p> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Wir haben die DIL-Version 7.0 veröffentlicht, die folgende Upgrades und Fehlerbehebungen aufweist: </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      <li id="li_FDBFB52DA5214B50B3D77482925B8FA4">Es wurde eine Race-Bedingung beim Launch mit dem <a href="https://marketing.adobe.com/resources/help/en_US/aam/r_dil_sc_init.html" format="html" scope="external">DIL SiteCatalyst-Moduls</a> behoben. (CORE-10266)
 </li> 
      <li id="li_53DBDB6DAB354DF1AD8545A9F14D36F5">Es wurden UX-Bewertungen der DIL-Erweiterung für Launch implementiert. (CORE-8143)
 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Termin am 25. Mai 2018, an dem die Datenschutz-Grundverordnung (DSGVO) in Kraft tritt, rückt immer näher. Daher haben wir eine Dokumentation vorbereitet, die Sie bei der Verwaltung von Kundendaten im [!DNL Audience Manager] unterstützt, um die DSGVO-Vorgaben einzuhalten. Weitere Informationen finden Sie unter: </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> DSGVO im [!DNL Audience Manager] </a> </p> </li> 
...
## [!DNL Advertising Cloud] (ehemals Media Optimizer)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die folgende Unterstützung ist für dynamische Suchanzeigen (Dynamic Search Ads, DSA) von Bing Ads und für Google AdWords DSAs im neuen AdWords-Erlebnis verfügbar. Diese Anzeigentypen werden als „erweiterte dynamische Suchanzeigen“ (eDSAs) bezeichnet. </p> <p> 
