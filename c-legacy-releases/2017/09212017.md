...
* Neue Dokumentation hinzugefügt: [Content Security Policies and the Marketing Cloud ID Service](https://docs.adobe.com/content/help/en/id-service/using/reference/csp.html). Darin wird erklärt, wie Sie Anrufe an Adobe-Domains gesondert zulassen können, die vom ID-Service verwendet werden.
...
* Es wurde ein Problem behoben, bei dem [Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab.html) nur langsam geladen wurde. (AAM-32249)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads beginnt am 25. September mit der Migration von Advertising Cloud-verwalteten Konten zum neuen Sitelink-Modell (gemeinsame Sitelinks); Der Prozess wird voraussichtlich vier Tage dauern. Zwischen dem 22. September und dem Abschluss der Kontomigration sind Sitelinks in der Advertising Cloud nicht verfügbar und werden fälschlicherweise als gelöscht angezeigt. Wenn Sie Änderungen an Ihren Sitelinks vornehmen müssen, bevor die Migration abgeschlossen ist, arbeiten Sie direkt im Bing Ads-Editor; Ihre Änderungen werden nach Abschluss der Migration in das neue Modell migriert und von der Advertising Cloud synchronisiert. Die Unterstützung freigegebener Sitelinks wird im Oktober-Release hinzugefügt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Beta-Suchkampagnen </p> </td> 
