...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/de/marketing-cloud/how-to/use-cases.html" format="html" scope="external"> E-Mail-Optimierung </a> </p> </td> 
...
* Die neue Dokumentation [Inhaltssicherheitsrichtlinien und der Marketing Cloud-ID-Dienst](https://docs.adobe.com/content/help/de-DE/id-service/using/reference/csp.html), in der beschrieben wird, wie Sie Aufrufe an vom ID-Dienst verwendete Domänen der Adobe zulassen.
...
Release-Datum: **21. September 2017**
...
* Es wurde ein Fehler behoben, der verhinderte, dass [Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab.html) zeitnah geladen wurde. (AAM-32249)
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> Masse Abonnement mit Herkunft und Datum </p> </td> 
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> SAP HANA-Anschluss </p> </td> 
   <td colname="col2"> <p>Machen Sie die Silos kaputt und nutzen Sie alle externen ‪ in ‪ Adobe Campaign in Echtzeit mit Federated Data Access ‪ Connectors, jetzt unterstützt auch SAP HANA. Mit ‪ Data Access ‪ können Benutzer mehrere unterschiedliche, ‪ externe ‪ mit Adobe Campaign verbinden. Abfrage von Daten aus einer beliebigen Quelle in Echtzeit, ohne ‪ den ‪ zu importieren oder auf der Adobe Campaign-Plattform zu speichern. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Hadoop Connector über HiveSQL </p> </td> 
   <td colname="col2"> <p>Bei der Handhabung großer Datensätze hat Hadoop den Vorteil gegenüber relationalen Datenbankmanagementsystemen, und sein Wert für jedes Größengeschäft wird sich mit fortschreitender Zunahme unstrukturierter Daten weiter erhöhen. Adobe Campaign kann die Leistungsfähigkeit von Hadoop über den Hadoop Connector über HiveSQL nutzen, wo Kunden direkt über die Adobe Campaign-Benutzeroberfläche auf Schema zugreifen können, um erweiterte, hochsegmentierte Audiencen schnell, flexibel und skalierbar zu erstellen. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Diese Version bietet neue Automatisierungs- und Versand-Funktionen für Dynamic Media-Kunden und ist die erste Version, die für bestehende Dynamic Media Classic (S7)-AEM-Kunden konzipiert ist, die eine Transition nach Dynamic Media durchführen möchten. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Die neue Dokumentation zu AEM Screens 6.3 ist verfügbar. Alternativ steht ein Schnellstart zur Verfügung, mit dem ein Benutzer in 5 Minuten ein Digital Signage Experience erstellen kann. Sehen Sie sich die folgenden Ressourcen an: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <b>Dynamic Media-Funktionspaket: Architektur und Fehlerbehebung</b> </p> <p> 
     <ul id="ul_4B68CC8CF9534D88A7874E0C63BAD6FE"> 
      <li id="li_41A24144372347DDB1260D5D8E3D2428">Übersicht über die neuen Funktionen des Dynamic Media Feature Pack </li> 
      <li id="li_E9106D8DC4FF48DB937CB66449D425F8">Architektur von Dynamic Media Feature Pack. </li> 
