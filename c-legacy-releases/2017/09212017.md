...
* Added new documentation, [Content Security Policies and the Marketing Cloud ID Service](https://docs.adobe.com/content/help/de-DE/id-service/using/reference/csp.html) that explains how to allow calls to Adobe domains used by the ID service.
...
Analytics-Kunden können benutzerdefinierte Integrationen für ExactTarget mithilfe standardmäßiger Analytics-Funktionen und APIs implementieren, einschließlich Classifications, Data Sources, Verarbeitungsregeln und Exporte von Data Warehousen. Bei Bedarf können Interaktionen mit dem Beratungsteam der Adobe berücksichtigt werden.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dimensionen, die auf Zeitstempeln basieren, wurden dem Analysis Workspace standardmäßig hinzugefügt. Zu den Dimensionen gehören: </p> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> Adobe Analytics Cloud kann nun die Leistung von intelligenten Sprachassistenten wie Amazon Alexa, Google Assistant, Microsoft Cortana und Apple Siri nachverfolgen. </p> <p>Siehe <a href="https://marketing.adobe.com/resources/help/en_US/reference/voice-analytics-faq.html" format="html" scope="external">Häufig gestellte Fragen </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> Es wurde ein Fehler behoben, der dazu führte, dass Segmente, die "java_enabled"verwendeten, für Data Warehousen-Aufträge nicht ordnungsgemäß verarbeitet wurden. (AN-147372) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Ausführbare Protokolldateien </p> </td> 
...
* Es wurde ein Problem behoben, bei dem aktualisierte Segmentnamen von Audience Managern nicht an Google DFP-Ziele gesendet wurden. (AAM-31677)
...
* Ein Fehler in Zusammenhang mit Chrome wurde behoben, der dazu führte, dass DIL beim Klicken auf die Schaltfläche &quot;Zurück&quot;in diesem Browser einen Fehler ausgab. (CORE-5135)
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>Adaptives Forms </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Das neue Tutorial Erste Schritte für Entwickler 6.3 basiert auf den folgenden AEM: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Wenn eine Komponente auf einer Webseite gerendert wird, können Sie ein HTML-Element generieren und die gerenderte Komponente in sich einschließen. Für Entwickler AEM Angebote eine klare und einfache Logik zur Steuerung der Dekorations-Tags, die Komponenten einschließen. </p> <p>Siehe <a href="https://docs.adobe.com/docs/en/aem/6-3/develop/components/decoration-tag.html" format="https" scope="external">Designtag </a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads beginnt am 25. September mit der Migration von Advertising Cloud-verwalteten Konten zum neuen Sitelink-Modell (gemeinsame Sitelinks); Der Prozess wird voraussichtlich vier Tage dauern. Zwischen dem 22. September und dem Abschluss der Kontomigration sind Sitelinks in Advertising Cloud nicht verfügbar und werden fälschlicherweise als gelöscht angezeigt. Wenn Sie Änderungen an Ihren Sitelinks vornehmen müssen, bevor die Migration abgeschlossen ist, arbeiten Sie direkt im Bing Ads-Editor; Ihre Änderungen werden nach Abschluss der Migration in das neue Modell migriert und von Advertising Cloud synchronisiert. Funktionen zur Unterstützung freigegebener Sitelinks stehen in der Oktober-Version zur Verfügung. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Beta-Suchkampagnen </p> </td> 
