  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">Es wurde ein Problem behoben, das auftrat, wenn z. B. keine Link-Klicks für einen ausgewählten Datumsbereich erfasst wurden. Dies führte dazu, dass die Activity Map-Symbolleiste in einem hängenden Status feststeckte. (AN-140163, AN-140119, AN-136186) </li> 
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Sie können jetzt Bilder mit den zahlreichen Funktionen des Adobe Creative SDK direkt im Inhaltseditor während der Bearbeitung von E-Mails oder Landingpages bearbeiten. </p> <p> Für diese Funktionen ist kein Erwerb zusätzlicher Creative Cloud-Lösungen erforderlich. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Die neuesten empfohlenen AEM Oak Cumulative Fix Packs sind an folgenden Stellen verfügbar: </p> <p> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Eine neue Version des Reverse-Data-Feeds von Advertising Cloud zu Analytics verbessert die Datengenauigkeit erheblich. Alle Advertiser mit Analytics-Integration werden in den kommenden Wochen auf den neuen Reverse Feed aktualisiert. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Nur Beta-zugelassene Werbetreibende) Eine neue Search Beta-Benutzeroberfläche steht in der Woche nach der Veröffentlichung zur Verfügung mit: </p> <p> 
