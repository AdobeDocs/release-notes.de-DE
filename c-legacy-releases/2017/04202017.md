...
# April 2017 - Versionshinweise

Erfahren Sie mehr über die Ankündigung der [Adobe Experience Cloud](https://www.adobe.com/experience-cloud.html) beim Adobe Summit 2017.
...
* Die Funktion „Profil-Link“ wurde verbessert. Die Funktion verknüpft jetzt eine [Audience Manager UUID](https://marketing.adobe.com/resources/help/de_DE/aam/ids-in-aam.html) mit drei anderen Audience Manager-UUIDs, für insgesamt 4 Audience Manager-UUIDs in einem Cluster. (AAM-28808)
* Jetzt legen wir die Test Segment-IDs ( [SID und csegID](https://marketing.adobe.com/resources/help/de_DE/aam/ids-in-aam.html)) mit einem Abfrageparameter testSegments=true in den folgenden APIs offen (AAM -27591):
   * ` .../v1/segments`
   * ` .../v1/destinations/<destinationId>/mappings`

* Die Segment-API-Methoden wurden zu Swagger migriert. Siehe [Migration des Audience Manager-API-Code](https://marketing.adobe.com/resources/help/de_DE/aam/c_api_swagger.html). (AAM-28601)
...
Adobe hat ein [Sicherheitsbulletin für Adobe Campaign](https://helpx.adobe.com/de/security/products/campaign/apsb17-09.html) v6.11 für Windows und Linux veröffentlicht.
