  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
     ...
     <li id="li_7C5BD4DD52204E589364EB2BBE904814">Es wurde ein Fehler behoben, der dazu führte, dass alle Änderungen an einem geplanten Arbeitsbereich E-Mails auslösten, die an Empfänger gesendet wurden. (AN-131167) </li> 
...
* Die Funktion &quot;Profil-Link&quot;wurde verbessert. The feature now links an [Audience Manager UUID](https://docs.adobe.com/content/help/de-DE/audience-manager/user-guide/reference/ids-in-aam.html) to another three Audience Manager UUIDs, for a total of 4 Audience Manager UUIDs in a cluster. (AAM-28808)
* Nun werden die Test-Segment-IDs ([SID und csegID](https://docs.adobe.com/content/help/de-DE/audience-manager/user-guide/reference/ids-in-aam.html)) über den Abfragenparameter testSegments=true in den folgenden APIs verfügbar gemacht (AAM-27591):
   * ` .../v1/segments`
   * ` .../v1/destinations/<destinationId>/mappings`

* Die Segment-API-Methoden wurden zu Swagger migriert. See [Audience Manager API Code Migration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
...
Adobe hat ein [Sicherheitsbulletin für Adobe Campaign](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) v6.11 für Windows und Linux veröffentlicht.
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> Push-Benachrichtigungen für Transaktionen </p> </td> 
