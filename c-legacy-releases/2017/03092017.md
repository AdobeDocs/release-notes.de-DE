...
* API-Methoden für Eigenschaften und Ordner wurden in Swagger migriert. Siehe [Audience Manager-API-Codemigration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28221 und AAM-27133)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Die Optionen zur automatischen Optimierung von Angebotsanpassungen ermöglichen es Advertising Cloud, die Angebotsanpassungseinstellungen für Anzeigengruppen im Portfolio automatisch zu ändern, wenn das Portfolio optimiert wird, um die Leistung zu optimieren. Advertising Cloud kann Angebotsanpassungen für Google, Bing und Yahoo optimieren! Zielgruppen für mobile Geräte in Japan; Google- und Bing-Tablet- und -Computer-Zielgruppen; Google RLSA-Zielgruppen; und Google-Positionierung Zielgruppen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
