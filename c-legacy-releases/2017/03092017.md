...
* Die Traits- und Folder-API-Methoden wurden zu Swagger migriert. Siehe [Migration des Audience Manager-API-Codes](https://marketing.adobe.com/resources/help/de_DE/aam/c_api_swagger.html). (AAM-28221 und AAM-27133)
...
In dieser Version wurde ein Fehler behoben, durch den verhindert wurde, dass ` GA.submitUniversalAnalytics` Daten an die Datenerfassungsserver sendet. Siehe [GA. submitUniversalAnalytics](https://marketing.adobe.com/resources/help/de_DE/aam/dil-google-universal-analytics.html). (MCID-354)

**Neue und überarbeitete Dokumentation**

**Neu**

[Verwenden des DNS-Prefetch mit verschiedenen Experience Cloud-Lösungen](https://marketing.adobe.com/resources/help/de_DE/mcloud/dns-prefetch.html)beschreibt, wie Sie DNS Prefetch verwenden können, um die Seitenladezeiten zu reduzieren.

**Überarbeitet**

* [DCS-Fehlercodes, Nachrichten und Beispiele](https://marketing.adobe.com/resources/help/de_DE/aam/dcs_error_codes.html) enthält Integrationswarnungen.
* [Namen ausgehender Daten-Dateien](https://marketing.adobe.com/resources/help/de_DE/aam/c_name_reqs_outbound.html) enthält den optionalen ` PID-ALIAS` Parameter.
* [Segmentzusammenfassungsansicht](https://marketing.adobe.com/resources/help/de_DE/aam/c_segment_summary.html) enthält die Intervalle der Berichtsrückblicke.
* [DIL Create](https://marketing.adobe.com/resources/help/de_DE/aam/r_dil_create.html) enthält neue Informationen über die ` containerNSID`-Eigenschaft.
* [Adressierbare Zielgruppenmetriken](https://marketing.adobe.com/resources/help/de_DE/aam/addressable-audience-metrics.html) enthält überarbeitete Definitionen und Inhaltsorganisation.
...
* [Versionshinweise zu AEM 6.2](https://helpx.adobe.com/de/experience-manager/6-2/release-notes.html)
* [Startseite Adobe Experience Manager-Hilfe](https://docs.adobe.com)
* [Versionshinweise zu Scene7 Publishing System](https://marketing.adobe.com/resources/help/de_DE/s7/release_notes/index.html)
* [Versionshinweise zu AEM Assets on Demand](https://helpx.adobe.com/de/support/experience-manager/6-3.html)
...
Aktuelle Informationen finden Sie in den [Livefyre-Versionshinweisen](https://marketing.adobe.com/resources/help/de_DE/livefyre/).
