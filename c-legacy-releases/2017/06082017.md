...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Diese Konfigurationen werden parallel verwendet. Dadurch können verschiedene Instanzen des ID-Dienst-Codes, die in einem iFrame und auf der übergeordneten Seite implementiert sind, miteinander kommunizieren. Sie sollen dabei helfen, Probleme in konkreten Anwendungsfällen zu lösen, in denen Sie die übergeordnete Seite/Domain steuern können oder auch nicht und bei denen ID-Dienst-Code im iFrame einer Domain lädt, die Sie steuern können. Diese sind in VisitorAPI.js Code Version 2.2 oder höher verfügbar. Informationen finden Sie unter <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?=mcvid-whitelistdomain.html" format="https" scope="external">whitelistParentDomain and whitelistIframeDomains </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI ist eine Suite von Business Analytics-Dashboards, um Daten zu analysieren und Erkenntnisse zu teilen. Die Integration von Adobe Analytics mit Power BI bietet nun die Möglichkeit, Report Builder-Analysedaten in Microsoft Power BI zu visualisieren. </p> <p>Mit Power BI können Sie Adobe Analytics mit zusätzlichen Datenquellen (z. B. Verkaufsort, CRM) integrieren, um einzigartige Kundeneinblicke, -verbände und -möglichkeiten zu ermitteln und diese einfach in Ihrem Unternehmen freizugeben. Wenn Sie die Berichterstellungsfunktion von Report Builder mit Funktionen von Power BI kombinieren, sind Informationen für alle Mitglieder der Organisation online leichter zugänglich. </p> <p>Die Integration mit Adobe Report Builder ermöglicht Ihnen Folgendes: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     ...
     <li id="li_C06F93EF77314A8D9F04BF4077A996D1">Es wurde ein Problem behoben, durch das Benutzergruppennamen in der Admin-Konsole nicht in alphabetischer Reihenfolge aufgeführt wurden. (AN-142769, AN-142274) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> Es wurde ein Problem behoben, das bei der Konfiguration der Metriksichtbarkeit, jedoch nicht bei der Metrikpolarität auftrat. Die resultierende Farbe der Sammeländerung im Analysis Workspace war nicht wie erwartet (rot bei negativen, grün bei positiven). (AN-143496, AN-143413) </li> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Nur Beta-zugelassene Advertiser) Zu den neuen Funktionen gehören: </p> <p> 
