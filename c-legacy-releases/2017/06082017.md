...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Diese Konfigurationen werden parallel verwendet. Dadurch können verschiedene Instanzen des ID-Dienst-Codes, die in einem iFrame und auf der übergeordneten Seite implementiert sind, miteinander kommunizieren. Sie sollen dabei helfen, Probleme in konkreten Anwendungsfällen zu lösen, in denen Sie die übergeordnete Seite/Domain steuern können oder auch nicht und bei denen ID-Dienst-Code im iFrame einer Domain lädt, die Sie steuern können. Diese sind in VisitorAPI.js Code Version 2.2 oder höher verfügbar. Siehe <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?=mcvid-whitelistdomain.html" format="https" scope="external">allowParentDomain und allowIframeDomains </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
