...
>[!IMPORTANT]
>
>Der ID-Dienst-Code v2.0 synchronisiert IDs standardmäßig automatisch mit [!DNL  Adobe Media Optimizer]. Siehe auch [Die ID-Synchronisierung und Trefferraten verstehen](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid-match-rates.html).
...
Die Hilfe zum Experience Cloud ID-Dienst finden Sie [hier](https://marketing.adobe.com/resources/help/de_DE/mcvid/).
...
<table id="table_F710029AC6A4459796FBE37123BC5BB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Kunden, die die Experience Cloud ID-Dienst-Bibliothek Version 1.6.0+ mit Adobe Analytics verwenden, benötigen die Analytics-Bibliothek Version 1.6.2+. Bitte aktualisieren Sie Ihre Version entsprechend. </p> <p> Kunden, die die Experience Cloud ID-Dienst-Bibliothek Version 1.10.0 und setCustomerIDs() verwenden, müssen auf AppMeasurement 1.8.0 aktualisieren. </p> </td> 
  </tr> 
  <tr> 
...
[CSV-Dateien für Überlappungsberichte ](https://marketing.adobe.com/resources/help/de_DE/aam/overlap-csv-files.html). Sie können eine CSV-Datei für einen [!UICONTROL Überlappungsbericht] anfordern, wenn dieser Bericht die Grenze von 1 Million Datensätzen erreicht.

Überarbeitet:

* [Häufig gestellte Fragen zu Produkt-Features und Funktionen](https://marketing.adobe.com/resources/help/de_DE/aam/faq_features_functions.html) enthält einen neuen Eintrag zur Suche nach Ihrer [!UICONTROL  Unternehmens-ID].
* [Häufig gestellte Fragen zu Datenerfassung und Produktintegration](https://marketing.adobe.com/resources/help/de_DE/aam/faq_data_collection_integration.html) enthält einen neuen Eintrag zu [!DNL  Audience Manager] IP- und FTP-Adressen.
* [Häufig gestellte Fragen zu Datenschutz und Datenaufbewahrung](https://marketing.adobe.com/resources/help/de_DE/aam/faq_privacy.html) enthält überarbeitete Datenschutzinhalte.
* [Traffic DIL in Google Tag Manager (GTM)](https://marketing.adobe.com/resources/help/de_DE/aam/t_dil_google_tagmanager.html) beschreibt, wie Sie DIL-Code im benutzerdefinierten HTML-Abschnitt eines Tags laden können.
* [TraitWeight](https://marketing.adobe.com/resources/help/de_DE/aam/traitweight.html) enthält neue Informationen über einen zusätzlichen Schritt im algorithmischen Erkennungsprozess.
* [Fehlerraten von Datenstichproben im ausgewählten Audience Manager-Berichten](https://marketing.adobe.com/resources/help/de_DE/aam/report-sampling.html) enthält neue Informationen zur Funktionsweise von Datenstichproben.
* [Die Anforderungen für Name und Dateigröße von Amazon S3 für eingehende Daten](https://marketing.adobe.com/resources/help/de_DE/aam/inbound-s3-filenames.html) enthalten neue Informationen darüber, wie der Validierungsprozess auf leere Datendateien reagiert.
...
* Versionshinweise: [Adobe Experience Manager 6.2 Versionshinweise](https://helpx.adobe.com/de/experience-manager/6-2/release-notes.html)
* Hilfe-Startseite: [Adobe Experience Manager-Hilfe Startseite](https://docs.adobe.com)
* Scene7 Publishing System: [Scene7 Publishing System – Versionshinweise](https://marketing.adobe.com/resources/help/de_DE/s7/release_notes/index.html)
