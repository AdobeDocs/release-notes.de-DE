...
>[!IMPORTANT]
>
>Der ID-Dienst-Code v2.0 synchronisiert IDs standardmäßig automatisch mit [!DNL  Adobe Advertising Cloud]. Weitere Informationen finden Sie unter [Grundlegendes zu ID-Synchronisierung und Übereinstimmungsraten](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Sie können jetzt über „Suche“ &amp;gt; „Produkte“ Daten für ein Bing Merchant Center(BMC)-Konto herunterladen und anzeigen. Sie können auch eine Bestandsfeed-Vorlage mit dem BMC-Konto verknüpfen, um Feed-Spalten in Ihre Kampagnenstruktur und Anzeigenkopien für Shopping-Kampagnen einzubinden. </p> <p>Um direkt mit Produktdaten in der Advertising Cloud arbeiten zu können, müssen Sie in der Advertising Cloud einen entsprechenden Kontodatensatz mit den Kontozugriffsberechtigungen und aktiviertem Zugriff erstellen. </p> <p>Derzeit wird die Verwendung der BMC-Feeds unterstützt, wenn: </p> <p> 
     <ul id="ul_13FE5BC54CE04ED8BBBB0A5438E6C99A"> 
      ...
      <li id="li_EB6B3AF1B3F24A74A24921218F81CC64">URLs in der Feed-Datei enthalten die Advertising Cloud-Umleitung. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
