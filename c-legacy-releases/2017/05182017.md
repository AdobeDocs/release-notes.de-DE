...
[Grundlegendes zu ID-Synchronisierung und Übereinstimmungsraten](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html) umfasst neue Informationen zum ` cm.eversttech.net`-Aufruf des ID-Dienstes an [!DNL  Adobe Advertising Cloud].
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Wenn die Option zum automatischen Optimieren von Standort- oder Remarketing-Listen-Angebotsanpassungen aktiviert ist, ändert die Advertising Cloud jetzt die relevanten Gebotsanpassungen für die relevanten Kampagnen im optimierten Portfolio im Rahmen des Optimierungsprozesses nach Bedarf. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
