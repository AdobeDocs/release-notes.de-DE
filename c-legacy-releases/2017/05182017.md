...
[ID-Synchronisierung und Übereinstimmungsraten verstehen](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid-match-rates.html) enthält neue Informationen über den ` cm.eversttech.net` Aufruf des ID-Service an [!DNL  Adobe Media Optimizer].
...
* [Aufrufe an die Demdex-Domain verstehen](https://marketing.adobe.com/resources/help/de_DE/aam/demdex-calls.html) bietet eine Erklärung darüber, warum [!DNL  Audience Manager] Aufrufe an diese Domäne gesendet werden.
...
* [Anwendungsfälle des Audience Labs](https://marketing.adobe.com/resources/help/de_DE/aam/audience-lab-use-cases.html) bietet Beispiele für die Verwendung dieser Funktion zum Vergleich und zum Testen.
