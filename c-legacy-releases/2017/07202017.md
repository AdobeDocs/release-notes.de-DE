...
Siehe [4.x für Experience Cloud-Lösungen](https://marketing.adobe.com/resources/help/de_DE/mobile/android/) und [iOS SDK 4.x für Experience Cloud-Lösungen](https://marketing.adobe.com/resources/help/de_DE/mobile/ios/) für die SDK-Dokumentation. Um die Versionshinweise für frühere Versionen zu sehen, erweitern Sie *Frühere Versionshinweise* im linken Bereich.
...
* Verbesserungen der [!UICONTROL Regeln für die Profilzusammenführung]: Alle Geräte, die für ein Segment in Echtzeit qualifiziert sind, wenn eine Regel zur Profilzusammenführung mit der Gerätediagrammoption (z. B. dem Kooperationsdiagramm für Geräte von Adobe oder einem externen Gerätediagramm) verwendet wird, werden jetzt in die Gesamtpopulation einbezogen. Außerdem werden die IDs dieser qualifizierten Geräte an ein beliebiges Batch-Ziel gesendet, das für dieses Segment konfiguriert ist. Siehe [Häufig gestellte Fragen zu Profilzusammenführungsregeln und Gerätediagrammen](https://marketing.adobe.com/resources/help/de_DE/aam/profile-merge-faq.html) und [
Daten zu Merkmalen und Segmenten im Segment Builder](https://marketing.adobe.com/resources/help/de_DE/aam/segment-builder-data.html). (AAM-27726)
* CSV-Dateien für [!UICONTROL Overlap Reports] enthielten Zeichenfolgedaten in doppelten Anführungszeichen. Weitere Informationen finden Sie unter [CSV-Dateien für Überlappungsberichte](https://marketing.adobe.com/resources/help/de_DE/aam/?f=overlap-csv-files.html).
