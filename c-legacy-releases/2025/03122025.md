...
| -----------| ---------- | ---------- | ---------- |
|February 2025|[Customize an address layout](https://experienceleague.adobe.com/de/docs/commerce-learn/tutorials/edge-delivery-services/getting-started/customize-address-new-account-link)|New video |Learn how to customize e-commerce checkout forms and integrate Google Address Lookup for improved user experience and reduced input errors.|
