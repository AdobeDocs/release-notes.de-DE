...
| Januar 2023 | [Verwenden von Filtern (Tags)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/using-filters-tags-in-the-left-rail.html?lang=de) | Aktualisiertes Video | Erfahren Sie, wie Sie in Analysis Workspace Filter, so genannte Tags, verwenden. Dies sind zeitsparende Verfahren, mit denen Sie Ihr Projekt effizient erstellen können. |
...
| Januar 2023 | [Verwenden von Tastaturbefehlen](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/keyboard-shortcuts.html?lang=de) | Aktualisiertes Video | Erfahren Sie, wie Sie in Analysis Workspace Tastaturbefehle verwenden. Dies sind zeitsparende Verfahren, mit denen Sie verschiedene Aufgaben in einem Projekt ausführen können. |
