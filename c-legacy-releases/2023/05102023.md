...
| Mai 2023 | [Einführung in Filter in Customer Journey Analytics](https://experienceleague.adobe.com/docs/platform-learn/tutorials/cja/introduction-to-filters-in-cja.html) | Video | Beschreibung |
...
Ressourcen zur Selbsthilfe finden Sie unter [Dokumentation und Tutorials zu Audience Manager](https://experienceleague.adobe.com/docs/audience-manager.html) in Experience League.
...
* [Versions-Updates von Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html) – Sehen Sie sich Videoübersichten zu aktuellen und früheren Versionen von [!DNL Experience Manager as a Cloud Service] an.
...
* Die Unterstützung des neuen Protokolls DASH (Dynamic Adaptive Streaming over HTTP) wurde für adaptives Streaming in der Dynamic Media-Videobereitstellung (mit aktiviertem CMAF) eingeführt:
   ...
   * In Asien-Pazifik und Nordamerika verfügbar; [zu aktivieren über ein Support-Ticket](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html#enable-dash). Bald in Europa, im Nahen Osten und in Afrika verfügbar.
...
* **[Generieren des Datensatzdokuments für die auf Kernkomponenten basierenden adaptiven Formulare](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/generate-document-of-record-core-components.html)** – Erstellen Sie ein Datensatzdokument mit den gesendeten Daten für adaptive Formulare, das mithilfe von Kernkomponenten für die Archivierung oder als Referenz für Endbenutzerinnen und Endbenutzer erstellt wurde, in gedruckter Form oder im Dokumentformat.
...
* Wenn ein [Zertifikat](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html) abläuft, werden [Domain-Namen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-domain-names/introduction.html) und [IP-Zulassungslisten](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/ip-allow-lists/introduction.html), die mit dem Zertifikat verknüpft sind, jetzt nicht mehr aus dem CDN entfernt. In solchen Fällen ist die Site weiterhin erreichbar.
* Die Cloud Manager-Benutzeroberfläche bietet besser sichtbare Warnhinweise, dass das [SSL-Zertifikat](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html) bald abläuft.
...
>[!IMPORTANT]
>
>Adobe empfiehlt Ihnen ein [Upgrade auf die neueste Version 1.9.9](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html) des für Experience Manager erweiterten Workfront-Connectors.
...
* [Versionsaktualisierungen zu Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html)
...
| Mai 2023 | [Arbeiten mit großen Ergebnissätzen in AEM Headless](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/large-result-sets.html) | Video | Erfahren Sie, wie Sie mit großen Ergebnissätzen in AEM Headless arbeiten. | AEM CS |
...
| Mai 2023 | [Einführung in die [!UICONTROL Live-Suche]](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/marketing/live-search.html) | Video | Erfahren Sie, wie Sie mit der [!UICONTROL Live-Suche] von Adobe Commerce ein schnelles, relevantes und intuitives Sucherlebnis erhalten. |
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Mai 2023 | [Erstellen einer Umfrage](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/content-creation/create-a-survey.html) | Video | Erfahren Sie, wie Sie in [!DNL Adobe Campaign] v8 eine Umfrage erstellen. | [!DNL Campaign] v8 |
| Mai 2023 | [Erstellen einer Umfrage](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/create-a-survey.html) | Video | Erfahren Sie, wie Sie in [!DNL Adobe Campaign Classic] eine Umfrage erstellen. | [!DNL Campaign Classic] |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Mai 2023 | [Erstellen einer Web-Kampagne](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/web-channel/author-a-web-campaign.html) | Video | Erfahren Sie, wie Sie in [!DNL Journey Optimizer]-Kampagnen mithilfe des visuellen Web-Editors ein Web-Erlebnis erstellen. |
...
| Mai 2023 | [Exportieren von Datensätzen zu Cloud-Speicherorten](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/data-management/export-datasets.html) | Video | Erfahren Sie, wie Sie einen Datensatz aus [!DNL Journey Optimizer] in ein [!DNL Amazon] S3-Ziel exportieren. |
...
| Mai 2023 | [Aktualisieren einer Anfrage](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/issues-requests/update-a-request.html) | Video | Erfahren Sie, wie Sie die von Ihnen gesendeten Anfragen finden und diese in Workfront aktualisieren können. |
| Mai 2023 | [Grundlegendes zum Abschnitt „Diagramme“](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/workfront-goals/monitor-goals/understand-the-graphs-section.html) | Video | Erfahren Sie, wie Sie die Diagramme „Zielgesundheit“ und „Zielfortschritt“ in „Ziele“ lesen. |
| Mai 2023 | [Einrichten der Übungsdateien für Workfront Fusion](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/fusion/welcome-to-workfront-fusion/set-up-your-fusion-exercise-files-walkthrough.html) | Video | Erfahren Sie, wie Sie in Adobe Workfront Fusion die Übungsdateien herunterladen und in einen Ordner in Workfront hochladen können. |
| Mai 2023 | [Freigeben eines Projekts](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/projects/share-a-project.html) | Video | Erfahren Sie, wie Sie ein Projekt freigeben können, damit Interessengruppen und andere, die an dem Projekt interessiert sind, Einblick in die mit Workfront durchgeführten Arbeiten erhalten. |
| Mai 2023 | [Häufige Fragen zu Anfragewarteschlangen](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/request-queues/request-queue-faq.html) | Artikel | Erhalten Sie Antworten auf häufig gestellte Fragen zu Anfragewarteschlangen in Workfront. |
| Mai 2023 | [Grundlegendes zum Diagramm „Ressourcenkapazität“ in Enhanced Analytics](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/enhanced-analytics/19-resource-capacity-chart.html) | Video | Erfahren Sie, wie das Diagramm „Ressourcenkapazität“ die Anzahl der geplanten Stunden anzeigt, die einem Heim-Team innerhalb des gefilterten Zeitraums zugewiesen wurden, im Vergleich zur Gesamtzahl der verfügbaren Stunden des Teams. |
| Mai 2023 | [Grundlegendes zum Diagramm „Aktivität nach Team“ in Enhanced Analytics](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/enhanced-analytics/18-activity-by-team-chart.html) | Artikel | Erfahren Sie in Workfront, wie die Heim-Teams Ihrer Organisation ihre Zeit verbringen. |
| Mai 2023 | [Grundlegendes zur Team-Kapazität in Enhanced Analytics](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/enhanced-analytics/20-team-capacity-overview.html) | Artikel | Erfahren Sie, wie das Diagramm „Team-Kapazität“ zeigt, ob einem Heim-Team zu viel oder zu wenig Arbeit zugewiesen ist. |
| Mai 2023 | [Schließen eines Ziels nach Abschluss](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/workfront-goals/manage-goals/close-a-goal-once-complete.html) | Video | Erfahren Sie, wie Sie [!UICONTROL Ziele] verwenden, um ein Ziel zu schließen. |
| Mai 2023 | [Grundlegendes zur einfachen Projekterstellung](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/projects/understand-basic-project-creation.html) | Video | Erfahren Sie mehr über die vier Schritte zum Einrichten und Ausführen eines Projekts, die Definition eines Projekts und die drei häufigsten Methoden zum Erstellen eines Projekts. |
| Mai 2023 | [Aktualisieren des Fortschritts der Ergebnisse und Aktivitäten](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/workfront-goals/manage-goals/make-a-quantitative-update.html) | Video | Erfahren Sie, wie Sie den Fortschritt bei Ergebnissen und Aktivitäten in Workfront-Zielen aktualisieren können. |
| Mai 2023 | [Ausfüllen der Projektdetails](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/projects/fill-in-the-project-details.html) | Artikel | Erfahren Sie, für welche 12 Projektdetailfelder Workfront empfiehlt, dass Sie sie beim Erstellen eines Projekts ausfüllen. |
...
| Mai 2023 | [Senden von Dokumenten zur Beglaubigung](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/notarize/send-document-notarize.html) | Video | Erfahren Sie, wie Sie ein Dokument zur Beglaubigung senden. | Acrobat Sign |
