...
* Auf der [Eigenschaftszusammenfassungs-Seite](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_tb_trait_summary.html) wird nun der Eigenschaftstyp angezeigt. (AAM-25784)
* Die [Segmentzusammenfassungs-Seite](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_summary.html) enthält jetzt einen Hyperlink zur Datenquelle des Segments zur einfacheren Navigation. (AAM-40015)
...
* Es wurde ein Fehler behoben, durch den das Kontrollkästchen **[!UICONTROL Alle auswählen]** in den algorithmischen Modellen auf der Seite [Eigenschaften auswählen, die ausgeschlossen werden sollen](https://experiencecloud.adobe.com/resources/help/en_US/aam/trait-exclusion-algo-models.html) fehlte. (AAM-42462)
...
Weitere Informationen finden Sie unter [Über In-App-Nachrichten](https://helpx.adobe.com/de/campaign/standard/channels/using/about-in-app-messaging.html) und die spezielle [In-App-Übung](https://helpx.adobe.com/de/campaign/kt/acs/using/acs-in-app-message-tutorial.html).
...
Weitere Informationen finden Sie im[Neue Funktionen in AEM Assets Marken-Portal](https://helpx.adobe.com/de/experience-manager/brand-portal/using/whats-new.html) und unter [Versionshinweise](https://helpx.adobe.com/de/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html).
