...
Informationen zur Produktdokumentation finden Sie unter [Experience Cloud ID-Dienst](https://docs.adobe.com/content/help/en/id-service/using/home.html).
...
* Ein Problem wurde behoben, bei dem der Vor-/Nachname eines (migrierten) Benutzers in Analytics anders war als der mit der Adobe ID des Benutzers in Experience Cloud verknüpfte Name. Um den Analytics-Namen mit dem im Experience Cloud zu aktualisieren, gehen Sie zu **[!UICONTROL Admin]** > **[!UICONTROL Benutzerverwaltung (veraltet)]** > **[!UICONTROL Benutzer bearbeiten]** und klicken Sie auf die Benutzer-ID. Klicken Sie dann auf **[!UICONTROL Von Experience Cloud aktualisieren]**. (AN-172825)
...
* Auf der Seite [Übersicht über Eigenschaften](https://experiencecloud.adobe.com/resources/help/de_DE/aam/c_tb_trait_summary.html) wird nun der Eigenschaftstyp angezeigt. (AAM-25784)
...
Weitere Informationen finden Sie unter [Info zu In-App-Nachrichten](https://helpx.adobe.com/de/campaign/standard/channels/using/about-in-app-messaging.html) und im dedizierten [In-App-Lernprogramm](https://helpx.adobe.com/de/campaign/kt/acs/using/acs-in-app-message-tutorial.html).
...
Aktuelle Informationen finden Sie unter [Livefyre-Versionshinweise](https://docs.adobe.com/content/help/en/livefyre/using/release-notes/c-rn.html).
