...
| Änderungen an der regionalen Datenerfassung (RDC) in China | Mit der regionalen Datenerfassung von Adobe auf dem chinesischen Festland können Kunden in China Daten direkt an ein Datenerfassungszentrum innerhalb Chinas und nicht weltweit an andere Standorte senden. Dadurch werden die Seitenladezeit und die Datengenauigkeit verbessert, während die Daten an Datenerfassungszentren außerhalb Chinas gesendet werden. [Mehr](https://marketing.adobe.com/resources/help/de_DE/reference/rdc-china.html) |
| Regionale Beschleunigung für China | Die Option &quot;China-Beschleunigung&quot;ist jetzt in den Analytics Report Suite-Einstellungen verfügbar. Diese Option verbessert die Benutzerfreundlichkeit von Adobe Analytics Berichte für Benutzer in Mainland China. Jeder Adobe Analytics-Benutzer kann diese Option aktivieren oder deaktivieren. Wählen Sie diese Option nicht für Benutzer außerhalb von Mainland China, da sie die Leistung negativ beeinflusst. [Mehr](https://marketing.adobe.com/resources/help/de_DE/sc/user/report_settings.html) |
...
Diese Version umfasst die Integration von Adobe Campaign mit den allgemein verfügbaren (GA) Versionen von Android- und iOS-Erweiterungen für Adobe Campaign Standard in Adobe Experience Platform Launch und Mobile SDKs. Diese Erweiterungen unterstützen Push-Benachrichtigungen, In-App-Benachrichtigungen und Mobile-App-Profilaktualisierungen.

Weitere Informationen finden Sie unter [Verwenden von Adobe Experience Platform SDK](https://helpx.adobe.com/de/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
Mit der Veröffentlichung von Cloud Manager 2019.2.0 wird die Systemüberwachung hinzugefügt. Diese neue Funktion ermöglicht es Kunden, den Status ihrer Adobe Managed Services-Umgebung auf Systemebene Ansicht.
