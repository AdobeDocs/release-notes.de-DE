...
* Die Hilfedefinition für [Protokoll-Syntaxdokumentation (X, B)](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) wurde aktualisiert. (AN-180527)
...
Ein wichtiger AEM-Patch für die AEM 6.5 clientlibs-Cache-Cache-Speicherung ist über das [AEM 6.5.1.0-Update](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) oder diesen [KB-Artikel verfügbar](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html).
