...
# Versionshinweise zu Adobe Experience Cloud - Mai 2019
...
| **Analysis Workspace:** Neue Einstellung für die Flussvisualisierung _Wiederholungsinstanzen einschließen_ | Mit der Einstellung &quot;Wiederholte Instanzen _einschließen_ &quot;können Sie wiederholte Instanzen, wie z. B. Seitenneuladungen, ein- oder ausschließen. Darüber hinaus basieren alle Flussvisualisierungen jetzt nur noch auf Instanzen. |
| **Ad Hoc Analysis:** Kompatibilität mit Java 11 | Ad Hoc Analysis ist jetzt kompatibel mit Java 11. Erfahren Sie, wie Sie [Ad Hoc Analysis auf Java 11](https://marketing.adobe.com/resources/help/en_US/dsc/adhoc-java.html)ausführen. |
| **Datenerfassung:** Neues s_ecid-Cookie | Added a new [first-party server cookie](https://docs.adobe.com/content/help/de-DE/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor&#39;s ECID. |
...
* Audience Analytics: Es wurde ein Fehler behoben, der auftrat, nachdem der Name einer Audience in Audience Manager (AAM) geändert wurde - der aktualisierte Name wurde in Audience Analytics nicht angezeigt. (AN-176237)
* Es wurde ein Problem behoben, bei dem Benutzer keine Analytics-Segmente in AAM speichern konnten. Dies wurde durch vorhandene AAM-Ordner mit Groß- und Kleinbuchstaben verursacht. Wir behandeln nun alle Ordner ohne Unterscheidung von Groß- und Kleinschreibung, sodass sie synchronisiert werden. (AN-177934)
...
* Es wurde ein Problem mit Zeitzonenoffset in Data warehouse-Anforderungen behoben. (AN-177585)
...
AEM 6.5, verfügbar ab 8. April 2019, ist eine Upgrade-Version auf die AEM 6.4-Codebasis. Unsere neuesten Updates für AEM 6.5 bieten Ihnen sofortigen Zugriff auf interessante Verbesserungen, die Ihr Unternehmen noch schneller vorantreiben.
...
AEM 6.4, Service Pack 4 (6.4.4.0, 04. April 2019) ist ein wichtiges Update, das wichtige Fehlerbehebungen enthält, die seit der allgemeinen Verfügbarkeit von AEM 6.4, April 2018, veröffentlicht wurden.

[Versionshinweise zu AEM 6.4 Service Pack](https://helpx.adobe.com/de/experience-manager/6-4/release-notes/sp-release-notes.html)-[AEM Forms](https://helpx.adobe.com/de/aem-forms/kb/aem-forms-releases.html)

**AEM S3 Connector**

AEM-Instanzen mit alten Versionen des S3-Datenastore-Connectors stehen aufgrund von S3-Zugriffsfehlern möglicherweise nicht mehr zur Verfügung, nachdem die Signature-Version 2 am 24. Juni 2019 nicht mehr unterstützt wurde. Als AEM-Kunde empfiehlt Adobe, die Version des S3-Datenastore-Connectors zu überprüfen, die Sie verwenden. Aktualisieren Sie bei Bedarf auf eine neuere Version.

Siehe Auswirkungen [der AWS-Signatur in Version 2 - Veraltet für Amazon S3](https://helpx.adobe.com/de/experience-manager/kb/the-impact-of-aws-signature-version-2-deprecation-for-amazon-s3.html)

### Selbsthilfe

**Modernisieren der AEM Sites-Codebasis**

Erfahren Sie, wie Sie die neueste AEM-Technologie nutzen können, um Ihre AEM Sites-Codebase zu modernisieren. [Vorhandene Adobe Experience Manager-Sites-Codebase modernisieren](https://expleague.azureedge.net/labs/L761/index.html)

**AEM Rich Text Editor - Deep Dive**

Hier lernen Sie bewährte Verfahren für die Rich-Text-Konfigurationen und die Verwendung des Rich-Text-Editors in AEM kennen.
...
Magento ist eine E-Commerce-Plattform, die Online-Händler mit einem flexiblen Einkaufswagen-System und Kontrolle über das Aussehen, Inhalt und Funktionalität ihres Online-Shops bietet. Magento ist in einer Open-Source-Version und einer Vollversion erhältlich.
