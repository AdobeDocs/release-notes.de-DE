...
| -----------| ---------- | ---------- |
| Einschränkungen für Classification Rule Builder | Hinzugefügt am 5. Juni 2019 | Diese Beschränkungen sind nicht neu, wurden aber zur Dokumentation [hier hinzugefügt](https://marketing.adobe.com/resources/help/en_US/reference/classification_rule_builder.html). |
...
| Schutz, Stabilität und Skalierbarkeit | Campaign Classic wurde eine Reihe von Verbesserungen hinzugefügt. Verbesserungen an der Speicherung, Stabilität und Skalierbarkeit werden in [den Versionshinweisen zur Kampagne Classic aufgeführt](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
