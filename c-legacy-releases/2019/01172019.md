...
# [!DNL Adobe Experience Cloud] Versionshinweise - Januar 2019
...
* [Target](https://marketing.adobe.com/resources/help/en_US/target/rn/target_release_notes.html) - Links zur Hilfe zur Lösung
...
* [Start](https://docs.adobelaunch.com/) - Links zur Produkthilfe
...
In 8.1 haben wir DIL an die strengeren Sicherheitsrichtlinien von Google Tag Manager angepasst. This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. Künftige Versionen werden diese Änderungen enthalten. (CORE-24189)
