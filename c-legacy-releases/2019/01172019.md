...
* [Target](https://marketing.adobe.com/resources/help/en_US/target/rn/target_release_notes.html) - Links zur Lösungshilfe
* [Primetime](https://helpx.adobe.com/primetime/user-guide.html) - Links zur Lösungshilfe

## [!DNL Experience Cloud] Hauptdienste und Administration {#experiencecloud}
...
* [Starten von Adobe](https://docs.adobelaunch.com/) - Links zur Produkthilfe
...
### [!DNL Experience Cloud] Oberfläche {#ecui}

Funktionen und Fehlerbehebungen in der Experience Cloud-Oberfläche.

#### Version 19.1.1

**Hinweis:** Im März 2019 wird Internet Explorer 11 von der Experience Cloud-Oberfläche nicht unterstützt.
...
Diese Einstellung kann über **[!UICONTROL Project]** &gt; **[!UICONTROL Project Info &amp; Settings]** aufgerufen werden.
...
* Admin: Es wurde ein Fehler behoben, der verhinderte, dass Nicht-Administratoren Verarbeitungsregeln erstellen konnten, selbst wenn ihnen die entsprechenden Rechte zugewiesen wurden. (AN-170690)
...
* Die Verwendung der Eingabetaste am Anfang eines `<li>` Elements `<p>` bricht Conrefs ab.
...
* Wenn im Autorenmodus die Eingabetaste zum Hinzufügen eines Absatzelements `<p>` in einer Tabellenzelle verwendet wurde, führte die PDF-Ausgabe zu zusätzlichen Hash-Zeichen.
...
| Beta-Verbesserungen am In-App-Messaging | Die Beta-Funktion für das In-App-Messaging wurde um folgende Optionen erweitert: Der In-App-Beta-Kanal ist GDPR-kompatibel; Integration mit Analytics-apis zum Ausfüllen von Triggers-Dropdowns; Intuitive Darstellung und Beschreibung der Bereitstellungsvorlagen; Verbesserungen an der Authoring-Oberfläche aus dem Standpunkt. Weitere Informationen finden Sie in der ausführlichen Dokumentation. |
