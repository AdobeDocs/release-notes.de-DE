...
| September 2021 | [Fehlender Null-ID-Datensatz](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/login-and-client-console/fixing-zero-id.html) | Campaign Classic | Erfahren Sie, wie Sie das Problem der Null-ID (0) beheben können. |
...
| September 2021 | [Kampagnentitel an Analytics senden](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/integrations/missing-campaign-label.html) | Campaign Classic | Erfahren Sie, wie Sie das Fehlen eines Kampagnentitels in Analytics beheben können. |
