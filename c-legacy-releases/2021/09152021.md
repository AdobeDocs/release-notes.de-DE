...
| Funktion | Beschreibung |
| ------- | ----------- |
| Markensicherheit | (Release vom 22. September) [!DNL DoubleVerify] Produkte zur Markensicherheit wurden aktualisiert auf [!DNL Brand Suitability Tiers], die es Werbetreibenden ermöglichen, zwischen drei Risikostufen (niedrig, mittel und hoch) für bestimmte Segmente zu wählen, ohne dass alle Instanzen eines bestimmten Themas vermieden werden. Historisch gesehen enthielten die Segmente keine Toleranzwerte. |
...
| Funktion | Beschreibung |
| ------- | ----------- |
| Werbeeinblicke | (8. September) Weitere Einblicke sind im Beta-Modus verfügbar. |  | Markensicherheit | (Release vom 22. September) [!DNL DoubleVerify] Produkte zur Markensicherheit wurden aktualisiert auf [!DNL Brand Suitability Tiers], die es Werbetreibenden ermöglichen, zwischen drei Risikostufen (niedrig, mittel und hoch) für bestimmte Segmente zu wählen, ohne dass alle Instanzen eines bestimmten Themas vermieden werden. Historisch gesehen enthielten die Segmente keine Toleranzwerte. |
