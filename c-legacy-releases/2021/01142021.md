...
| 9. Dezember 2020 | [Erstellen von Regeln in Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-rules.html?lang=de) | Video | Erfahren Sie, wie Sie in [!UICONTROL Offer Decisioning] Regeln erstellen. Regeln werden mithilfe der Ereignisse und Attribute in Platform erstellt. [!UICONTROL Echtzeit-Kundenprofil] und aus den Eignungsbegrenzungen von Angeboten. |
...
| ----------- | ---------- | ----- |
| [!UICONTROL Geräte]- und [!UICONTROL Geografie]-Dimensionen | 30. Oktober 2020 | Diese Dimensionen sind jetzt standardmäßig als Teil der [Standardsuche](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/standard-lookups.html) Unterstützungsprojekt in Adobe Analytics [!UICONTROL Source Connector]. Dieser dringend benötigte Zusatz erhöht die [Parität zwischen Adobe Analytics und CJA](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-aa.html?lang=de#cja-overview). |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| 7. Dezember 2020 | [Erweiterte Datenmodellierung mit Fragmentverweisen](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/multi-step/fragment-references.html) | Artikel | Erste Schritte mit Adobe Experience Manager (AEM) und GraphQL. Erfahren Sie, wie Sie die [!UICONTROL Fragmentverweis] Funktion für erweiterte Datenmodellierung und zur Erstellung einer Beziehung zwischen zwei verschiedenen [!UICONTROL Inhaltsfragmente]. Erfahren Sie, wie Sie eine GraphQL-Abfrage ändern, um Felder aus einem referenzierten Modell einzubeziehen. |
