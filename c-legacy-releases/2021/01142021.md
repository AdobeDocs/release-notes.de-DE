...
| Migration von der Domain `omniture.com` zu `adobe.com` | 21. August 2020 | Am 13. August 2020 migrierte Adobe Analytics seine Frontend-Architektur von der Domain `omniture.com|http://omniture.com/` zu `adobe.com|http://adobe.com/`. Diese Änderung soll Probleme mit Drittanbieter-Cookies beheben, die nach der ersten Änderung der einheitlichen Produkt-Domain am 28. Mai 2020 aufgetreten sind. Aufgrund dieser Aktualisierung werden Benutzer vom Browser aufgefordert, der neuen Domäne `.adobe.com|http://an.adobe.com/` oder `experience.adobe.com|http://experience.adobe.com/` zu vertrauen. |
| Aktualisierung auf Ad Hoc Analysis Java™ 8-Kompatibilität | 21. August 2020 | Ad Hoc Analysis ist derzeit nicht mit Java™ 8-Versionen 1.8.0_261+ kompatibel. Um sicherzustellen, dass Ihr Zugriff auf dieses Tool nicht unterbrochen wird, bevor das [Enddatum des Lebenszyklus](https://spark.adobe.com/page/S9Bhp66VJ2fEn/) erreicht ist, empfiehlt Adobe, eine Java™ 8-Version vor dem 1.8.0_261 zu verwalten. |
| Ende von Adobe Data Connectors | 13. Juli 2020 | Adobe [!UICONTROL Data Connectors] basieren auf einer älteren Technologie, die nicht mehr funktionsfähig ist oder unterstützt wird. Adobe hat im [Adobe Exchange Partner Program](https://partners.adobe.com/exchangeprogram/experiencecloud) einen neuen Standard, der für alle Integrationen übernommen werden sollte, die weiterhin angeboten und unterstützt werden sollen. Das offizielle Ende des Lebenszyklus ist noch festzulegen, aber Adobe geht davon aus, dass es in den nächsten 12 bis 18 Monaten (Mitte 2021 bis Ende 2021) sein wird. [Weitere Infos...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=de) |
...
Experience Manager 6.5, Service Pack 7 (6.5.7.0, veröffentlicht am 26. November 2020) ist ein wichtiges Update mit neuen Funktionen, wichtigen Kundenverbesserungen, verbesserter Performance, Stabilität und Sicherheit, das seit der allgemeinen Verfügbarkeit von Experience Manager 6.5, April 2019, veröffentlicht wurde.
...
| 16. Dezember 2020 | [Dynamic Media-Kernkomponente](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-core-components.html?lang=de) | Video | Die Image-Komponente, die zu den Experience Manager-Kernkomponenten gehört, unterstützt Dynamic Media. Erfahren Sie, wie die Bildkomponente einem Inhaltsautor oder einer Inhaltsautorin ermöglicht, Funktionen von Dynamic Media wie Bildvorgaben, Smart Crop und Bildmodifikatoren auf einer Experience Manager Sites-Seite zu verwenden. |
