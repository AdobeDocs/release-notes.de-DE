...
Die Dokumentation zu Experience Cloud-Diensten und Administration umfasst Kundenattribute, die Zielgruppenbibliothek ([!UICONTROL Personen] -Dienst), Aktivierung, Benutzer- und Produktverwaltung sowie Experience Cloud-Cookies.

Kein Update in diesem Monat.

Aktuelle Versionsinformationen finden Sie unter [den gesammelten Versionshinweisen zu Experience Cloud-Services](https://experienceleague.adobe.com/docs/core-services/interface/release-notes/release-notes.html?lang=de).
...
Allgemein - Das SDK wird jetzt mit [!DNL XCFrameworks] um Hardware mit der neuen Apple M1-Architektur zu unterstützen und gleichzeitig die Unterstützung der bestehenden Intel® Architektur zu erhalten.
...
| -----------| ---------- | ---------- | ---------- |
| 23. Dezember 2020 | [Übersicht über Vereinigungsschemas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/union-schemas-overview.html?lang=de) | Video | Erfahren Sie mehr über Vereinigungsschemas, die vom Echtzeit-Kundenprofil von Adobe Experience Platform verwendet werden. |
| 22. Dezember 2020 | [Erstellen von Segmenten mit mehreren Entitäten](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/create-multi-entity-segments.html?lang=de) | Video | Erfahren Sie, wie Sie im Segmentaufbau von Adobe Experience Platform Segmente mit mehreren Entitäten erstellen. |
...
| 9. Dezember 2020 | [Erstellen von Regeln in Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-rules.html?lang=de) | Video | Erfahren Sie, wie Sie in [!UICONTROL Offer Decisioning] Regeln erstellen. Regeln werden anhand der Ereignisse und Attribute in den Platform-Variablen [!UICONTROL Echtzeit-Kundenprofil] und aus den Eignungsbegrenzungen von Angeboten. |
...
| 29. Oktober 2020 (aktualisiert) | [Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/demo-of-offer-decisioning.html?lang=de) | Video | Erfahren Sie, wie Marken die neue Adobe [!UICONTROL offer decisioning] -Dienst, um ihre Angebote zu definieren und zu verwalten, Echtzeit-Kundendaten zu nutzen und die richtigen Erlebnisse für ihre Kunden bereitzustellen. |
...
| 26. Oktober 2020 (aktualisiert) | [Datenerfassung mit Salesforce CRM Source Connector](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html?lang=de) | Video | Mit dem Salesforce CRM Source Connector können Sie Daten aus Salesforce CRM problemlos in das Echtzeit-Kundenprofil von Adobe Experience Platform und den Experience Data Lake integrieren, und zwar auf nahtlose und skalierbare Weise. |
| 13. Oktober 2020 (aktualisiert) | [Datenerfassung mit Salesforce CRM Source Connector](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=de) | Video | Mit dem Salesforce CRM Source Connector können Sie Daten aus Salesforce CRM problemlos in das Echtzeit-Kundenprofil von Adobe Experience Platform und den Experience Data Lake integrieren, und zwar auf nahtlose und skalierbare Weise. |
...
Experience Manager 6.5, Service Pack 7 (6.5.7.0 vom 26. November 2020) ist ein wichtiges Update, das neue Funktionen, wichtige Kundenverbesserungen, verbesserte Leistung, Stabilität und Sicherheit umfasst. Dieses Update wurde seit der allgemeinen Verfügbarkeit von Experience Manager 6.5 im April 2019 veröffentlicht.
...
Weitere Informationen zu diesem Plug-in finden Sie unter [Einheitliches Erlebnis](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=de#benefits).
      * Index Converter ist ein Dienstprogramm, mit dem die benutzerdefinierten OAK-Indexdefinitionen eines Kunden in as a Cloud Service kompatible OAK-Indexdefinitionen des Experience Managers umgewandelt werden können.
...
* **Best Practices Analyzer**
   ...
   * [!UICONTROL Cloud Readiness Analyzer] heißt jetzt [!UICONTROL Best Practices Analyzer] (BPA). BPA bietet eine Best Practices-Bewertung Ihrer aktuellen Experience Manager-Implementierung und hilft bei der Beurteilung der Bereitschaft, von einer vorhandenen AEM-Instanz zu AEM zu wechseln, als [!UICONTROL Cloud Service].
...
| 9. Dezember 2020 | [API-Kompatibilität](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/developer-reference-material-apis.html?lang=de) | Artikel | Erstellen Sie einen einfachen Artikel, der klar angibt, welche AEM APIs (npm, Java™, HTTP) für verschiedene [!UICONTROL Assets] Vorgänge. |
...
| 16. Dezember 2020 | [Dynamic Media-Kernkomponente](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-core-components.html?lang=de) | Video | Die Image-Komponente, die zu den Experience Manager-Kernkomponenten gehört, unterstützt Dynamic Media. Erfahren Sie, wie die Bildkomponente es einem Inhaltsautor ermöglicht, Funktionen von Dynamic Media wie Bildvorgaben, smartes Zuschneiden und Bildmodifikatoren auf einer Experience Manager Sites-Seite zu verwenden. |
...
| 29. Dezember 2020 | [Erstellen ausfüllbarer Formulare](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/getting-started/create-fillable-forms.html?lang=de) | Artikel | Verwandeln Sie gescannte Papierformulare oder Dokumente, die in InDesign, Microsoft® Word oder Excel oder einer anderen Anwendung erstellt wurden, in ein ausfüllbares PDF-Formular. |
