...
| [Hub-Blueprint zur Kundenaktivität](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/customer-activity.html) | Erfahren Sie, wie externe Anwendungen auf das [!UICONTROL Echtzeit-Kundenprofil] von Adobe Experience Platform zugreifen können. |
...
| [Blueprint zur serverseitigen Unternehmenserfassung](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-ingestion/server-side-collection.html) | Erfahren Sie, wie mit Adobe Experience Platform Web- und Mobile-SDKs erfasste Daten von Experience Platform [!UICONTROL Edge Network] an das gewünschte Ziel weitergeleitet werden können. |
...
| -----------| ---------- |
| Einheitliche Suche | Unified Search, die für die Experience Platform verfügbar ist, unterstützt jetzt die Suche nach Quellen und Zielen für Experience Platform-Benutzer. Mit dieser Funktion können Sie Segmente, Datensätze, Schemas, Quellen und Ziele durchsuchen. |
...
| März 2021 | [Streamen von Daten mithilfe von Source Connectors](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector.html?lang=de) | Video | In diesem Video wird gezeigt, wie Daten in Echtzeit von einer Cloud-Speicherquelle an Platform gestreamt und in Echtzeit für die Kundeninteraktion verwendet werden. |
...
| 5. März 2021 | [Streamen der Datenerfassung über die API](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api.html?lang=de) | Video | In diesem Video wird gezeigt, wie Daten mithilfe des HTTP-API-Endpunkts in Echtzeit an Adobe Experience Platform gestreamt werden. |
...
| 5. März 2021 | [Daten aus Adobe Analytics aufnehmen](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html) | Video | Mit Adobe Analytics Source Connector können Sie Daten aus Adobe Analytics nahtlos und skalierbar in das Echtzeit-Kundenprofil und in Experience Data Lake von Adobe Experience Platform streamen. |
...
| 5. März 2021 | [Details zu Adobe IO Console Export Postman](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html) | Video | Erfahren Sie, wie Sie Experience Platform-APIs authentifizieren und darauf zugreifen. |
...
| Analysis Workspace: [!UICONTROL Histogramm Smart Bucket Predic>] | 25. März 2021 | [!UICONTROL Histogramm Smart Bucket Prediction] hilft bei Histogrammen mit hoher Kardinalität, indem automatisch die richtige Breite und Anzahl der Behälter für Ihren Datenbogen identifiziert wird. Bei Metriken mit niedriger Kardinalität verhält sich die Visualisierung genauso wie zuvor. |
...
* [Versions-Updates und Roadmap für Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html?lang=en)
...
| März 2021 | [Grundlage – Management von Arbeitsabläufen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/administering/workflows-administering.html?lang=en) | Video | In diesem Video werden Arbeitsablaufmodelle verwendet, um diesen Satz von Funktionen zu demonstrieren. Sie gelten auch für AEM-Starter. |
...
* [Experience Manager 6.2 – Training und Support, Startseite](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
...
* [Ältere Versionen der Dokumentation zu Experience Manager](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
