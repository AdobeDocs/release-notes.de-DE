...
* [Wichtige Hinweise für Analytics-Administrierende](#aa-notices) **(aktualisiert am 6. April 2021)**
* [AppMeasurement](#appm)
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| 19. März 2021 | [Grundlegendes zur Datenverwaltung in Real-Time CDP für Benutzende von Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-data-gov-for-aam-users.html?lang=de) | Video | Erfahren Sie mehr über die Funktionen zur Datenverwaltung in der [!UICONTROL Real-time Customer Data Platform]. |
...
| 3. März 2021 | [Grundlegendes zu Eigenschaften in Real-Time CDP für Benutzende von Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.html#other-integrations) | Video | Erfahren Sie, welche Eigenschaften in Audience Manager vorhanden sind und welche ihnen in Real-Time CDP entsprechen. |
...
Neue Funktionen, Fehlerbehebungen und Aktualisierungen in Experience Manager. Adobe empfiehlt Kunden mit lokalen Bereitstellungen, die aktuellen Patches bereitzustellen, um mehr Stabilität, Sicherheit und Leistung zu erzielen.
...
Die aktuellen Versionsinformationen finden Sie in den [!DNL Marketo Engage] [Versionshinweisen](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html).
