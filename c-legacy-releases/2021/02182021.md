...
| 2. Februar 2021 | [AEM-Projekte zur Implementierung mit Cloud Manager zusammenführen](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/merge-projects.html?lang=de) | Video | Erfahren Sie, wie mithilfe von Cloud Manager mehrere Projekte zur Implementierung in Experience Manager as a Cloud Service zu einem einzigen Projekt zusammengeführt werden können. |
