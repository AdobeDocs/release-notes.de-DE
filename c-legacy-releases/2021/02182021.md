...
| 3. Februar 2021 | [Aktivieren von Daten in nicht zu Adobe gehörenden Anwendungen](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=de) | Video | Erfahren Sie, wie Sie mit der Real-Time CDP von Adobe wahre Personalisierungsstrategien für Ihre Zielgruppen erstellen können. Erfahren Sie außerdem, wie es in Ihr bestehendes Ökosystem und mit nicht zu Adobe gehörenden Anwendungen von Microsoft®, Google und Facebook eingebunden werden kann. |
