...
* Der [DCS-Systemfehler-Code 10](https://experienceleague.adobe.com/docs/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-error-codes.html#system-error-codes) wurde hinzugefügt. Er gibt an, ob die Eigenschaften in der Anfrage teilweise oder gar nicht ausgewertet wurden.
...
In den [!DNL Marketo Engage] [Versionshinweisen](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) finden Sie die neuesten Informationen zum Versionsplan.
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| Mai 2021 | [Steuern Ihrer Online-Erfahrung mit PDFs und Sammeln von Analysen](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=de#part1) | Artikel | Erfahren Sie, wie Sie mit der Adobe PDF Embed-API das Erscheinungsbild steuern, die Zusammenarbeit aktivieren und Analysen zur Interaktion der Benutzenden mit PDFs sammeln können, einschließlich der Zeit, die auf einer Seite oder mit Suchvorgängen verbracht wurde. (Vier Teile.) |
