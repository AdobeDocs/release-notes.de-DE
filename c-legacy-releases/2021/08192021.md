...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager as a Cloud Service Foundation**
      ...
      * Die Benutzeroberfläche für die Strukturreplikation unter dem Replikationsagenten [!UICONTROL Verteilen] -Registerkarte als veraltet betrachtet werden; Es ist für die Entfernung nach dem 30. September 2021 geplant. [Erfahren Sie mehr über alternative Replikationsstrategien](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=de#tree-activation).
