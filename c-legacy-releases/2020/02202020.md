...
* Behebung eines Fehlers, der dazu führte, dass Trait-Recommendations von Drittanbietern bei Traits, die Pipe-Zeichen (`|`) im Namen (AAM-51635) enthalten, nicht korrekt funktionierten.
* Mehrere Verbesserungen hinsichtlich der Barrierefreiheit in der gesamten Benutzeroberfläche.

## Experience Manager {#aem}

Neue Funktionen, Fehlerbehebungen und Updates in Adobe Experience Manager (Experience Manager). Adobe empfiehlt Kunden mit lokalen Bereitstellungen, die aktuellen Patches bereitzustellen, um mehr Stabilität, Sicherheit und Leistung zu erzielen.
