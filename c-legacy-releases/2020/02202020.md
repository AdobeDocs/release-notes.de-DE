...
* **Neue Workspace-Vorlage für Organisationen, die geräteübergreifende Analysen verwenden:** Diese Vorlage zeigt, wie effektiv CDA beim Zusammenfügen von Besuchen ist und informiert Sie über CDA-exklusive Dimensionen und Metriken. Eine Report Suite, die CDA verwendet, ist erforderlich. Weitere Informationen finden Sie unter [Einrichten von geräteübergreifenden Analysen](https://experienceleague.adobe.com/docs/analytics/components/cda/cda-setup.html?lang=en).
...
* **Labs (Technologievorschau):** Mit dieser neuen Analytics-Funktion können Sie neue Funktionsprototypen in der Produktion testen und Adobe wertvolles Feedback geben. [Weitere Infos...](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html?lang=en)
...
| Option **[!UICONTROL Archiv anzeigen]** wird eingestellt | 30. Oktober 2019 | Die Option Archiv anzeigen ]**im Dashboard-Manager (**[!UICONTROL  Komponenten > Dashboards ]**) wird im Januar 2020 eingestellt.**[!UICONTROL  |
...
* **Tutorials für Experience Manager als Cloud Service**
   ...
   Beginnen Sie schnell mit den [Tutorials für Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en).
