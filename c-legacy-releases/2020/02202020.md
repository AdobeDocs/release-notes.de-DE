...
* **Chromium-basierter Microsoft® Edge-Browser:** Diese Version umfasst Änderungen zur Erkennung des Chromium-basierten Microsoft® Edge-Browsers (Version 79 und höher) zu Berichtszwecken.
...
| Option **[!UICONTROL Archiv anzeigen]** wird eingestellt | 30. Oktober 2019 | Ankündigung des Enddatums (Januar 2020) für die **[!UICONTROL Archiv anzeigen]** im Dashboard-Manager (**[!UICONTROL Komponenten > Dashboards]**). |
...
* Es wurde ein Fehler behoben, der dazu führte, dass Empfehlungen zu Eigenschaften von Drittanbietern für Eigenschaften mit Pipe-Zeichen (`|`) im Namen (AAM-51635).
...
* **Tutorials für Experience Manager as a Cloud Service**
   ...
   Erste Schritte mit dem [Tutorials für Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=de).
