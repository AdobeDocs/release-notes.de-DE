...
| Option **[!UICONTROL IP-Anmeldebeschränkungen erzwingen]** wird eingestellt | 30. Oktober 2019 | Die IP-Zulassungsliste-Funktion (**[!UICONTROL IP-Anmeldebeschränkungen erzwingen]**) unter dem Menü **[!UICONTROL Admin > Unternehmenseinstellungen > Sicherheit]** wird im Januar 2020 eingestellt. |
...
| FTP-Broker in San Jose endet für London und Singapur | Juli 2020 | Für Kunden in London und Singapur wird die Datenvermittlung zwischen London oder Singapur und dem Rechenzentrum in San Jose nicht mehr unterstützt. [ftp.omniture.com](ftp://ftp.omniture.com/)<br/><ul><li>Für London verwenden Sie [ftp3.omniture.com](ftp://ftp3.omniture.com/)</li><li>Für Singapur verwenden Sie [ftp4.omniture.com](ftp://ftp4.omniture.com/)</li></ul> |
...
* **Service zur automatischen Formularumwandlung**
   ...
   * [Konfigurieren des Dienstes](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   * [Konvertieren von PDF-Formularen in adaptive Formulare](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)
...
| Suche > Kampagnen, Berichte | Die Google Ads-Bekanntheitsmetriken &quot;Impr. (Abs. Top) %&quot;und &quot;Impr. (Top) %&quot;sind jetzt in allen allgemeinen Berichten und Kampagnenverwaltungsansichten auf Entitätsebene verfügbar, mit Ausnahme der Ansichten für Einkaufsproduktgruppen, in den Berichten Campaign Daily Impression Share und Keyword Daily Impression Share sowie in den Bezeichnungs- und Beschränkungsansichten. |
