...
Adobe passt die Einstellung `same-site` für Cookies an, um sich auf Änderungen vorzubereiten, die Chrome in Chrome 80 vornimmt (Veröffentlichung im Februar 2020).
...
| Option **[!UICONTROL IP-Anmeldebeschränkungen erzwingen]** wird eingestellt | 30. Oktober 2019 | Die IP-Zulassungsliste-Funktion (**[!UICONTROL IP-Anmeldebeschränkungen erzwingen]**) unter **[!UICONTROL Admin > Unternehmenseinstellungen > Sicherheit]** wird im Januar 2020 eingestellt. |
...
* **Dienst zur automatischen Formularumwandlung**
   ...
   * [Einführung](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/introduction.html?lang=en)
...
Siehe [Anzeigen einer Vorschau von 3D-Assets](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html?lang=en).

* **Kernkomponenten**

   Core Components 2.8.0 ist jetzt gemeinsam mit der [Erstellungsdokumentation](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=en), den [Entwicklerdetails und dem Projektdownload auf GitHub](https://github.com/adobe/aem-core-wcm-components) verfügbar.
...
* Einrichten einer neuen Subdomäne – [Weitere Informationen](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html?lang=en)
