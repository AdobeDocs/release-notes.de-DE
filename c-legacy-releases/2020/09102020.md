...
Aktuelle Versionsinformationen finden Sie unter [Systemstatus von Adobe – 21. Mai 2020](https://experienceleague.corp.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html#status).

## ![Symbol](/assets/ec_appicon_24.png) Experience Cloud-Benutzeroberfläche {#ecloud}

Die neuesten Versionsinformationen zur Experience Cloud-Benutzeroberfläche (Kundenattribute, Audiences, Benutzer- und Produktverwaltung) finden Sie unter [Sammlung von Versionshinweisen](https://experienceleague.corp.adobe.com/docs/core-services/interface/release-notes/release-notes.html).
...
* [Ziele](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#destinations)
* [Quellen](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#sources)
...
* August-Version – [Mehr erfahren](https://experienceleague.corp.adobe.com/docs/journeys/using/release-notes/release-notes.html#august-release)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Möglichkeit in [!UICONTROL AEM as a Cloud Service], [Seiten und Unterseiten (Seitenbäume) als frühere Version wiederherzustellen](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions).
...
Siehe [Inhaltsprüfungstests](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html).
...
* **Experience Manager [!UICONTROL Desktop-App] 2.0.3.2**
   ...
   * Siehe [Versionshinweise](https://experienceleague.corp.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html).
...
* **AEM [!UICONTROL Assets Brand Portal]**
   ...
   * Siehe [Versionshinweise](https://experienceleague.corp.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html).
...
* **Ungültigmachen von CDN in [!UICONTROL Dynamic Media]**
   ...
   Siehe [Ungültigmachen des CDN-Cache in [!UICONTROL Dynamic Media].](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)
...
* **[!UICONTROL Kernkomponenten]**
   ...
   [!UICONTROL Kernkomponentenversion] 2.11.0 führt Unterstützung für AMP ein und ist jetzt zusammen mit [Verfassungsdokumentation](https://experienceleague.corp.adobe.com/docs/experience-manager-core-components/using/introduction.html) sowie [Entwicklerdetails und Projektdownload auf GitHub verfügbar](https://github.com/adobe/aem-core-wcm-components).
...
* Version 20.2.2 – [Mehr lesen](https://experienceleague.corp.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html#release-20-2-2-build-9180)
