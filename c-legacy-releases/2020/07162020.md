...
Ein entsprechendes Beispiel finden Sie in der [Dokumentation zur Benutzeroberfläche](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) von Experience Cloud.
...
* Im [Onboarding-Statusbericht](https://experienceleague.adobe.com/help/en/audience-manager/user-guide/reporting/onboarding-status-report.html) weicht das Datum, das beim Klicken auf einen Balken im Diagramm angezeigt wird, jetzt nicht mehr von dem in der Tabelle angezeigten Datum ab. (AAM-55235)
...
* **Dynamic Media Classic**
   ...
   Siehe [Adobe Dynamic Media Classic Desktop-App – jetzt verfügbar](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/new-ui-2020.html).
...
* **Dynamic Media jetzt mit Unterstützung für 3D-Assets**
   ...
   * Für AEM as a Cloud Service finden Sie nähere Informationen hierzu unter [Arbeiten mit 3D-Assets in Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/assets-3d.html).
   * Für AEM 6.5 finden Sie nähere Informationen hierzu unter [Arbeiten mit 3D-Assets in Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/assets-3d.html).
...
* **Aktualisierungen der Dokumentation zu AEM 6.5.5 Forms**
   ...
   * Neue Funktionen und Verbesserungen in Version 6.5.5:
      ...
      * [Anpassen der Spalten zum Posteingang in Adobe Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/essentials/inbox.html#inbox-admin-control).
      * [Speichern interaktiver Kommunikation als Entwurf.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html#save-as-draft)
      ...
      * [Verbesserungen hinsichtlich der Barrierefreiheit.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html#accessibility-improvements)
      * [Authentifizierung für SOAP-basierte Webservices im Formulardatenmodell mittels X.509-Zertifikat.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html#configure-soap-web-services)
      * [Unterstützung für Oracle RAC.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html#other-improvements)
      * [Verbesserte Fehlerprotokollierung in Transaktionsberichten.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/transaction-reports/viewing-and-understanding-transaction-reports.html#view-transaction-reporting-logs)
   * Neue Funktionen und Verbesserungen in Version 6.4.8.1:
      * [Authentifizierung für SOAP-basierte Webservices im Formulardatenmodell mittels X.509-Zertifikat.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html#configure-soap-web-services)
      * [Verbesserte Fehlerprotokollierung in Transaktionsberichten.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/transaction-reports/viewing-and-understanding-transaction-reports.html#view-transaction-reporting-logs)
...
| 23. Juni 2020 | [Verarbeitungsprofile](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/processing-profiles.html) | Video | Verarbeitungsprofile definieren die in AEM as a Cloud Service für Assets erstellten Ausgabeformate. |
...
| 3. Juni 2020 | [Tutorial zur Handhabung von HTML5-Formularübermittlungen](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/html5-forms/handle-mobile-form-submission.html) | Artikel | Erfahren Sie, wie Sie im benutzerdefinierten Submit-Handler auf übermittelte Daten zugreifen können. |
...
* [Versionshinweise zum AEM 6.5 Cumulative Fix Pack](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html)
...
* Verwaltung von GPG-Schlüsseln – [mehr dazu](https://experienceleague.adobe.com/docs/control-panel/using/instances-settings/gpg-keys-management.html?lang=de)
...
| 12. Juni 2020 | [Konfigurieren einer Versandvorlage](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/configuring-a-delivery-template.html) | Campaign Classic | Erfahren Sie, wie Sie eine E-Mail-Vorlage konfigurieren. |
