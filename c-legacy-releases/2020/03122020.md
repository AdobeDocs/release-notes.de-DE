...
* [!DNL Target] - [!DNL Target] Die Sitzungs-ID wird jetzt als Kontextdatenparameter &quot;a.target.sessionId&quot;im internen Treffer [!UICONTROL Analytics-for-Target] hinzugefügt, der an Adobe Analytics gesendet wird.
...
* Es wurde ein Problem behoben, bei dem Einstiegs- oder Ausstiegsmetriken manchmal falsch gezählt wurden, wenn sie in einem klassifizierten Dimensionsbericht auf &quot;Nicht angegeben&quot;angewendet wurden.
...
Siehe [AppMeasurement für JavaScript-Versionshinweise](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=de). Version 2.20.0 wurde am 5. März 2020 veröffentlicht.
...
Siehe [Arbeiten mit Smart Crop](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/adding-dynamic-media-assets-to-pages.html).
