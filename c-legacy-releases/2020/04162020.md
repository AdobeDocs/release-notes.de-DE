...
* **Konfigurieren von Dynamic Media – Scene7-Modus**
   ...
   Siehe [Erstellen einer Dynamic Media-Konfiguration](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/config-scene7-mode/config-dms7.html?lang=en).
