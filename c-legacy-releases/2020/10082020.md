...
| 23. September 2020 | [Verfolgen geklickter Komponenten mit Adobe Analytics](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/analytics/track-clicked-component.html?lang=de) | Artikel | Verwenden Sie die ereignisgesteuerte Adobe Client-Datenschicht mit AEM Kernkomponenten, um Klicks auf bestimmte Komponenten auf einer Adobe Experience Manager-Site zu verfolgen. Erfahren Sie, wie Sie mithilfe von Regeln in Experience Platform Launch auf Klick-Ereignisse überwachen, nach Komponenten filtern und die Daten mit einem Verfolgungslink-Beacon an eine Adobe Analytics senden können. |
