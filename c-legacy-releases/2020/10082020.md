...
Benötigen Sie Hilfe? Besuchen Sie [Adobe Experience League](https://experienceleague.adobe.com/?lang=de-DE#home), um Produkt- und technische Dokumentation, von Adobe kuratierte Kurse, Video-Tutorials, schnelle Antworten, Community-Einblicke und von Schulungsleitern geführte Kurse zu erhalten.
...
| 25. September 2020 | [Benutzer anhand ihrer Handynummer verifizieren](https://docs.adobe.com/content/help/de-DE/experience-manager-learn/forms/some-useful-integrations/two-factor-authentication.html) | Artikel | Erfahren Sie, wie Sie mithilfe von SMS in adaptiven Formularen eine OTP-Überprüfung durchführen können. |
...
| Veröffentlicht | Name | Typ | Beschreibung |
| -----------| ---------- | ---------- | ---------- |
| 30. September 2020 | [Kurzübersicht zu Adobe Sign](https://docs.adobe.com/content/help/de-DE/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/quick-tour.html) | Video | Verschaffen Sie sich einen kurzen Überblick über die Adobe Sign-Oberfläche, um sofort loslegen zu können. |
