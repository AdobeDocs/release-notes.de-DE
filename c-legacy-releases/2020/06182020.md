...
| Schreibgeschützte Workspace-Projekte | 18. Juni 2020 | Workspace-Projekte können Benutzern nur als &quot;Kann anzeigen&quot;freigegeben werden. Wenn ein Empfänger mit der Rolle „Anzeigen“ das freigegebene Projekt öffnet, hat er eingeschränkte Handlungsmöglichkeiten ohne linke Leiste und mit beschränkten Interaktionen. [Weitere Infos...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/view-only-projects.html) |
| Möglichkeit zur gemeinsamen Bearbeitung von Workspace-Projekten | 18. Juni 2020 | Empfänger, die der Rolle &quot;Kann bearbeiten&quot;hinzugefügt wurden, können ein für sie freigegebenes Projekt überschreiben. Dies gilt sowohl für Administratoren als auch für Nicht-Administratoren. [Weitere Infos...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/share-projects.html) |
...
| Funktion | Beschreibung |
| -----------| ---------- |  
| [Audience Manager-Plug-in für IAB TCF v2.0](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/consent-management/aam-iab-plugin.html?lang=de) | Adobe konzentriert sich weiterhin auf Datenschutz durch Design. Ab dem 10. Juni 2020 wird das Audience Manager-Plugin für IAB TCF auf die IAB Transparency &amp; Consent Framework (TCF)-Version 2.0 aktualisiert. Kunden, die das Audience Manager-Plugin für IAB TCF implementiert haben, müssen bis zum 15. August 2020 auf Version 2.0 aktualisieren, um die Funktion weiterhin nutzen zu können. Ab dem 15. August 2020 wird Version 1.1 nicht mehr unterstützt. |
...
* **AEM 6.5.5.0**
  ...
  AEM 6.5, Service Pack 5 (6.5.5.0, veröffentlicht am 4. Juni 2020) ist das wichtigste Update seit der allgemeinen Verfügbarkeit von AEM 6.5 im April 2019 und beinhaltet neue Funktionen, wichtige von Kunden angeforderte Verbesserungen und Steigerungen bei der Performance, Stabilität und Sicherheit.
...
| [Einrichtung intelligenter Tags](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/metadata/smart-tags-technical-video-setup.html?lang=de) | Videotutorial | Schrittweise Anleitung zur Integration von Adobe Experience Manager (AEM) in den Smart Content Service mit Adobe I/O. |
...
| [!UICONTROL Bestand] | (Beta-Version vom 22. Juni) Mit einem neuen Deal-ID-Formular können Sie schnell einen privaten Deal einrichten, den Sie bereits ausgehandelt haben. |
...
| ACTV Audience Lens | (Version 18. Juni) Audience Lenses ermöglicht es Benutzern, sekundäre Zielgruppen-Analysen für ihre Planungs-, Bestellungs- und Reporting-Workflows zu erstellen. Dadurch können sie (1) schnelle Einblicke in sekundäre Zielgruppen gewinnen, (2) flexibel auf bevorzugte Zielgruppen reagieren und (3) die Ausführung einer Kampagne durch das &quot;Objektiv&quot;mehrerer Zielgruppen messen. |
...
| [!UICONTROL Werbeeinblicke] | (Version vom 13. Juni) Die folgenden Erkenntnisse wurden entfernt:<br/><br/><ul><li>Zielgruppen-Performance (die neuere Version)</li><li>Historische Performance (die neuere Version)</li><li>Übereinstimmungstyp (die neuere Version)</li><li>Einstellungsprüfung (die neuere Version)</li><li>Portfolio-Vorveröffentlichung (veraltet)</li></ul><br/>Die verbleibenden Erkenntnisse sind ältere Versionen, und die Bezeichnung „_Veraltet_“ wurde aus den Namen entfernt. Außerdem wurden die Modi „Live/Bearbeiten“ entfernt. |
