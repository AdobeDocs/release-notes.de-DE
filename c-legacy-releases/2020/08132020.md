...
* **AEM as a Cloud Service**
   ...
   * Siehe [vollständige Versionshinweise für AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=de&mkt_tok=eyJpIjoiWm1SallqTmtOekF6WldZMCIsInQiOiJoTTZ3Qm9LNVRXc1lsbjExdlpNMGdQNFE2UGM5ejZob1EwZXlPZHp2MEZJa1BPTHhybHBYcUxFWTgwVjNFajlzYU1Fb1NoVXRwMTc3U2IrbHZKeTVSOG02MUErbWpIb1pjNU8zYkdTbW5MZHVIRUUyNk9vUU9SckdOeUJmbXlObSJ9&amp;lang=de).
...
* **AEM Forms**
   ...
   * Javadocs für AEM-Versionen [6.5.5.0](https://helpx.adobe.com/de/experience-manager/6-5/forms/javadocs/index.html) und AEM [6.4.8.1](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/index.html) sind verfügbar.
...
| Veröffentlicht | Name | Typ | Beschreibung |
| ----------- | ---------- | ---------- | ---------- |
| 7. August 2020 | [Erste Schritte mit der Verwaltung mehrerer Sites für Geschäftsbenutzer](https://experienceleague.adobe.com/?lang=de&recommended=ExperienceManager-U-1-2020.1.sites.msm&amp;lang=de) | Kurs | Erfahren Sie, wie Sie eine solide Grundlage für Ihre AEM Assets-Implementierung schaffen können, indem Sie die wichtigsten Anliegen konfigurieren – von der Einrichtung einer grundlegenden Inhaltsarchitektur und -taxonomie bis zur Anpassung von Metadaten und Asset-Verarbeitung. |
| 7. August 2020 | [Konfigurieren von AEM Assets für Administratoren](https://experienceleague.adobe.com/?lang=de&recommended=ExperienceManager-A-1-2020.1.assets&amp;lang=de) | Tutorial | Beschreibung |
