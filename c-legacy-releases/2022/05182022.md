...
| ------- | ----------- |
| [!UICONTROL Benutzerspezifische Berichte] | (31. Mai) Beta-Funktion) Advertising Cloud DSP kann jetzt Erstanbietersegmente erfassen, die aus authentifizierten Signalen bestehen, die in einer Kundendatenplattform (CDP) erstellt wurden. |
| Optimierungsziele | (25. Mai) Video- und native Platzierungen können jetzt in Pakete mit den benutzerdefinierten Zielen aufgenommen werden [!UICONTROL Höchste ROAS] und [!UICONTROL Niedrigster CPA]. |
...
| Integration in Adobe Analytics | (7. Mai) Im Daten-Feed, an den Advertising Cloud sendet [!DNL Analytics], Daten für [!DNL Google Ads] dynamische Suchanzeigen sind nur bis zum 7. Mai 2022 auf Anzeigengruppenebene verfügbar. |
