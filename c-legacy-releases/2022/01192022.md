...
* **Experience Manager as a Cloud Service**
   ...
   * **Cloud Manager**
      ...
      * Der Antwortheader `x-request-id` ist jetzt im API-Player unter [www.adobe.io](https://www.adobe.io/) sichtbar. Diese Kopfzeile ist beim Senden von Problemen bei der Kundenunterstützung zur Fehlerbehebung nützlich.
