...
| Januar 2022 | [Output-Erstellung mit XML-Dokumentation für AEM](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/output-generation/overview.html) | Videos und Artikel | Erfahren Sie mehr über das Zuordnungs-Dashboard, Berichte, die Veröffentlichung mit Ausgangswerten und Bedingungen und mehr. |
...
* Informationen zur Vorabversion von Adobe Target finden Sie in den Versionshinweisen zur [Vorabversion von Adobe Target](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html).
* Aktuelle Versionshinweise finden Sie unter [Versionshinweise zu Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html).
