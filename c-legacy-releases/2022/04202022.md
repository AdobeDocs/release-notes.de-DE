...
* **Experience Manager as a Cloud Service**
  ...
  Sehen Sie sich das Video mit der Versionsübersicht vom [ März 2022](https://video.tv.adobe.com/v/341465) mit einer Zusammenfassung der Funktionen an, die in der Version 2022.3.0 (März 2022) hinzugefügt wurden. <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
