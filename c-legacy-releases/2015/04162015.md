...
* Es wurde ein Problem behoben, durch das Single Sign-On zwischen dem [!DNL  Marketing Cloud] und [!DNL  Media Optimizer] verhindert wurde.
...
* Die Funktion „Social-Anwendungen“ ist ab der Version Adobe Social 15.4.1.0 (April 2015) endgültig veraltet. Damit werden auch alle anwendungsbegleitenden Metriken, Daten und API-Methoden entfernt Bei Fragen wenden Sie sich bitte an Ihren Social-Kontomanager. Ausführliche Informationen finden Sie in dem [Adobe Social-Anwendungen Missbilligungs-Informationsblatt](https://helpx.adobe.com/de/social/kb/social-applications---deprecation-fact.html).
