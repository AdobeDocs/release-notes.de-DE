...
seo-title: 17. Juli 2015 - Versionshinweise
solution: Experience Cloud, Versionshinweise
title: 17. Juli 2015 - Versionshinweise
...
* Es wurde ein Problem behoben, bei dem neue Segmente, die in Reports &amp;amp Analysen erstellt wurden, nicht in Marketing Cloud-Zielgruppen verfügbar waren. (MAC-25817)
...
Ein bekanntes Problem verursacht die Erstellung doppelter automatisch generierter Konten in Audience Manager und die automatische Verknüpfung dieser Konten mit der Marketing Cloud-Identität eines Benutzers. Dieses Problem tritt auf, wenn Sie versuchen, zu Audience Manager zu navigieren, bevor Sie Ihre Konten verknüpft haben. Adobe empfiehlt Ihnen, die Verknüpfung Ihrer Audience Manager-Konten mit der Marketing Cloud vorzunehmen, bevor Sie zu Audience Manager navigieren. (MAC-25640)
...
* Fehlerbehebungen:
   ...
   * [Korrekturen in ReportBuilder](../../c-legacy-releases/2015/07162015.md#fixes_arb)
   * [Korrekturen der Ad-hoc-Analysen](../../c-legacy-releases/2015/07162015.md#fixes_ad_hoc)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Änderungen an den Einstellungen der Gruppenberechtigung in der Analytics-Admin-Konsole </td> 
...
* Die maximale Anzahl der Report Suites, die in der Admin-Konsole angezeigt werden können, ohne dass die benutzerdefinierten Spalten ausgeblendet werden, wurde von 500 zu 400 geändert. (AN-102864)
...
### Korrekturen in ReportBuilder {#fixes_arb}
