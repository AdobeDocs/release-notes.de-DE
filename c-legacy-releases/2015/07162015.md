...
* Die Datenquellen-API-Methoden wurden zu Swagger migriert. See the [Audience Manager API Docs](https://bank.demdex.com/portal/swagger/index.html) for methods, syntax, and code samples.
