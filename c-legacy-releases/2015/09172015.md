...
>[!NOTE]
>
>Der Inhalt dieser Seite wird eine Woche vor dem Releasedatum bereitgestellt und kann beim Erscheinen der neuen Version Änderungen unterliegen. Prüfen Sie diese Seite am Releasedatum erneut auf aktualisierte Informationen. Abonnieren Sie die [Adobe Priority Produktaktualisierung](https://www.adobe.com/subscription/priority-product-update.html), um Versionshinweise eine Woche vor der monatlichen Produktaktualisierung zu erhalten.
...
Lösungsadministratoren finden unter [Benutzer und Gruppen](https://marketing.adobe.com/resources/help/de_DE/mcloud/?f=user_mgmt_admin) wichtige Informationen über die Zuordnung von Lösungsgruppen zu umfassenderen Adobe-Gruppen sowie zum Hinzufügen von mehreren Benutzern in das [Enterprise Dashboard](http://adminconsole.adobe.html/#).
...
Analytics-Administratoren: Wenn Sie Administrator in der Experience Cloud sind, finden Sie unter [Benutzer und Gruppen](https://marketing.adobe.com/resources/help/de_DE/mcloud/?f=user_mgmt_admin) aktualisierte Informationen über die Zuordnung von Analytics-Gruppen zu umfassenderen Adobe-Gruppen sowie zum Hinzufügen von mehreren Benutzern zum [Enterprise-Dashboard](http://adminconsole.adobe.html/#).
...
Siehe [AppMeasurement-Versionsgeschichte](https://marketing.adobe.com/resources/help/de_DE/sc/appmeasurement/release/index.html) zu einer Versionsgeschichte von [!DNL  AppMeasurement] auf den folgenden Plattformen:
...
* Die neue Dokumentation beschreibt die Verwendung von Metadatendateien zum Ersetzen numerischer IDs durch lesbaren Text in den [!UICONTROL Advertising Analytics]-Berichten. Siehe [Daten- und Metadatendateien für Advertising Analytics-Berichte](https://marketing.adobe.com/resources/help/de_DE/aam/?f=metadata-files-intro.html).
* [Erfassen von Kampagnendaten-Impressionsdaten über Pixelaufrufe](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_capturing_camp_data.html) überarbeitet, um neue wichtige Wertpaare einzubeziehen, die für [!UICONTROL  die Advertising Analytics]-Berichte erforderlich sind.
* [Erfassung von Kampagnen-Klickdaten über Pixel-Aufrufe](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_capturing_camp_click_data.html) überarbeitet, um neue wichtige Wertpaare einzubeziehen, die für die Advertising Analytics-Berichte erforderlich sind.
