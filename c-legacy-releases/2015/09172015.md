...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Sending push messages to  <span class="wintitle"> Analytics </span> segments from the <span class="keyword"> Mobile Services </span> UI allows you to leverage your robust [!DNL Analytics] data while engaging with users. </p> <p>Siehe: </p> 
