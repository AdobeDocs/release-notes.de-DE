...
* Der Classification Rule Builder wurde mit dem Panel [Report Suites und Variablen auswählen](https://marketing.adobe.com/resources/help/de_DE/reference/?f=classification_rule_definitions) aktualisiert. Über dieses Bedienfeld können Sie einem bestehenden Regelsatz Report Suites und Variablen hinzufügen. Zuvor mussten die Variable und Report Suite bei der Erstellung des Regelsatzes festgelegt werden. Diese Änderung verhindert Fehler, die im Zusammenhang mit Classification-Variablen aufgetreten sind.
...
* Ein Fehler wurde behoben, durch den der [!UICONTROL Besucher-ID-Service] mehrteilige Top-Level-Domain-Cookies nicht ordnungsgemäß setzte. Bei einer Domain wie ` my_company.co.uk` setzte beispielsweise der [!UICONTROL Besucher-ID-Service] nur für ` co.uk` einen Cookie. (AN-104683)
   ...
   * Eine [Übergangsphase wurde aktiviert](https://marketing.adobe.com/resources/help/de_DE/mcvid/?f=mcvid_grace_period.html)*oder* verwenden Cookies von Erstanbietern, und Benutzer blockieren Cookies von Drittanbietern.
...
* Ein neues Dokument erläutert den Import von Daten aus einem Google Doubleclick Campaign Manager (DCM)-Konto in den [!DNL  Audience Manager]. Siehe [Import von DCM-Dateien in Audience Manager](https://marketing.adobe.com/resources/help/de_DE/aam/?f=t_dcmlogs.html).
* Ein neues Dokument erläutert die Arbeit mit [!UICONTROL Massenverwaltungswerkzeugen]. Weitere Informationen finden Sie unter [Massenverwaltungswerkzeuge](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_bulk.html).
* Die[Master Marketing Profil-Integration](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_mmp.html) wurde überarbeitet, um die Kontextdatenvariable zu aktualisieren. Diese Variable sollte mit einem Unterstrich enden. Zuvor wurde sie mit einem Punkt am Ende gezeigt.

**Bekannte Probleme**

[!DNL  Analytics] Kunden müssen einen Integrationscode festlegen, wenn sie die [Master Marketing Profile](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_mmp.html) verwenden und deklarierte IDs [!DNL  Audience Manager] an den [Besucher-ID Service](https://marketing.adobe.com/resources/help/de_DE/mcvid/?f=mcvid_service.html) weiterleiten. Weitere Informationen finden Sie unter [Profile Merge Customer Enablement](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_profile_merge_enablement.html).
...
<table id="table_3C13024F4D754E2C98D7B8434A3497EF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/mobile/" format="html" scope="external"> Mobil </a> </p> </td> 
