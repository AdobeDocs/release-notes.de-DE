...
* [Neue Funktionen in [!DNL Analytics]](../../c-legacy-releases/2015/08202015.md#features_analytics) **(am 21.8.2015 aktualisiert):** Der nicht mehr unterstützte SFTP-Schlüssel (der im Herbst 2013 öffentlich bekannt gegeben wurde), der zum Übertragen von Data Warehouse-Berichten und -Datenfeeds verwendet wurde, wurde endgültig entfernt.
...
* Ein neues Dokument erläutert den Import von Daten aus einem Google Doubleclick Campaign Manager (DCM)-Konto in den [!DNL  Audience Manager]. Siehe [DCM-Dateien in Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/t_dcmlogs.html) importieren.
...
* Die Variable [Übergeordnet Marketing Profil Integration](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html) wurde überarbeitet, um die Kontextdatenvariable zu aktualisieren. Diese Variable soll mit einem Unterstrich enden. Zuvor wurde die Anzeige mit einem Punkt beendet.

**Bekannte Probleme**

[!DNL  Analytics] Kunden müssen einen Integrationscode festlegen, wenn sie das  [Übergeordnet Marketing ](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html) Profile verwenden und deklarierte IDs  [!DNL  Audience Manager] mit dem Besucher-ID-Dienst weitergeben.
