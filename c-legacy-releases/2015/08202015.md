---
description: Aktuelle Passwortanforderungen zum Bearbeiten für Benutzer in Analytics User Management, aktualisierter Classification Rule Builder in Analytics, neue Funktionen in Social und allgemeine Fehlerbehebungen in Adobe Marketing Cloud-Lösungen.
keywords: Versionshinweise
seo-description: Aktuelle Passwortanforderungen zum Bearbeiten für Benutzer in Analytics User Management, aktualisierter Classification Rule Builder in Analytics, neue Funktionen in Social und allgemeine Fehlerbehebungen in Adobe Marketing Cloud-Lösungen.
seo-title: 20. August 2015 - Versionshinweise
solution: Experience Cloud, Versionshinweise
title: 20. August 2015 - Versionshinweise
...
* Ein Fehler wurde behoben, durch den Benutzer Segmente mit bestimmten anderen Benutzern nicht im Ad-hoc-Analysen-Segment-Manager teilen konnten. (AN-105679)
...
* Ein Fehler wurde behoben, durch den der Ad-hoc-Analysen-Segment-Builder bei sequenzieller Segmentierung „Minute“ nicht als „Innerhalb“-Option anbot. (AN-105632)
* Ein Fehler im Zusammenhang mit Statistiken in Ad-hoc-Analysen bei der Verwendung von Berichtsdimensionen wurde behoben. (AN-105864)
...
* Ein Problem mit Tableau-Dateien wurde behoben, bei dem die [!DNL  .csv] Dateierweiterung nicht hinzugefügt wurde, wenn *` .csv`* sie Teil des Dateinamens war. (AN-106466)
