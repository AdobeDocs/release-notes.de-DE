...
* Der  Menüauswahlmöglichkeiten für die <span class="term">Zielgruppenbibliothek</span> und die <span class="term">Kundenattribute</span> sind nun unter <span class="term">Audiences</span> zu finden.
...
Informationen zu dieser Änderung finden Sie unter [Besucher-ID-Service Implementierung](https://marketing.adobe.com/resources/help/de_DE/mcvid/?f=mcvid_implement).
...
Trainingsvideos zu diesen neuen Funktionen finden Sie unter [Neue Funktionen im Mai 2015](https://bit.ly/1JSO2k5).
...
|---|---|
| [Audience Marketplace](https://marketing.adobe.com/resources/help/de_DE/aam/c_audience_marketplace.html) | Durch spezialisierte Funktionen ermöglicht der [!DNL  Audience Marketplace] das selbstständige Kaufen und Verkaufen von Daten bei minimalem Aufwand. Sprechen Sie mit Ihrem [!DNL  Audience Manager]-Berater, um zu beginnen. Er kann [!DNL  Audience Marketplace] für Sie aktivieren. |

**Fehlerbehebungen, Verbesserungen und veraltete Elemente**

* [Erstellen von Gruppen](https://marketing.adobe.com/resources/help/de_DE/aam/t_create_groups.html): Vereinfachte Schritte und Anweisungen zum Erstellen von Gruppen und Zuweisen von Berechtigungen.
* [Platzhalter-Berechtigungen verstehen](https://marketing.adobe.com/resources/help/de_DE/aam/c_wildcard_permissions.html): Verwenden Sie [!DNL  Wild Card Permissions], um den Gruppenmitgliedern automatisch Zugriff auf neue Datenquellen zu gewähren. Mit den Standardberechtigungen können Sie neue Datenquellen für eine Gruppe nur manuell zuweisen.
