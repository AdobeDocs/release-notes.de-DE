...
In der [Versionshistorie zu ](https://docs.adobe.com/content/help/de-DE/analytics/implementation/appmeasurement-release-notes/c-release-notes-mjs.html) finden Sie Informationen zu den verschiedenen Versionen von [!DNL  AppMeasurement]AppMeasurement auf den folgenden Plattformen:
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Zurzeit empfangen wir Metriken von sozialen Netzwerken, die nicht in <span class="keyword">Adobe Analytics</span> angezeigt werden können. Mit neuen reservierten Ereignissen können Sie benutzerdefinierte Berichte in <span class="wintitle"> Analytics </span> erstellen, um soziale Daten mit Webdaten zu Ansichten. </p> </td> 
  </tr> 
  <tr valign="top"> 
