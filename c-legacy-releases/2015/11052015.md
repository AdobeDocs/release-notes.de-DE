...
Die iOS- und Android-SDKs Version 4.8.0 (2. November 2015) umfassen die folgenden Änderungen:
...
Im November und Dezember rechnet die Adobe mit einem hohen Volumen an Classification-Uploads in unserem Kundenstamm. Wir verarbeiten diese Uploads so schnell wie möglich, aber es ist möglich, dass die Verarbeitungszeit länger ist als sonst. Tipps zur Minimierung der Verarbeitungszeit finden Sie unter [Classification Processing Time](https://helpx.adobe.com/analytics/kb/saint-processing-time.html).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Hinzugefügte Unterstützung für  <span class="term">Aufschlüsselung nach Segment</span>. Zusätzlich zu den Aufschlüsselungen nach „Standard“ (Elemente) und „Benutzerspezifisch“ (Insights) können Sie Berichte nun auch nach Segmenten aufschlüsseln. Wenn Sie die Registerkarte Segmente auswählen, wird die Liste mit den Segmenten gefüllt, die auch in der Dropdown-Liste Verfügbare Segmente angeboten werden. </p> <p>Linienelemente mit Mitgliedschaft im Segment melden den Wert "1"und Elemente außerhalb des Segmentberichts "0". (AN-100346) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse: Suchfeld in der Aufschlüsselungs- und Metrikauswahl </td> 
   <td colname="col2"> Es wurde ein Suchfeld zur Aufschlüsselungs- und Metrikauswahl hinzugefügt. Es ist jetzt einfacher, eine bestimmte Variable oder ein bestimmtes Segment zu finden, da Sie nicht mehr durch die gesamte Liste blättern müssen. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse: Benutzerdefinierte inkrementierende Ereignis in Segmentdefinitionen </td> 
   <td colname="col2"> Zuvor wurden Segmentregeln zur Bewertung der Gesamtwerte benutzerdefinierter Ereignis nur für Zähler-Ereignis unterstützt. Segmentregeln zur Bewertung der Gesamtwerte von Ereignissen behandeln nun auch inkrementelle Ereignis. (AN-113168) </td> 
  </tr> 
  <tr> 
   <td colname="col1"> AVRO-Datenfeed für die Data Workbench </td> 
   <td colname="col2"> <p>Der AVRO-Daten-Feed ist ein neues Protokollformat für die Data Workbench, mit dem Sie auf alle neuen Variablentypen und -funktionen zugreifen können, einschließlich aktualisierter eVars, benutzerspezifischer Ereignis und Lösungsvariablen. Außerdem bietet er eine interne Automatisierung, um den Datenfeed für zukünftige Updates nahtlos zu ändern. </p> <p>Der AVRO-Daten-Feed und sonstige Aktualisierungen wurden zur Version <a href="https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/c_6_51.html" format="https" scope="external">Data Workbench 6.51</a> hinzugefügt. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">Es wurde ein Problem behoben, bei dem die Funktion für das rechte/linke Diagramm im Schlüsselmetrikbericht angezeigt wurde, obwohl diese Funktion in Trendberichten nicht unterstützt wird. Die Diagrammsymbole wurden nun aus Trendberichten entfernt. </li> 
      <li id="li_533E80996F6B4B1DA79E0E8AFD82B345">Es wurde ein Problem mit den Admin-Kennworteinstellungen für die Benutzerverwaltung in den Admin Tools behoben. Nur Administratoren mit einem Analytics-Kennwort können die Einstellungen anderer Benutzer ändern. Das betrifft Admins, die lediglich Anmeldedaten für Experience Cloud haben. (AN-108518 + AN-114469) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">Es wurde ein Fehler behoben, der verhinderte, dass "Städte"-Daten in Berichten angezeigt wurden. (AN-104987) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_193CB58F22D14FE4AB4759418A00848B"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Quartil-Ereignisse </p> </td> 
   <td colname="col2"> Die folgenden neuen Video-Core-Parameter und -Ereignis wurden hinzugefügt: 
...
<!-- 
 <draft-comment> 
  ...
  <tr> 
   <td colname="col1"> <p>Ereignis zur durchschnittlichen Audience in Minuten </p> </td> 
...
* Es wurde ein Fehler behoben, der verhinderte, dass das Tool zum Hochladen von Massen-Daten Berichtsdaten für integrierte oder regelbasierte Eigenschaften zurückgab. (AAM-21444)
* Es wurde ein Fehler in Data Export Controls behoben, der dazu führte, dass die Beschriftung &quot;Datenexportbeschriftungen&quot;außerhalb des Abschnittsrahmens angezeigt wurde. (AAM-21341)
* Es wurde ein Fehler bei der Profil-Zusammenführung behoben, sodass verfügbare Metriken den Lebenszeitbereich anstelle der letzten 60 Tage anzeigen. (AAM-21383)
* Es wurde ein Fehler bei der Profil-Zusammenführung behoben, durch den Daten für die verfügbaren Datumsbereiche nicht zuverlässig angezeigt werden konnten. (AAM-21400)
* Es wurde ein Fehler bei der Profil-Zusammenführung behoben, durch den die korrekte Anzeige der Ergebnisse im Trenddiagramm verhindert wurde. (AAM-21401)
* Es wurde ein Fehler in Trendberichten behoben, durch den die Ergebnisse im Diagramm nicht korrekt angezeigt wurden. (AAM-21435). Verbesserter Arbeitsablauf zum Zusammenführen von Profilen und Benachrichtigungen zum Löschen von Zusammenführungsregeln. (AAM-20861)

>[!NOTE]
>
>Seit dem 1. Oktober verwenden alle neuen Links, die mit dem t.co-Wrapper von Twitter gewrappt wurden, das HTTPS-URL-Schema. Durch diese geplante Änderung wird die Länge der umschlossenen URLs um ein einzelnes Zeichen verlängert.

## [!DNL Social]

Das Social Release 15.11.1.0 (05.11.2015) beinhaltet die folgenden Änderungen:
...
<!-- <draft-comment> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Ein- oder Ausblenden eines Kommentars zu einem Beitrag auf einer Facebook-Seite Dies ist nützlich, um Kommentare auszublenden, ohne sie tatsächlich von der Seite zu löschen. Wenn problematische Kunden zur Seite zurückkehren, sehen sie immer noch ihre Kommentare, aber diese werden von allen anderen ausgeblendet. </p> 
<!-- <draft-comment> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Sie können jetzt Direktnachrichten mit bis zu 10.000 Zeichen anstelle der vorherigen Beschränkung von 140 Zeichen senden. </p> 
<!-- <draft-comment> 
  ...
  <tr valign="top"> 
   <td colname="col1"> LinkedIn-API-Aktualisierung </td> 
...
Diese Social-Version konzentriert sich auf die Optimierung der Erstellung, Verteilung und Interaktion von Social-Inhalten, damit Sie hochwertige, visuelle Social-Inhalte schneller erstellen und bereitstellen können und damit sichergestellt ist, dass die Interaktionen mit diesen Inhalten für die Marke angemessen und produktiv bleiben.
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Unter <span class="uicontrol"> Admin Tools </span> &gt; <span class="uicontrol"> Classification Rule Builder </span> &gt; <span class="term"> Regelsatzname </span> können Sie mit zwei neuen Optionen einen Überschreibmodus auswählen: </p> 
