...
seo-title: 01. November 2015 - Versionshinweise
solution: Experience Cloud, Versionshinweise
title: 01. November 2015 - Versionshinweise
...
# 01. November 2015 - Versionshinweise
...
<table id="table_812AC7BF7F314540B7DA72D1C97D1918"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1" morerows="2"> <p>iOS-SDK 4.x für Marketing Cloud-Lösungen </p> </td> 
   <td colname="col2"> <p> <b>Neue Methoden beim Marketing Cloud-ID-Dienst </b> </p> <p>Die folgenden neuen Methoden wurden hinzugefügt: </p> 
  ...
  <tr> 
   <td colname="col1" morerows="2"> <p>Android-SDK 4.x für Marketing Cloud-Lösungen </p> </td> 
   <td colname="col2"> <p> <b>Neue Methoden beim Marketing Cloud-ID-Dienst </b> </p> <p>Die folgenden Methoden wurden hinzugefügt: </p> 
...
Verbesserungen und Korrekturen für den Marketing Cloud ID-Dienst (Version 1.5.3).
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_533E80996F6B4B1DA79E0E8AFD82B345">Ein Problem mit den Admin-Kennworteinstellungen für die Benutzerverwaltung in Admin Tools wurde behoben. Nur Admins mit einem Analytics-Kennwort können die Einstellungen anderer Benutzer ändern. Das betrifft Admins, die lediglich Anmeldedaten für Marketing Cloud haben. (AN-108518 + AN-114469) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>JavaScript 1.5.2: </p> 
    <ul id="ul_B5B69A24247F452E9C9D0452B707F07D"> 
     <li id="li_EAE62521A20C4228B61439A1DEFE881B">Aufnahme der Besucher-API 1.5.3 (siehe Änderungen in <a href="../../c-legacy-releases/2015/11052015.md#mcvid" format="dita" scope="local">Marketing Cloud ID-Dienst </a>) </li> 
