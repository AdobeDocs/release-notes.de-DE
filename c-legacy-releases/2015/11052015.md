...
Im November und Dezember rechnet die Adobe mit einem hohen Volumen an Classification-Uploads in unserem Kundenstamm. Wir verarbeiten diese Uploads so schnell wie möglich, aber es ist möglich, dass die Verarbeitungszeit länger ist als sonst. Tipps zur Verkürzung der Verarbeitungszeit finden Sie unter [Classification-Verarbeitungszeit](https://helpx.adobe.com/analytics/kb/saint-processing-time.html).
