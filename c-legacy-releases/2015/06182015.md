...
Die Produktdokumentation finden Sie unter [Adobe Mobile Services](https://docs.adobe.com/content/help/en/mobile-services/using/home.html). Um die Versionshinweise für frühere Versionen zu sehen, erweitern Sie *Frühere Versionshinweise* im linken Bereich.
...
Analytics Premium bietet folgende zusätzliche neue Funktionen in der Version [Data Workbench 6.4 ](https://docs.adobe.com/content/help/de-DE/data-workbench/using/release-notes/release-notes.html):
...
<table id="table_FE8C9A73676345CDA450CE84111A2B72"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Nach der Installation der Workstation wird der Arbeitsbereich <b>Verbindungen mit dem Server konfigurieren</b> mit zusätzlichen Informationen zum Installieren eines Zertifikats und zum Eingeben der Serververbindungsinformationen in die Datei Insight.cfg geöffnet. Sie können auch den Verbindungsstatus an Ihre Server Ansicht und Profil auswählen. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Sie können das Datumsformat anhand des Gebietsschemas in der Datei "Standardzeit <i>Dimensionen.cfg</i>"ändern. Ändern Sie das Standardformat <i>MM/TT/JJJJ</i> in das Format <i>TT/MM/JJJJ</i> oder wählen Sie andere Optionen. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Verbesserte Sichtbarkeit beim Bewegen des Mauszeigers über einen Abschnitt bei der Anzeige der Visualisierung <b>Akkord</b>. </td> 
  </tr> 
  <tr> 
...
* ID-Anforderung korrekt formatiert. Bei Verwendung der *`mbox3rdpartyId`*-Kennung anstelle der Standard-PCIDs wurde [!UICONTROL Adobe Target] veranlasst, über die Zielgruppe/Data Workbench-Integration (unter Verwendung des [!DNL  ExportIntegration.exe]) generierte Anforderungen abzulehnen. Diese ID-Anforderung wird jetzt korrekt formatiert und der Durchsatz ist erfolgreich.
...
* Änderungen an der Geschäftslogik Besuchszeit/Site-Zeit:
   ...
   * Verwenden Sie *`visit_start_time_gmt`* als Startzeit eines Besuchs. Jetzt wirken sich Besuche, deren Start vor dem Berichtsdatum liegt, nicht mehr negativ aus.
...
* Wir verbessern die API-Dokumentation mit Swagger. Neue und überarbeitete Methoden finden Sie im Abschnitt [Audience Manager-API-Dokumente](https://bank.demdex.com/portal/swagger/index.html).
...
Weitere Informationen finden Sie unter [Versionshinweise für Adobe Social](https://docs.adobe.com/content/help/de-DE/social/using/home.html).
