...
* Folgende Handbücher wurden umstrukturiert und verbessert:
   ...
   * [Benutzerhandbuch zu Adobe Mobile Services](https://marketing.adobe.com/resources/help/de_DE/mobile/)
   * [iOS-SDK 4.x für Experience Cloud-Lösungen Administratorhandbuch](https://marketing.adobe.com/resources/help/de_DE/mobile/ios/)
...
Analytics Premium bietet diese zusätzlichen neuen Funktionen im [Data Workbench 6.4 Release](https://marketing.adobe.com/resources/help/de_DE/insight/whatsnew/):
...
>[!NOTE]
>
>Der Data Warehouse-Zugriff über Version 14 wurde entfernt.[Weitere Informationen](https://marketing.adobe.com/resources/help/de_DE/reference/?f=whatsnew_segments)
...
Siehe [AppMeasurement-Versionsverlauf](https://marketing.adobe.com/resources/help/de_DE/sc/appmeasurement/release/index.html) zu einem Versionsverlauf von [!DNL  AppMeasurement] auf den folgenden Plattformen:
...
* Wir verbessern die API-Dokumentation mit Swagger. Neue und überarbeitete Methoden finden Sie im Abschnitt [Audience Manager API Docs](https://bank.demdex.com/portal/swagger/index.html).
* Neue Dokumentation zu [Experience Cloud-Besucher-IDs](https://marketing.adobe.com/resources/help/de_DE/aam/?f=c_visitor_id_versions.html)hinzugefügt. Manchmal wird beim Erstellen oder Bearbeiten einer Datenquelle eine Besucher-ID benötigt.
...
* Es wurde ein Problem behoben, das verhinderte, dass Benutzer Listening-Regeln für WordPress erstellen konnten, die einen ODER-Operator enthielten.

Weitere Informationen finden Sie unter [Versionshinweise für Adobe Social](https://marketing.adobe.com/resources/help/de_DE/social/c_rel_notes.html).
