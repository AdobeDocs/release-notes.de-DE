...
seo-title: 18. Juni 2015 - Versionshinweise
solution: Experience Cloud, Versionshinweise
title: 18. Juni 2015 - Versionshinweise
...
Kunden müssen über [!DNL  Analytics—Mobile Apps] die folgenden [!DNL  Analytics Premium] Funktionen verfügen oder die folgende Funktion nutzen:
...
* Problem mit Metriken im Bericht [!UICONTROL Videotagesabschnitt] wurde behoben, indem zukünftige Tage aus der Berechnung des Mittelwerts ausgeschlossen wurden.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Berechnete Metriken erlauben jetzt segmentierte Metriken, weiterführende mathematische Operationen und bieten die Möglichkeit, Metriken zu organisieren und freizugeben. </p> <p>Sie können neue Metriken erstellen, die historisch angewendet werden, ohne Ihre Implementierung zu aktualisieren, Metriken freigeben und kuratieren, ohne überflüssige Sachen zu entfernen, und eine grundlegende statistische Analyse durchführen. Segmente können viel einfacher verglichen werden. </p> <p>Diese neuen Metriken können überall in Reports &amp; Analysen, im Arbeitsbereich für Analysen, ReportBuilder und Ad-hoc-Analysen angewendet werden. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/calcmetrics/" format="https" scope="external"> Mehr... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Arbeitsbereich für Analysen – Freiformanalyse </td> 
   <td colname="col2"> <p>In der Freiformanalyse können Sie Dimensionen, Metriken und Segmente ziehen und ablegen, um beliebige Berichte zu erstellen. Sie können Ihre Daten entsprechend Ihren spezifischen Anforderungen aufschlüsseln und auf einer Arbeitsfläche Abfragen erstellen, die relevante Metriken, Dimensionen, Segmente, Zeitachsen und andere Analysewerte nutzen. </p> <p>Die aktuellsten Funktionen umfassen: </p> <p> 
     <ul id="ul_F5C624FACEEF4839BD1A9AE10C437085"> 
      ...
      <li id="li_22D58E07B0BB43C5A50F16523DC7B647"> <p> <b>Verbesserungen der Berechtigungen:</b> Der Zugriff auf den Arbeitsbereich für die Analyse kann Nichtadministratoren über den Bereich für Benutzergruppenberechtigungen in den Admin Tools gewährt werden. </p> </li> 
     </ul> </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/freeform/index.html" format="https" scope="external"> Freiformanalyse</a> wird aktuell in der offenen Beta-Phase in erster Linie durch das Analytics Community-Team unterstützt. Im <a href="https://help-forums.adobe.com/content/adobeforums/en/analytics-forum/freeform-analysis.html" format="http" scope="external">Forum zur Freiformanalyse (Beta)</a> finden Sie weitere Informationen und können Fragen zur Freiformanalyse stellen . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Unterstützung für neu berechnete Metriken. Die Benutzeroberfläche des Generators für berechnete Metriken in Ad-hoc-Analysen gleicht nun der in Reports &amp; Analysen. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FE8C9A73676345CDA450CE84111A2B72"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> Export in Reports &amp; Analysen </td> 
   <td colname="col2"> Mit der Customer Record Service- (CRS-)Exportfunktion können Sie Data Workbench-Daten exportieren, um sie in andere Bereiche von Analytics zu integrieren, z. B. in <i>Reports &amp; Analysen</i>. </td> 
  </tr> 
  <tr> 
...
* Ein Problem wurde behoben, das dafür sorgte, dass eine Instanz einer eVar inkrementiert wurde, wenn der Wert der eVar mithilfe von Verarbeitungsregeln gelöscht oder  *` blank`* gelassen wurde.

### Korrekturen der Ad-hoc-Analysen {#fixes_ad_hoc}

* Es wurde ein Fehler in Bezug auf Bericht-E-Emails ( [!DNL  .xls] und [!DNL  .csv] Anlagen) behoben, der anstelle des Report Suite-Namens in der E-Email die Report Suite-ID enthielt. Jetzt wird der Name der Report Suite angezeigt.
...
* Unterstützung des authentifizierten Status. Zusammen mit der Marketing Cloud-Besucher-ID akzeptiert die Besucher-API mehrere Kunden-IDs für denselben Besucher sowie eine Kundentypkennung, um den Umfang der einzelnen Kunden-IDs und  *` authStates`*.
